...
For how-to guidance for using the **VideoStabilizationEffect**, see [Effects for video capture](https://docs.microsoft.com/windows/uwp/audio-video-camera/effects-for-video-capture).

## -examples

## -see-also
[IMediaExtension](../windows.media/imediaextension.md), [Effects for video capture](https://docs.microsoft.com/windows/uwp/audio-video-camera/effects-for-video-capture)