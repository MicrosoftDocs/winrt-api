...
## -see-also
[IVideoEffectDefinition](../windows.media.effects/ivideoeffectdefinition.md), [Scene anlysis for MediaCapture](https://docs.microsoft.com/windows/uwp/audio-video-camera/scene-analysis-for-media-capture)