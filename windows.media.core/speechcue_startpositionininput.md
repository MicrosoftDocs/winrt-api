---
-api-id: P:Windows.Media.Core.SpeechCue.StartPositionInInput
...
# Windows.Media.Core.SpeechCue.StartPositionInInput
...
## -property-value
The offset into the string contained in the [Text](speechcue_text.md) property of the first character in the word or sentence associated with the cue.
