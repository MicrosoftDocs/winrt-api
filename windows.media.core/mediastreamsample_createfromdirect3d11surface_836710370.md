...
## -description
Creates a [MediaStreamSample](mediastreamsample.md) from an [IDirect3DSurface](https://docs.microsoft.com/en-us/uwp/api/Windows.Graphics.DirectX.Direct3D11.IDirect3DSurface).
