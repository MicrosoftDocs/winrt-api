...
You can iterate through a MediaStreamSamplePropertySet object in C# or Microsoft Visual Basic. In many cases, such as using **foreach** syntax, the compiler does this casting for you and you won't need to cast to `IEnumerable` explicitly. If you do need to cast explicitly, for example if you want to call [GetEnumerator](/dotnet/api/system.collections.ienumerable.getenumerator?redirectedfrom=MSDN#System_Collections_IEnumerable_GetEnumerator), cast the collection object to [IEnumerable&lt;T&gt;](/dotnet/api/system.collections.ienumerable?redirectedfrom=MSDN) with a [KeyValuePair](/dotnet/api/system.collections.generic.keyvaluepair-2?redirectedfrom=MSDN) of [Guid](/dotnet/api/system.guid?redirectedfrom=MSDN) and [Object](/dotnet/api/system.object?redirectedfrom=MSDN) as the constraint.
