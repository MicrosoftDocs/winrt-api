...
<!-- Method syntax
public Windows.Perception.Spatial.SpatialStationaryFrameOfReference CreateStationaryFrameOfReferenceAtCurrentLocation(Windows.Foundation.Numerics.Vector3 relativePosition)
-->
