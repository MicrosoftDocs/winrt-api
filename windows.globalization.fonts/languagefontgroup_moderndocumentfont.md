...
## -remarks
The [ModernDocumentFont](languagefontgroup_moderndocumentfont.md) property provides a font recommendation for typical document body text following modern style conventions. These fonts can also be used in headings or other document elements.
...
A [ModernDocumentFont](languagefontgroup_moderndocumentfont.md) recommendation is available for every supported language or script.
