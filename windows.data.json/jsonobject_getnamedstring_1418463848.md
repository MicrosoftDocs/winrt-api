...
## -description
Gets the [String](/dotnet/api/system.string?redirectedfrom=MSDN) value with the specified name, or the provided default value if no such named value is found.
...
## -returns
The [String](/dotnet/api/system.string?redirectedfrom=MSDN) with the specified *name*, or if this value wasn't found, the *defaultValue* is returned.
