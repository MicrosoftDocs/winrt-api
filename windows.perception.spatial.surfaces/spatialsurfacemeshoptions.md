---
-api-id: T:Windows.Perception.Spatial.Surfaces.SpatialSurfaceMeshOptions
-api-type: winrt class
-api-device-family-note: xbox
---

<!-- Class syntax.
public class SpatialSurfaceMeshOptions : Windows.Perception.Spatial.Surfaces.ISpatialSurfaceMeshOptions
-->
