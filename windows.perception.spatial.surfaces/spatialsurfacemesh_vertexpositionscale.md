...
## -description
Gets the scale vector that you must use to scale the elements of VertexPositions. This gets you mesh coordinates in meters in the mesh's specified coordinate system.
