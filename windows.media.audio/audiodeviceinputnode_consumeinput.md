---
-api-id: P:Windows.Media.Audio.AudioDeviceInputNode.ConsumeInput
...
# Windows.Media.Audio.AudioDeviceInputNode.ConsumeInput

## -description
Gets or sets a value indicating if the audio device input node consumes input.

## -property-value
True if the audio device input node consumes input, and false otherwise.
