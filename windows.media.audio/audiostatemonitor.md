...
For more information on using **AudioStateMonitor** in a UWP app, see [Detect and respond to audio state changes](https://msdn.microsoft.com/windows/uwp/audio-video-camera/detect-and-respond-to-audio-state-changes).
