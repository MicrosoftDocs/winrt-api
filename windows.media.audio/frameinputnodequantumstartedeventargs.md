---
-api-id: T:Windows.Media.Audio.FrameInputNodeQuantumStartedEventArgs
-api-type: winrt class
---

<!-- Class syntax.
public class FrameInputNodeQuantumStartedEventArgs : Windows.Media.Audio.IFrameInputNodeQuantumStartedEventArgs
-->
