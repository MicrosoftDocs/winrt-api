---
-api-id: T:Windows.Media.Audio.AudioNodeEmitterNaturalDecayModelProperties
-api-type: winrt class
---

<!-- Class syntax.
public class AudioNodeEmitterNaturalDecayModelProperties : Windows.Media.Audio.IAudioNodeEmitterNaturalDecayModelProperties
-->
