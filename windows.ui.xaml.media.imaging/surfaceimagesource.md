...
For more info on how to draw to a SurfaceImageSource, including sample code, see [DirectX and XAML interop](https://docs.microsoft.com/previous-versions/windows/apps/hh825871(v=win.10)).
