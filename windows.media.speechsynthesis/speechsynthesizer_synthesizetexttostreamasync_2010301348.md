...
To generate speech from [Speech Synthesis Markup Language (SSML) Version 1.1](http://go.microsoft.com/fwlink/p/?LinkID=201763), see [SynthesizeSsmlToStreamAsync](speechsynthesizer_synthesizessmltostreamasync_1873155127.md).
