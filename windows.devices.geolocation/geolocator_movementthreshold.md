...
## -property-value
The distance of required movement, in meters, for location services to raise a
[PositionChanged](geolocator_positionchanged.md) event. The default value is 0.
