...
## -remarks
> [!IMPORTANT]
> The value of **ReportInterval** must be greater than or equal to 1. Passing 0 is not supported, and is treated as *not set*. To request the minimum supported update interval, set **ReportInterval** to 1 (1 millisecond).
