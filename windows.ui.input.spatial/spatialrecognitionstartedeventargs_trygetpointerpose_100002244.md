---
-api-id: M:Windows.UI.Input.Spatial.SpatialRecognitionStartedEventArgs.TryGetPointerPose(Windows.Perception.Spatial.SpatialCoordinateSystem)
...
# Windows.UI.Input.Spatial.SpatialRecognitionStartedEventArgs.TryGetPointerPose
