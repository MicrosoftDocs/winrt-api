...
## -description
Gets the available pointing poses, such as the user's head gaze and each spatial controller's pointing pose, for the timestamp when this state snapshot was taken.
