...
## -description
Gets the available pointing poses, such as the user's head gaze and each spatial controller's pointing pose, for use in routing this interaction to a SpatialGestureRecognizer.
