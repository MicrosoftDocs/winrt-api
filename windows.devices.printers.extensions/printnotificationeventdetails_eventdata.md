...
## -remarks
The  property is nested XML that is formatted as string. To get this property, parse for the Bidi request and response schema that is embedded in an `<Envelope>`, following the AsyncUI's [balloonUI](https://msdn.microsoft.com/library/8db15dcb-26ed-429e-ad4c-e5dc59f9bbca) element message, which contains the [action](https://msdn.microsoft.com/library/dae207ad-072e-4de6-b6a2-f1188ce91065) element. The [action](https://msdn.microsoft.com/library/dae207ad-072e-4de6-b6a2-f1188ce91065) element contains the `<Envelope>` where the Bidi response schema is found. Examine the Bidi response to determine the cause of the event.
