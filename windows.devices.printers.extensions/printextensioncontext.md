...
For more information about using the **PrinterExtensionContext** class, see the [UWP device apps for printers](https://msdn.microsoft.com/library/windows/hardware/dn265150(v=vs.85).aspx) topic on the Hardware Dev Center.

## -examples

## -see-also
[DeviceInformation class](https://docs.microsoft.com/uwp/api/windows.devices.enumeration.deviceinformation), [UWP device apps for printers](https://msdn.microsoft.com/library/windows/hardware/dn265150(v=vs.85).aspx)
