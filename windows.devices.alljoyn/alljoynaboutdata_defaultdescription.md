...
## -remarks
By default the returned value is pulled from either the "Description" field in a UWP app 's app manifest, or [FileDescription](https://msdn.microsoft.com/library/windows/desktop/bb760697(v=vs.85).aspx) property of the EXE in a Desktop app.
