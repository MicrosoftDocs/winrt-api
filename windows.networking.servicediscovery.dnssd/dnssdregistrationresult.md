...
## -remarks
See [RFC 1034](http://go.microsoft.com/fwlink/?LinkId=524161) for details about the format and contents of the DNS SRV RR, and [RFC 2782](http://go.microsoft.com/fwlink/?LinkId=524158) for details about how DNS-SD clients and servers use those records.
