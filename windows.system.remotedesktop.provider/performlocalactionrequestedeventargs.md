...
Provides data for the [PerformLocalActionRequested](/uwp/api/windows.system.remotedesktop.provider/remotedesktopconnectionremoteinfo_performlocalactionrequested) event.
