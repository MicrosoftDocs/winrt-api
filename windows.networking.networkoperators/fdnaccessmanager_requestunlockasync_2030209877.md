...
## -returns
An asynchronous retrieval operation. On successful completion, contains a [Boolean](https://msdn.microsoft.com/library/system.boolean.aspx) value representing whether the PIN was entered successfully.
