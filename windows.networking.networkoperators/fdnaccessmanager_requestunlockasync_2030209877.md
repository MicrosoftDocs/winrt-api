...
## -returns
An asynchronous retrieval operation. On successful completion, contains a [Boolean](/dotnet/api/system.boolean?redirectedfrom=MSDN) value representing whether the PIN was entered successfully.
