---
-api-id: P:Windows.Networking.NetworkOperators.ESimProfileMetadata.ProviderIcon
...
# Windows.Networking.NetworkOperators.ESimProfileMetadata.ProviderIcon
...
## -property-value
A memory buffer containing the icon of the mobile network operator (MNO) provider for the eSIM profile.
