---
-api-id: M:Windows.UI.Xaml.Automation.Provider.IScrollProvider.Scroll(Windows.UI.Xaml.Automation.ScrollAmount,Windows.UI.Xaml.Automation.ScrollAmount)
...
# Windows.UI.Xaml.Automation.Provider.IScrollProvider.Scroll

## -description
Scrolls the visible region of the content area horizontally, vertically, or both.

Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Automation.Provider.IScrollProvider.Scroll](/windows/winui/api/microsoft.ui.xaml.automation.provider.iscrollprovider.scroll).
