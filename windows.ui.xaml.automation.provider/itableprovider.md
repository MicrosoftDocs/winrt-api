...
## -remarks
This pattern has guidelines and conventions that aren't fully documented here. For more info on what this pattern is for, see [Table Control Pattern](https://msdn.microsoft.com/library/81a1a316-cdd6-4490-8de2-1b6db52d84e6).
...
## -see-also
[IGridProvider](igridprovider.md), [ITableItemProvider](itableitemprovider.md), [ITableProvider (COM interface)](https://msdn.microsoft.com/library/ae6be8be-78ea-4843-924f-2dc5d5286da2), [Table Control Pattern](https://msdn.microsoft.com/library/81a1a316-cdd6-4490-8de2-1b6db52d84e6), [Custom automation peers](https://msdn.microsoft.com/library/aa8da53b-fe6e-40ac-9f0a-cb09637c87b4)
