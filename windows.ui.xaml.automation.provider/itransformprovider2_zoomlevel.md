...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Automation.Provider.ITransformProvider2.ZoomLevel](/windows/winui/api/microsoft.ui.xaml.automation.provider.itransformprovider2.zoomlevel).
