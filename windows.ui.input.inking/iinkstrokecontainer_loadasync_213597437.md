...
## -returns
The status of the asynchronous operation as the number of bytes fetched. For more information, see [ReadAsync](https://msdn.microsoft.com/library/4d5046c8-a1d2-435f-9c3d-64c242fc20cf) method.
