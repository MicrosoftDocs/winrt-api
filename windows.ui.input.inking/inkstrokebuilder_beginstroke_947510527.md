---
-api-id: M:Windows.UI.Input.Inking.InkStrokeBuilder.BeginStroke(Windows.UI.Input.PointerPoint)
-api-type: winrt method
---

<!-- Method syntax
public void BeginStroke(Windows.UI.Input.PointerPoint pointerPoint)
-->
