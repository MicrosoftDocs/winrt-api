---
-api-id: P:Windows.UI.Input.Inking.InkManager.Mode
-api-type: winrt property
-api-device-family-note: xbox
---

<!-- Property syntax
public Windows.UI.Input.Inking.InkManipulationMode Mode { get;  set; }
-->

# Windows.UI.Input.Inking.InkManager.Mode
