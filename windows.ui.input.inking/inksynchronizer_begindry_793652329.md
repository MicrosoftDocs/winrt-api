...
## -returns
The collection of "wet" ink strokes to pass to the [IInkD2DRenderer](https://docs.microsoft.com/windows/desktop/api/inkrenderer/nn-inkrenderer-iinkd2drenderer) object .
