...
## -description
Gets or sets the position and rotation angle of the [InkPresenterRuler](inkpresenterruler.md) within the 2-D coordinate space of the [InkCanvas](../windows.ui.xaml.controls/inkcanvas.md).
