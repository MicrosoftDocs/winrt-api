---
-api-id: E:Windows.UI.Input.Inking.InkUnprocessedInput.PointerLost
-api-type: winrt event
-api-device-family-note: xbox
---

<!-- Event syntax
public event Windows.Foundation.TypedEventHandler PointerLost<Windows.UI.Input.Inking.InkUnprocessedInput,  Windows.UI.Core.PointerEventArgs>
-->

# Windows.UI.Input.Inking.InkUnprocessedInput.PointerLost
