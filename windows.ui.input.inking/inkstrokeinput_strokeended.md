...
<!-- Event syntax
public event Windows.Foundation.TypedEventHandler StrokeEnded<Windows.UI.Input.Inking.InkStrokeInput,  Windows.UI.Core.PointerEventArgs>
-->

# Windows.UI.Input.Inking.InkStrokeInput.StrokeEnded
