---
-api-id: M:Windows.Storage.BulkAccess.FileInformation.OpenTransactedWriteAsync(Windows.Storage.StorageOpenOptions)
...
## -returns
When this method completes, it returns a [StorageStreamTransaction](../windows.storage/storagestreamtransaction.md) that contains the random-access stream and methods that can be used to complete transactions.
...
## -see-also
[OpenTransactedWriteAsync](fileinformation_opentransactedwriteasync_579614817.md)