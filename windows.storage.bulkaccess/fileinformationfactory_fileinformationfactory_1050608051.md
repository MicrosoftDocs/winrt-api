...
## -remarks
If the query specified [SetThumbnailPrefetch](../windows.storage.search/queryoptions_setthumbnailprefetch.md) options, those options are overridden by options requested in any of the [FileInformationFactory](fileinformationfactory_fileinformationfactory_1050608051.md) constructors.
