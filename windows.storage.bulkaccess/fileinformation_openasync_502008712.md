---
-api-id: M:Windows.Storage.BulkAccess.FileInformation.OpenAsync(Windows.Storage.FileAccessMode)
-api-type: winrt method
---

<!-- Method syntax
public Windows.Foundation.IAsyncOperation<Windows.Storage.Streams.IRandomAccessStream> OpenAsync(Windows.Storage.FileAccessMode accessMode)
-->
...
## -see-also
[OpenAsync(FileAccessMode, StorageOpenOptions)](fileinformation_openasync_1542217918.md)