---
-api-id: P:Windows.UI.Text.Core.CoreTextTextRequest.IsCanceled
...
# Windows.UI.Text.Core.CoreTextTextRequest.IsCanceled

## -description
Gets a value that indicates whether the text request operation is canceled.

## -property-value
**true** if the text request operation is canceled; otherwise, **false**.
