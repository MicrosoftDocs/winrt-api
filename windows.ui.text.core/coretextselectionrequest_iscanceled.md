---
-api-id: P:Windows.UI.Text.Core.CoreTextSelectionRequest.IsCanceled
...
# Windows.UI.Text.Core.CoreTextSelectionRequest.IsCanceled

## -description
Gets a value that indicates whether the selection request operation is canceled.

## -property-value
**true** if the selection request operation is canceled; otherwise, **false**.
