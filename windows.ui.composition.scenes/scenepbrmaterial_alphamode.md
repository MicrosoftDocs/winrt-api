...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.Scenes.ScenePbrMaterial.AlphaMode](/windows/winui/api/microsoft.ui.composition.scenes.scenepbrmaterial.alphamode).
