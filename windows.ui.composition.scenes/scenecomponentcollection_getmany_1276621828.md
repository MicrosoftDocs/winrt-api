...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.Scenes.SceneComponentCollection.GetMany](/windows/winui/api/microsoft.ui.composition.scenes.scenecomponentcollection.getmany).
