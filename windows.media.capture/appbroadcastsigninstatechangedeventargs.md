---
-api-id: T:Windows.Media.Capture.AppBroadcastSignInStateChangedEventArgs
-api-type: winrt class
---

<!-- Class syntax.
public class AppBroadcastSignInStateChangedEventArgs : Windows.Media.Capture.IAppBroadcastSignInStateChangedEventArgs
-->
