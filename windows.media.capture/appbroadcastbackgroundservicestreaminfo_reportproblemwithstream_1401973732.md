...
## -remarks
The may be a problem with the broadcast stream if the [FrameId](https://docs.microsoft.com/en-us/uwp/api/windows.media.capture.appbroadcaststreamvideoheader.FrameId) of an audio or video frame is not an increment of 1 from the previous frame.
