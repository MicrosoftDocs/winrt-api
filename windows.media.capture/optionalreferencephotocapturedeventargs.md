...
## -see-also
[AdvancedPhotoCapture](advancedphotocapture.md), [High dynamic range (HDR) and low-light photo capture](/windows/apps/develop/camera/hdr-low-light-photo-capture)
