---
-api-id: T:Windows.Media.Capture.CameraCaptureUIMaxVideoResolution
-api-type: winrt enum
---

<!-- Enumeration syntax
public enum Windows.Media.Capture.CameraCaptureUIMaxVideoResolution : int
-->
