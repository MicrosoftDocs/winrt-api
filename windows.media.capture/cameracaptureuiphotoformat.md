...
## -see-also
[Capture photos and video with Windows built-in camera UI](/windows/apps/develop/audio-video-camera/capture-photos-and-video-with-cameracaptureui), [CameraCaptureUI](cameracaptureui.md), [CameraCaptureUIPhotoCaptureSettings.Format](cameracaptureuiphotocapturesettings_format.md)
