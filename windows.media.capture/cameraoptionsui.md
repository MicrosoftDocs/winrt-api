...
## -see-also
[Audio, video, and camera](https://docs.microsoft.com/windows/uwp/audio-video-camera/index), [Audio, video, and camera](https://docs.microsoft.com/windows/uwp/audio-video-camera/index), [Camera capture UI sample](http://code.msdn.microsoft.com/windowsapps/CameraCaptureUI-Sample-845a53ac), [Camera options UI sample](https://go.microsoft.com/fwlink/p/?linkid=228588)
