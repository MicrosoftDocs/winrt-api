...
## -see-also
[Capture photos and video with Windows built-in camera UI](/windows/apps/develop/camera/cameracaptureui), [CameraCaptureUI](cameracaptureui.md), [CameraCaptureUIPhotoCaptureSettings.Format](cameracaptureuiphotocapturesettings_format.md)
