...
## -see-also
[MediaCaptureVideoProfile.GetConcurrency](mediacapturevideoprofile_getconcurrency_2045494455.md), [Discover and select camera capabilities with camera profiles](/windows/apps/develop/camera/camera-profiles)
## -capabilities
