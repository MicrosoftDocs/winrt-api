...
## -see-also
[Discover and select camera capabilities with camera profiles](/windows/apps/develop/camera/camera-profiles),

[Process media frames with MediaFrameReader](/windows/apps/develop/camera/process-media-frames-with-mediaframereader)
