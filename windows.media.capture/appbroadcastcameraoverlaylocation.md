---
-api-id: T:Windows.Media.Capture.AppBroadcastCameraOverlayLocation
-api-type: winrt enum
---

<!-- Enumeration syntax
public enum Windows.Media.Capture.AppBroadcastCameraOverlayLocation : int
-->
