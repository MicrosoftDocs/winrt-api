...
## -see-also
[Audio, video, and camera](/windows/uwp/audio-video-camera/index), [Capture photos and video in a desktop app with the Windows built-in camera UI](/windows/apps/develop/camera/cameracaptureui)
