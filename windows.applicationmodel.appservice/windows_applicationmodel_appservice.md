...
[Create and consume an app service](https://msdn.microsoft.com/windows/uwp/launch-resume/how-to-create-and-consume-an-app-service), [App services sample (Windows 10)](https://go.microsoft.com/fwlink/p/?LinkId=620489)
