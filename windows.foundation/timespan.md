...
> **.NET**
> When programming with .NET, this structure is hidden, and developers should use the [System.TimeSpan](/dotnet/api/system.timespan?redirectedfrom=MSDN) type.
...
## -remarks
When programming with .NET, this structure is hidden and developers should use the [System.TimeSpan](/dotnet/api/system.timespan?redirectedfrom=MSDN) structure.
...
## -see-also
[DateTime](datetime.md), [System.TimeSpan](/dotnet/api/system.timespan?redirectedfrom=MSDN)
