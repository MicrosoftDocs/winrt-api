...
When programming with .NET, this interface is hidden and is replaced by the [System.IDisposable](/dotnet/api/system.idisposable?redirectedfrom=MSDN) interface.
