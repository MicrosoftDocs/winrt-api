...
Specifically, if you want to handle progress in .NET code, use the **AsTask** signature that in an extension usage has a single [IProgress](https://msdn.microsoft.com/library/hh138298) reference parameter. (In this usage, the progress unit is already constrained and matches the [IAsyncActionWithProgress](iasyncactionwithprogress_1.md) method you're using.) Provide an object that implements [IProgress](https://msdn.microsoft.com/library/hh138298), and your [Report](https://msdn.microsoft.com/library/hh193864) method implementation is invoked each time the Windows Runtime method reports a progress notification.
