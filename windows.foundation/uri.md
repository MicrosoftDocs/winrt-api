...
+ ms-resource: refers to app resources in the [Resource Management System](/previous-versions/windows/apps/jj552947(v=win.10)). For more info, see "How to load string resources" ([HTML](/previous-versions/windows/apps/hh465248(v=win.10)) or [XAML](/previous-versions/windows/apps/hh965323(v=win.10))).
