...
## -description
A constraint for a [SpeechRecognizer](speechrecognizer.md) object based on a [](https://docs.microsoft.com/en-us/uwp/schemas/voicecommands/voice-command-elements-and-attributes-1-2.md) file.
