...
## -description
A dictionary that contains all installed command sets that have a [Name](voice_command_elements_and_attributes.md) attribute set in the [](voice_command_elements_and_attributes.md) file.
