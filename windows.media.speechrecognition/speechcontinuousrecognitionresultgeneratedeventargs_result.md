---
-api-id: P:Windows.Media.SpeechRecognition.SpeechContinuousRecognitionResultGeneratedEventArgs.Result
...
## -description
Gets the complete recognition result returned by the speech recognizer at the end of a dictation session ([SpeechRecognitionResultStatus](speechrecognitionresultstatus.md) is set to [Success](speechrecognitionresultstatus.md)).
