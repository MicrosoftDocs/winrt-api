...
Asynchronously begin a continuous speech recognition (dictation) session with the specified [SpeechContinuousRecognitionMode](speechcontinuousrecognitionmode.md) behavior.
...
## -remarks
[CompileConstraintsAsync](speechrecognizer_compileconstraintsasync.md) must always be called before [StartAsync](speechcontinuousrecognitionsession_startasync_192219967.md), even if no constraints are specified in the [Constraints](speechrecognizer_constraints.md) property.
