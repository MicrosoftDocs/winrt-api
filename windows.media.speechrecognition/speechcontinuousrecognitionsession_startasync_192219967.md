...
## -remarks
[CompileConstraintsAsync](speechrecognizer_compileconstraintsasync_1901700993.md) must always be called before [StartAsync](speechcontinuousrecognitionsession_startasync_192219967.md), even if no constraints are specified in the [Constraints](speechrecognizer_constraints.md) property.
