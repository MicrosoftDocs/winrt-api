...
## -description
A constraint for a [SpeechRecognizer](speechrecognizer.md) object based on a list of words or phrases. When initialized, this object is added to the [Constraints](speechrecognizer_constraints.md) collection.
