...
## -description
Populates a [PhraseList](/uwp/schemas/voicecommands/voice-command-elements-and-attributes-1-2.md) element with an array of [Item](/uwp/schemas/voicecommands/voice-command-elements-and-attributes-1-2.md) elements.

## -parameters
### -param phraseListName
The string that corresponds to the label attribute of the [PhraseList](/uwp/schemas/voicecommands/voice-command-elements-and-attributes-1-2.md) element.

### -param phraseList
A string array of values that will be added to the [PhraseList](/uwp/schemas/voicecommands/voice-command-elements-and-attributes-1-2.md) element as [Item](/uwp/schemas/voicecommands/voice-command-elements-and-attributes-1-2.md) elements.
