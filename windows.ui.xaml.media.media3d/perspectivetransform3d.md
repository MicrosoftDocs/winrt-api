...
Following the guidelines of the [The Direct3D Transformation Pipeline](XREF:TODO:dxtecharts.the_direct3d_transformation_pipeline), [PerspectiveTransform3D](perspectivetransform3d.md) represents a projection transform. In comparison, [CompositeTransform3D](compositetransform3d.md) represents a world or view transform. Because of this, [PerspectiveTransform3D](perspectivetransform3d.md) should usually be applied at the root of the XAML scene. In most cases, this would be the [Page](../windows.ui.xaml.controls/page.md) element.
