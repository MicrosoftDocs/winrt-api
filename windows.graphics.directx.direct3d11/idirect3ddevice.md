...
## -remarks
To move back and forth between [IDirect3DDevice](idirect3ddevice.md) and [IDXGIDevice](/windows/desktop/api/dxgi/nn-dxgi-idxgidevice), use the [CreateDirect3DDevice](https://msdn.microsoft.com/library/windows/apps/dn895089) and [GetDXGIInterface(IDirect3DDevice^, DXGI_TYPE**)](https://msdn.microsoft.com/library/windows/apps/dn895100) functions.
