...
## -remarks
An instance of [HttpDiagnosticProvider](httpdiagnosticprovider.md) is returned from the [CreateFromProcessDiagnosticInfo](httpdiagnosticprovider_createfromprocessdiagnosticinfo.md) method.
