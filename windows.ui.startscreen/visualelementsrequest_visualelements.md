...
## -description
Gets a copy of the parent secondary tile's [SecondaryTileVisualElements](secondarytilevisualelements.md)object. The visual elements properties can be set or read through this object. When [deferral](visualelementsrequest_getdeferral.md) is complete (or the handler returns without a deferral), the properties in this object are verified and then reflected in the **Pin to Start**  flyout.
