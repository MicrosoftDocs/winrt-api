---
-api-id: T:Windows.UI.StartScreen.VisualElementsRequestDeferral
-api-type: winrt class
---

<!-- Class syntax.
public class VisualElementsRequestDeferral : Windows.UI.StartScreen.IVisualElementsRequestDeferral
-->
