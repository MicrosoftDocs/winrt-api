...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.Interactions.InteractionTracker.ScaleInertiaDecayRate](/windows/winui/api/microsoft.ui.composition.interactions.interactiontracker.scaleinertiadecayrate).
