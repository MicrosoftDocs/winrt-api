...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.Interactions.CompositionConditionalValue](/windows/winui/api/microsoft.ui.composition.interactions.compositionconditionalvalue).
