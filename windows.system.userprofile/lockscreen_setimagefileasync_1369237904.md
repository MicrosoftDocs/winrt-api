...
## -see-also
[Personalization app sample](http://go.microsoft.com/fwlink/p/?linkid=231592), [LockScreen.getImageStream](lockscreen_getimagestream.md), [LockScreen.originalImageFile](lockscreen_originalimagefile.md), [LockScreen.setImageStreamAsync](lockscreen_setimagestreamasync.md), [Lock screen overview](http://msdn.microsoft.com/library/07fefb48-f55c-4ab7-8b68-a8aed11074fd)