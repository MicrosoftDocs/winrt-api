...
The coordinates (in DIPs), relative to the window, of the user's finger or mouse pointer when the [oncontextmenu](XREF:TODO:wwa.oncontextmenu_Event) event fired. The menu is placed above and centered on this point.
...
ng context menus](XREF:TODO:m_ui_contextmenu.adding_context_menus_portal), [Context menu sample](http://go.microsoft.com/fwlink/p/?linkid=234891), [Guidelines and checklist for ](XREF:TODO:m_ui_contextmenu.guidelines_and_checklist_for_context_menus), [IUICommand](iuicommand.md), [oncontextmenu](XREF:TODO:wwa.oncontextmenu_Event), [Point](../windows.foundation/point.md), [PopupMenu.Commands](popupmenu_commands.md), [UICommand](uicommand.md)