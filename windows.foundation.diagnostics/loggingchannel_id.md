...
The value of the **Id** depends on how the **LoggingChannel** is constructed as described in the following table:<table>
   ...
   <tr><td>[LoggingChannel(String)](loggingchannel_loggingchannel_290278668.md)</td><td>The channel will be operating in Windows 8.1 compatibility mode and will return **4bd2826e-54a1-4ba9-bf63-92b73ea1ac4a** which is the GUID for the Microsoft-Windows-Diagnostics-LoggingChannel manifest.</td></tr>
