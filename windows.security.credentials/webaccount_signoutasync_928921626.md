---
-api-id: M:Windows.Security.Credentials.WebAccount.SignOutAsync
-api-type: winrt method
---

<!-- Method syntax
public Windows.Foundation.IAsyncAction SignOutAsync()
-->
...
## -see-also
[SignOutAsync(String)](webaccount_signoutasync_1860157754.md)