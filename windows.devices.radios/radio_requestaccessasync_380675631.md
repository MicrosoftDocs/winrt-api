...
2. Enumerate radios using [GetRadiosAsync](radio_getradiosasync_548754145.md) or device enumeration with [GetDeviceSelector](radio_getdeviceselector_838466080.md).
