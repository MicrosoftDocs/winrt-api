...
Content consumption settings define whether a specific piece of content can be consumed (e.g. whether an app can be installed, or a movie can be watched). If content is blocked for consumption, the child is given an option to ask for a parental override.
