...
## -remarks
If a read operation is in progress when an application attemptes to detach the stream, the call will fail with the error HRESULT_FROM_WIN32(ERROR_INVALID_OPERATION).
