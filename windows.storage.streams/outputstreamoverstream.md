...
## -description
Provides a Windows Runtime output stream for an [IStream](https://docs.microsoft.com/windows/desktop/api/objidl/nn-objidl-istream) base implementation.
...
## -see-also
[InputStreamOverStream](inputstreamoverstream.md), [RandomAccessStreamOverStream](randomaccessstreamoverstream.md), [IStream](https://docs.microsoft.com/windows/desktop/api/objidl/nn-objidl-istream)
