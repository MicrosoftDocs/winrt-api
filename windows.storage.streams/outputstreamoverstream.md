...
## -description
Provides a Windows Runtime output stream for an [IStream](XREF:TODO:stg.istream) base implementation.
...
## -see-also
[InputStreamOverStream](inputstreamoverstream.md), [RandomAccessStreamOverStream](randomaccessstreamoverstream.md), [IStream](XREF:TODO:stg.istream)