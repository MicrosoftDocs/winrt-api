...
## -description
> [!NOTE]
> TryUnsnap may be altered or unavailable for releases after Windows 8.1. Apps can be continuously resized, but cannot be snapped, starting in Windows 8.1. Also, ApplicationView static methods may be altered or unavailable for releases after Windows 8.1. Use [ApplicationView.GetForCurrentView](applicationview_getforcurrentview.md) to get an [ApplicationView](applicationview.md) object.
