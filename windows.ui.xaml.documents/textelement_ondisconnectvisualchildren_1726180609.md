...
## -remarks
[TextElement](textelement.md) does not define any of the content or children properties that [OnDisconnectVisualChildren](textelement_ondisconnectvisualchildren.md) might act upon. Such properties are introduced by derived classes such as [Paragraph](paragraph.md).
