...
Because [FindName](textelement_findname.md) relies on all the XAML sources being parsed for the **Name** attributes, you should not attempt to call [FindName](textelement_findname.md) until the XAML is loaded.

Names and [FindName](textelement_findname.md) are influenced by the concept of a XAML namescope. 
