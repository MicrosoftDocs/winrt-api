...
## -remarks
[Hyperlink](hyperlink.md) has restrictions on the content that can exist in its [Inlines](span_inlines.md) colllection. Specifically, a [Hyperlink](hyperlink.md) only permits [Run](run.md) and other [Span](span.md) types that aren't another [Hyperlink](hyperlink.md). [InlineUIContainer](inlineuicontainer.md) can't be in the [Inlines](span_inlines.md) colllection of a [Hyperlink](hyperlink.md). Attempting to add restricted content throws an invalid args exception or XAML parse exception.
