...
## -remarks
Some functionality in this class is restricted to specific development languages. The parent topic, [ValueSet](valueset.md) class, indicates which members are accessible in specific languages. For functionality similar to this member, see [Add(String,Object)](valueset_add_2.md) and [Add(KeyValuePair)](valueset_add_1.md).

## -examples

## -see-also
[Add(String,Object)](valueset_add_2.md), [Add(KeyValuePair)](valueset_add_1.md)