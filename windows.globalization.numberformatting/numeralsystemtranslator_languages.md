...
## -description
Gets the [BCP-47](http://go.microsoft.com/fwlink/p/?linkid=227302) language tag(s) used to initialize this [NumeralSystemTranslator](numeralsystemtranslator.md) object.

## -property-value
The [BCP-47](http://go.microsoft.com/fwlink/p/?linkid=227302) language tag(s) used to initialize this [NumeralSystemTranslator](numeralsystemtranslator.md) object. There is always at least one.
