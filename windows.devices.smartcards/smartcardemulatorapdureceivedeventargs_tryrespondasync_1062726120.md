...
## -see-also
[TryRespondAsync(IBuffer, IReference(UInt32))](smartcardemulatorapdureceivedeventargs_tryrespondasync_968497288.md), [Create an NFC Smart Card app](https://msdn.microsoft.com/library/26834a51-512b-485b-84c8-abf713787588)
