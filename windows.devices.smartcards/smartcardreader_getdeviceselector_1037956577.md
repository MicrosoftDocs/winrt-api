...
## -see-also
[GetDeviceSelector](smartcardreader_getdeviceselector_838466080.md), [Create an NFC Smart Card app](https://docs.microsoft.com/windows/uwp/devices-sensors/host-card-emulation)
