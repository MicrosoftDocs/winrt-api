...
You can obtain a [BindingExpression](bindingexpression.md) object by calling the [GetBindingExpression](../windows.ui.xaml/frameworkelement_getbindingexpression.md) method on an object, specifying the dependency property that has the binding.
