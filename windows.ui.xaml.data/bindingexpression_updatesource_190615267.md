...
## -remarks
If the [UpdateSourceTrigger](binding_updatesourcetrigger.md) value of a two-way binding is set to **Explicit**, you must call the [UpdateSource](bindingexpression_updatesource.md) method or the changes will not propagate back to the source.
