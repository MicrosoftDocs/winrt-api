...
Equivalent **WinUI 2 API for UWP**: [UpdateSourceTrigger](/windows/winui/api/microsoft.ui.xaml.data.updatesourcetrigger) (for WinUI in the [Windows App SDK](/windows/apps/windows-app-sdk/), see the **[Windows App SDK namespaces](/windows/windows-app-sdk/api/winrt/)**).
