...
If a value for [ConverterParameter](binding_converterparameter.md) is specified, this value is used for the *parameter* value when invoking the converter logic. Specifically, this provides the value of the *parameter* parameter of the [Convert](ivalueconverter_convert.md) or [ConvertBack](ivalueconverter_convertback.md) methods of the specific converter that is requested with the [Converter](binding_converter.md) property.
