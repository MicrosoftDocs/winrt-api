...
## -remarks
You create a [HashAlgorithmProvider](hashalgorithmprovider.md) object by calling the static [OpenAlgorithm](hashalgorithmprovider_openalgorithm.md) method and specifying one of the following algorithm names:
+ MD5
+ SHA1
+ SHA256
+ SHA384
...
[!code-cs[ShowHashAlgProviderClass] (../windows.security.cryptography/code/crypto-snippets/cs/cryptosnippets.cs#ShowHashAlgProviderClass)]
