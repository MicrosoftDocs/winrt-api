...
## -remarks
You create a [MacAlgorithmProvider](macalgorithmprovider.md) object by calling the static [OpenAlgorithm](macalgorithmprovider_openalgorithm.md) method and specifying one of the following algorithm names:
...
[!code-cs[ShowMacAlgProviderClass] (../windows.security.cryptography/code/crypto-snippets/cs/cryptosnippets.cs#ShowMacAlgProviderClass)]
