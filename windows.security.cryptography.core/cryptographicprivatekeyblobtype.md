...
Microsoft private key format defined by the legacy Cryptography API (CAPI). For more information, see [Base Provider Key BLOBs](https://msdn.microsoft.com/library/b4592036-0fa3-4b7e-beed-78cf1d2f39a9).
