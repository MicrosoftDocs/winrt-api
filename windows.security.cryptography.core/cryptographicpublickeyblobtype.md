...
Microsoft public key format defined by the legacy Cryptography API (CAPI). For more information, see [Base Provider Key BLOBs](https://docs.microsoft.com/windows/desktop/SecCrypto/base-provider-key-blobs).
