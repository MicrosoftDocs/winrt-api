...
## -remarks
You create a [SymmetricKeyAlgorithmProvider](symmetrickeyalgorithmprovider.md) object by calling the static [OpenAlgorithm](symmetrickeyalgorithmprovider_openalgorithm.md) method and specifying one of the following algorithm names.
