...
## -remarks
The Printing3DMaterial class roughly corresponds to the `<resources>` element in the 3D Manufacturing Format (3MF) specification. For more info, see the [3MF Specification](https://go.microsoft.com/fwlink/p/?LinkId=616252).
