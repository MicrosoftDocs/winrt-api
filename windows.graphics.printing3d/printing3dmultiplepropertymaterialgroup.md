...
The [Printing3DMultiplePropertyMaterialGroup](printing3dmultiplepropertymaterialgroup.md) class corresponds to the `<multiproperties>` element in the 3D Manufacturing Format (3MF) specification. For more info, see the [3MF Specification](http://go.microsoft.com/fwlink/p/?LinkId=616252).
