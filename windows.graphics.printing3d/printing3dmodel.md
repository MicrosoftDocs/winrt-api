...
## -remarks
The Printing3DModel class corresponds to the `<model>` element in the 3D Manufacturing Format (3MF) specification. For more info, see the [3MF Specification](https://3mf.io/3mf-specification/).
