...
## -remarks
The [Printing3DBaseMaterial](printing3dbasematerial.md) class corresponds to the `<base>` element in the 3D Manufacturing Format (3MF) specification. For more info, see the [3MF Specification](https://go.microsoft.com/fwlink/p/?LinkId=616252).
