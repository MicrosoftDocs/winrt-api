...
## -remarks
The [Printing3DTexture2CoordMaterialGroup](printing3dtexture2coordmaterialgroup.md) class corresponds to the `<texture2dgroup>` element in the 3D Manufacturing Format (3MF) specification. For more info, see the [3MF Specification](http://go.microsoft.com/fwlink/p/?LinkId=616252).
