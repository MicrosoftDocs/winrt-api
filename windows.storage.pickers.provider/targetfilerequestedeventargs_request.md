---
-api-id: P:Windows.Storage.Pickers.Provider.TargetFileRequestedEventArgs.Request
-api-type: winrt property
-api-device-family-note: xbox
---

<!-- Property syntax
public Windows.Storage.Pickers.Provider.TargetFileRequest Request { get; }
-->
...
## -see-also
[TargetFileRequest class](targetfilerequest.md), [TargetFileRequestedEventArgs class](targetfilerequestedeventargs.md)