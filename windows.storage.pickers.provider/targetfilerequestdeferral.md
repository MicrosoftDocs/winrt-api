...
## -examples
The [File picker sample](/samples/browse/) demonstrates how to respond to a [targetfilerequested](filesavepickerui_targetfilerequested.md) event handler, including how to get a deferral.
