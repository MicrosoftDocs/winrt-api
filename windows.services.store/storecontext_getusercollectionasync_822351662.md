...
## -returns
An asynchronous operation that, on successful completion, returns a [StoreProductQueryResult](storeproductqueryresult.md) object that contains Microsoft Store listing info for the add-ons of the current app for which the user has entitlements to use.
