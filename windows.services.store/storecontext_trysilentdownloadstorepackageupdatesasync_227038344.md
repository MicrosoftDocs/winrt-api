...
To get the list of packages that have updates available, use the [GetAppAndOptionalStorePackageUpdatesAsync](storecontext_getappandoptionalstorepackageupdatesasync.md) method. After you download the packages, you can install them by using the [TrySilentDownloadAndInstallStorePackageUpdatesAsync](storecontext_trysilentdownloadandinstallstorepackageupdatesasync_788206773.md) method. 
