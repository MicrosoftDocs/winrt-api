...
## -remarks
This property is only intended to be used in the context of a [multi-user app](https://msdn.microsoft.com/windows/uwp/xbox-apps/multi-user-applications). In this scenario, the **User** property returns the same [User](../windows.system/user.md) object that you passed to the [GetForUser](storecontext_getforuser.md) method when you created the [StoreContext](storecontext.md) object for a specific user.
