...
The following table provides definitions for the currently supported values. Additional values may be supported in the future.<table>
   ...
   <tr><td>**Application**</td><td>An app that belongs to any category other than **Games**. For more info, see [Category and subcategory table](https://docs.microsoft.com/windows/uwp/publish/category-and-subcategory-table).</td></tr>
   <tr><td>**Game**</td><td>An app that belongs to the **Games** category. For more info, see [Category and subcategory table](https://docs.microsoft.com/windows/uwp/publish/category-and-subcategory-table).</td></tr>
