...
## -remarks
For more information about using this method, including a code example, see [Enable in-app purchases of apps and add-ons](https://docs.microsoft.com/windows/uwp/monetize/enable-in-app-purchases-of-apps-and-add-ons).
...
## -see-also
[RequestPurchaseAsync(String, StorePurchaseProperties)](storecontext_requestpurchaseasync_1039951085.md), [Enable in-app purchases of apps and add-ons](https://docs.microsoft.com/windows/uwp/monetize/enable-in-app-purchases-of-apps-and-add-ons)
