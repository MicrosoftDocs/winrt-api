...
## -remarks
For an app, this property corresponds to the Store ID that is available on the **App identity** page for the app in [Partner Center](https://partner.microsoft.com/dashboard). For more information, see [View app identity details](https://docs.microsoft.com/windows/uwp/publish/view-app-identity-details).
