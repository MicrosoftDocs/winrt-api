...
## -description
Gets Windows Store listing info for the products that can be purchased from within the current app.
...
## -see-also
[StoreProductQueryResult](storeproductqueryresult.md), [Get product info for apps and add-ons](https://msdn.microsoft.com/windows/uwp/monetize/get-product-info-for-apps-and-add-ons), [Store sample](https://github.com/Microsoft/Windows-universal-samples/tree/master/Samples/Store)
