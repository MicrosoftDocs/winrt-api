...
After you have a [StoreProductPagedQueryResult](storeproductpagedqueryresult.md) object, you can retrieve the object that contains the next page of results by using the [GetNextAsync](storeproductpagedqueryresult_getnextasync_1854313260.md) method.
