---
-api-id: T:Windows.Services.Store.StorePackageLicense
-api-type: winrt class
---

<!-- Class syntax.
public class StorePackageLicense : Windows.Foundation.IClosable, Windows.Services.Store.IStorePackageLicense
-->
