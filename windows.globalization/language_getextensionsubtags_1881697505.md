...
## -parameters
### -param singleton
A single-character subtag for the [LanguageTag](language_languagetag.md) of the current language. See [BCP-47 language tags, Extensions and the Extensions Registry](http://go.microsoft.com/fwlink/p/?LinkId=282719).
...
## -see-also
[LanguageTag](language_languagetag.md), [BCP-47 language tags, Extensions and the Extensions Registry](http://go.microsoft.com/fwlink/p/?LinkId=282719), [BCP-47 language tags, Extension Subtags](http://go.microsoft.com/fwlink/p/?LinkId=282718)