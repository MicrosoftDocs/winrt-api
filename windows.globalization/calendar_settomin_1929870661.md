...
## -description
Sets the components of this [Calendar](calendar.md) object to the earliest date and time that are supported.
...
- Call either [SetToMin](calendar_settomin_1929870661.md) or [SetToMax](calendar_settomax_44967827.md), and then
