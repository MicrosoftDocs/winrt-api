...
Add a property to index by calling the [Insert](../windows.foundation.collections/imap_2_insert_884970571.md) method with a standard Windows property name, like [System.Author](https://docs.microsoft.com/windows/desktop/properties/props-system-author), and a [PropertyValue](../windows.foundation/propertyvalue.md).
