...
This list is initally empty and will not list arcade sticks even if they are already connected. After a short period this will return a complete list of arcade sticks.
