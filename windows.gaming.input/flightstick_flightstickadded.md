...
To identify flight sticks that have already been added, you query the list of conected flight sticks using [FlightStick.FlightSticks](flightstick_flightsticks.md).
