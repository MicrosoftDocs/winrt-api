...
This list is initally empty and will not list UI navigation controllers even if they are already connected. After a short period this will return a complete list of UI navigation controllers.
