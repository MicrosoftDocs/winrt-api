...
## -remarks
You can use the [CheckAvailabilityAsync](userconsentverifier_checkavailabilityasync.md) method to determine if fingerprint authentication is supported for the current computer.
...
[!code-csharp[1](../windows.security.credentials.ui/code/BiometricAuth/cs/MainPage.xaml.cs#Snippet1)][!code-js[1](../windows.security.credentials.ui/code/BiometricAuth/js/default.js#Snippet1)]
