---
-api-id: T:Windows.Media.DialProtocol.DialDeviceSelectedEventArgs
-api-type: winrt class
---

<!-- Class syntax.
public class DialDeviceSelectedEventArgs : Windows.Media.DialProtocol.IDialDeviceSelectedEventArgs
-->
