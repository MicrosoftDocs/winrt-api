...
[How to specify device capabilities for HID](https://docs.microsoft.com/uwp/schemas/appxpackage/how-to-specify-device-capabilities-for-hid), [Supporting human interface devices (HID)](https://docs.microsoft.com/previous-versions/windows/apps/dn263140(v=win.10)), [Sample Windows Runtime app for HID](http://channel9.msdn.com/Blogs/One-Dev-Minute/Building-a-HID-motion-sensor), [Custom HID device sample](https://github.com/Microsoft/Windows-universal-samples/tree/6370138b150ca8a34ff86de376ab6408c5587f5d/Samples/CustomHidDeviceAccess), [Apps for HID devices video](http://go.microsoft.com/fwlink/p/?LinkID=317592)
