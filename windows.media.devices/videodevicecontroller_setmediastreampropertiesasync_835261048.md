...
## -see-also
[Set format, resolution, and frame rate for MediaCapture](https://docs.microsoft.com/windows/uwp/audio-video-camera/set-media-encoding-properties), [Camera Resolution Sample](https://go.microsoft.com/fwlink/p/?LinkId=624252)
