...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Text.ITextParagraphFormat.ListLevelIndex](/windows/winui/api/microsoft.ui.text.itextparagraphformat.listlevelindex).
