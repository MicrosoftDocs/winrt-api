...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Text.ITextParagraphFormat.FirstLineIndent](/windows/winui/api/microsoft.ui.text.itextparagraphformat.firstlineindent).
