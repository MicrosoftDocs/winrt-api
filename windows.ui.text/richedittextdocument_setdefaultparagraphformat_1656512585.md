...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Text.RichEditTextDocument.SetDefaultParagraphFormat](/windows/winui/api/microsoft.ui.text.richedittextdocument.setdefaultparagraphformat).
