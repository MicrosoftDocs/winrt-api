...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Text.ITextCharacterFormat.FontStretch](/windows/winui/api/microsoft.ui.text.itextcharacterformat.fontstretch).
