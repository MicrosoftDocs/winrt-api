...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Text.ITextParagraphFormat.WidowControl](/windows/winui/api/microsoft.ui.text.itextparagraphformat.widowcontrol).
