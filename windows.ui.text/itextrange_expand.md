...
## -remarks
For example, if the insertion point is at the beginning, the end, or inside a word, the [Expand](itextrange_expand.md) method expands the range to include that word. If the range already includes one word and part of another, [Expand](itextrange_expand.md) expands the range to include both words.
