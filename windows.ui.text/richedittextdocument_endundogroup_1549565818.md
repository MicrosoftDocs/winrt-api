...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Text.RichEditTextDocument.EndUndoGroup](/windows/winui/api/microsoft.ui.text.richedittextdocument.endundogroup).
