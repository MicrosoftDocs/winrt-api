...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Text.RichEditTextRange.CharacterFormat](/windows/winui/api/microsoft.ui.text.richedittextrange.characterformat).
