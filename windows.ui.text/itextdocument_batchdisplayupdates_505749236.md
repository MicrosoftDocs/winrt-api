...
To decrement the internal counter, call the [ITextDocument.ApplyDisplayUpdates](itextdocument_applydisplayupdates.md) method.



> [!NOTE]
> If undo grouping is on (see [ITextDocument.BeginUndoGroup](itextdocument_beginundogroup.md)), screen updating is suppressed regardless of the internal counter's value.

## -examples

## -see-also
[ITextDocument.ApplyDisplayUpdates](itextdocument_applydisplayupdates.md)