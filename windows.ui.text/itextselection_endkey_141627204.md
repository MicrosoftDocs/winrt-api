...
## -remarks
The [EndKey](itextselection_endkey_141627204.md) method is a logical method rather than a directional method and so is dependent on the language that is involved. For example, in Arabic text, [EndKey](itextselection_endkey_141627204.md) moves to the left end of a line, whereas in English text, it moves to the right. Thus [EndKey](itextselection_endkey_141627204.md) is different from the [ITextSelection.MoveRight](itextselection_moveright_1427894299.md) or [ITextSelection.MoveLeft](itextselection_moveleft_1979591935.md) methods. Also, note that the [EndKey](itextselection_endkey_141627204.md) method is quite different from the End property, which is the character position at the end of the selection. [EndKey](itextselection_endkey_141627204.md) also differs from the [ITextRange.EndOf](itextrange_endof_428994747.md) method in that it extends from the active end, whereas [EndOf](itextrange_endof_428994747.md) extends from End.
