...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Text.ITextParagraphFormat.ClearAllTabs](/windows/winui/api/microsoft.ui.text.itextparagraphformat.clearalltabs).
