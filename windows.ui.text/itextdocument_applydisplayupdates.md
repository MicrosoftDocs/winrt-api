...
To increment the internal counter, call the [ITextDocument.BatchDisplayUpdates](itextdocument_batchdisplayupdates.md) method.
...
## -see-also
[ITextDocument.BatchDisplayUpdates](itextdocument_batchdisplayupdates.md)