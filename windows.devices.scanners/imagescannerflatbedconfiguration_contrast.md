...
## -remarks
Your app can set the value of this property to any [Int32](https://msdn.microsoft.com/library/system.int32.aspx) value between the [MinContrast](imagescannerflatbedconfiguration_mincontrast.md) and [MaxContrast](imagescannerflatbedconfiguration_maxcontrast.md) values, and also relates to the [ContrastStep](imagescannerflatbedconfiguration_contraststep.md) value with this equation:
