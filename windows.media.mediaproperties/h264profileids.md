...
## -examples
Here is some code that creates an instance of the [VideoEncodingProperties](videoencodingproperties.md) class using [CreateH264](videoencodingproperties_createh264.md) and sets the [ProfileId](videoencodingproperties_profileid.md) to the H.264 high profile.
