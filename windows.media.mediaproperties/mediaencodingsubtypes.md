...
For how-to guidance for setting the encoding properties for media, see [Set media encoding properties for MediaCapture](https://msdn.microsoft.com/en-us/windows/uwp/audio-video-camera/set-media-encoding-properties).

## -examples

## -see-also
[Set media encoding properties for MediaCapture](https://msdn.microsoft.com/en-us/windows/uwp/audio-video-camera/set-media-encoding-properties)