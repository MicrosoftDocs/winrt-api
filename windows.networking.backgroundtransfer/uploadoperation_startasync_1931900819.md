...
## -see-also
[BackgroundTransferError.GetStatus](backgroundtransfererror_getstatus.md), [Handling exceptions in network apps](http://msdn.microsoft.com/library/76fafcc9-c674-4cf8-baa0-2400638fae35), [WebErrorStatus](../windows.web/weberrorstatus.md)