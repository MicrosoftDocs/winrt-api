...
An upload operation must be scheduled using one of the [BackgroundUploader.CreateUpload](backgrounduploader_createupload_1442890857.md), [BackgroundUploader.CreateUploadAsync](backgrounduploader_createuploadasync_1414694207.md) , or [BackgroundUploader.CreateUploadFromStreamAsync](backgrounduploader_createuploadfromstreamasync_1788513301.md) methods before the [StartAsync](uploadoperation_startasync_1931900819.md) method is called.
