...
Azure Mobile Services is an option for developers wishing to host a prefetch XML file. To learn more about Azure Mobile Services, see the [ Dev Center](http://go.microsoft.com/fwlink/p/?LinkID=299824).
