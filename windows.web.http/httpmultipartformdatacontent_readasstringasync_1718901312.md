...
## -description
Serialize the [HttpMultipartFormDataContent](httpmultipartformdatacontent.md) to a [String](/dotnet/api/system.string?redirectedfrom=MSDN) as an asynchronous operation.
