---
-api-id: P:Windows.Web.Http.HttpGetStringResult.RequestMessage
...
# Windows.Web.Http.HttpGetStringResult.RequestMessage

## -description
Gets the request message that led to this [HttpGetStringResult](httpgetstringresult.md).

## -property-value
The request message that led to this [HttpGetStringResult](httpgetstringresult.md).
...
## -see-also
[HttpGetStringResult](httpgetstringresult.md), [HttpRequestMessage](httprequestmessage.md)
## -examples
