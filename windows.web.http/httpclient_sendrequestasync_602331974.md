...
## -see-also
[HttpRequestMessage](httprequestmessage.md), [PostAsync](httpclient_postasync.md), [PutAsync](httpclient_putasync.md), [SendRequestAsync(HttpRequestMessage, HttpCompletionOption)](httpclient_sendrequestasync_234300504.md)