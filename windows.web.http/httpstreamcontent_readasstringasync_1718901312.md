...
## -description
Serialize the [HttpStreamContent](httpstreamcontent.md) to a [String](https://docs.microsoft.com/dotnet/api/system.string?redirectedfrom=MSDN) as an asynchronous operation.
