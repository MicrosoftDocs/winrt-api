---
-api-id: P:Windows.Web.Http.HttpGetBufferResult.RequestMessage
...
# Windows.Web.Http.HttpGetBufferResult.RequestMessage

## -description
Gets the request message that led to this [HttpGetBufferResult](httpgetbufferresult.md).

## -property-value
The request message that led to this [HttpGetBufferResult](httpgetbufferresult.md).
...
## -see-also
[HttpGetBufferResult](httpgetbufferresult.md)
