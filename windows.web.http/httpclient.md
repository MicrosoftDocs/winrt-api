...
For sample code in C#/VB/C++ and XAML that shows how to use HttpClient to connect to an HTTP server, see [HttpClient](https://msdn.microsoft.com/library/ec9820d3-3a46-474f-8a01-ae1c27442750).
