...
In these cases, an app uses one of the [HttpRequestMessage](httpclient_httpclient.md) constructors to create an [HttpRequestMessage](httprequestmessage.md) instance. The app sets various properties on the [HttpRequestMessage](httprequestmessage.md) as needed. Then the [HttpRequestMessage](httprequestmessage.md) is passed as a parameter to one of the [HttpClient.SendRequestAsync](httpclient_sendrequestasync.md) methods.
...
+ [DeleteAsync](httpclient_deleteasync.md).
+ The [GetAsync](httpclient_getasync.md) methods.
+ [GetBufferAsync](httpclient_getbufferasync.md).
+ [GetInputStreamAsync](httpclient_getinputstreamasync.md).
+ [GetStringAsync](httpclient_getstringasync.md).
+ [PostAsync](httpclient_postasync.md).
+ [PutAsync](httpclient_putasync.md).
