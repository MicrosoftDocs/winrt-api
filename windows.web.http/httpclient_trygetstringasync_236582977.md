...
## -remarks
This operation will not block. The returned [IAsyncOperationWithProgress(HttpGetStringResult, HttpProgress)](../windows.foundation/iasyncoperationwithprogress_2.md) object will complete after the whole response body is read.
...
## -see-also
[HttpGetStringResult](httpgetstringresult.md), [HttpProgress](httpprogress.md)
