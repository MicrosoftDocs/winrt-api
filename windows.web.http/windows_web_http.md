...
The contents of an HTTP message corresponds to the entity body defined in [RFC 2616](https://go.microsoft.com/fwlink/p/?LinkID=241642). Several classes and an interface in the [Windows.Web.Http](windows_web_http.md) namespace can be used for HTTP content, including:
