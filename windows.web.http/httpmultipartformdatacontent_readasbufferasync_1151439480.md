...
The [HttpMultipartFormDataContent](httpmultipartformdatacontent.md) class can be used to stream content that might be of arbitrary length. The [ReadAsBufferAsync](httpmultipartformdatacontent_readasbufferasync_1151439480.md) method will fail if all of the [HttpMultipartFormDataContent](httpmultipartformdatacontent.md) can't fit in memory since this method requires the entire content to be buffered in memory first.
