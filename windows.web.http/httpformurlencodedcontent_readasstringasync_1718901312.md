...
## -description
Serialize the [HttpFormUrlEncodedContent](httpformurlencodedcontent.md) to a [String](https://msdn.microsoft.com/library/system.string.aspx) as an asynchronous operation.
