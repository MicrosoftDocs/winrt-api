---
-api-id: P:Windows.Web.Http.HttpGetInputStreamResult.RequestMessage
...
# Windows.Web.Http.HttpGetInputStreamResult.RequestMessage

## -description
Gets the request message that led to this [HttpGetInputStreamResult](httpgetinputstreamresult.md).

## -property-value
The request message that led to this [HttpGetInputStreamResult](httpgetinputstreamresult.md).
...
## -see-also
[HttpGetInputStreamResult](httpgetinputstreamresult.md)
