...
## -remarks
The [TryComputeLength](httpbuffercontent_trycomputelength_1823707804.md) method calculates the content length for the [HttpBufferContent](httpbuffercontent.md). This is useful for content types that are easy to calculate the content length.
