...
Apps written in JavaScript, C#, or VB.NET use garbage collection to release resources. So the [Close](httpmultipartformdatacontent_close_811482585.md) object and associated resources don't get released until the garbage collection pass runs. The [Close](httpmultipartformdatacontent_close_811482585.md) method allows an app to release these resources early rather than waiting for the object to be released by garbage collection.
