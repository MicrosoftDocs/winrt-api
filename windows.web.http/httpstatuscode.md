...
## -remarks
The [HttpStatusCode](httpstatuscode.md) enumeration contains the values of the status codes defined by the IETF in [RFC 2616](https://go.microsoft.com/fwlink/p/?LinkID=241642) for HTTP 1.1 and related RFCs.
