...
### -param phase
The number of times [ProcessBindings](idatatemplatecomponent_processbindings_1724539671.md) has been called.

### -param nextPhase
The phase on the next call to [ProcessBindings](idatatemplatecomponent_processbindings_1724539671.md).
