...
## -remarks
[IComponentConnector2](icomponentconnector2.md) is used by the XAML compiler in generated code files. For more info, see the Remarks for [IComponentConnector](icomponentconnector.md).
