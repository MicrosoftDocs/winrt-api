---
-api-id: M:Windows.ApplicationModel.Contacts.KnownContactField.ConvertTypeToName(Windows.ApplicationModel.Contacts.ContactFieldType)
-api-type: winrt method
---

<!-- Method syntax
public string ConvertTypeToName(Windows.ApplicationModel.Contacts.ContactFieldType type)
-->
