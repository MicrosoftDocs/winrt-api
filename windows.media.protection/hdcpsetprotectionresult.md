...
## -remarks
You can call [GetResults](https://msdn.microsoft.com/library/windows/apps/br206600.aspx) on the HDCP operation, and then check that against this enumeration in order to determine whether it was successful or not. See [HdcpSession](hdcpsession.md) for a usage example.
