---
-api-id: P:Windows.Devices.WiFi.WiFiOnDemandHotspotNetworkProperties.DisplayName
-api-type: winrt property
---

# Windows.Devices.WiFi.WiFiOnDemandHotspotNetworkProperties.DisplayName
...
A value containing the display name of the hotspot network.
