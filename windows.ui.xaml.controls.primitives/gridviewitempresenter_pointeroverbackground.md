---
-api-id: P:Windows.UI.Xaml.Controls.Primitives.GridViewItemPresenter.PointerOverBackground
...
# Windows.UI.Xaml.Controls.Primitives.GridViewItemPresenter.PointerOverBackground

## -description
Gets or sets the brush used to render the background of an item that has the pointer over it.

Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.Primitives.GridViewItemPresenter.PointerOverBackground](/windows/winui/api/microsoft.ui.xaml.controls.primitives.gridviewitempresenter.pointeroverbackground) (for WinUI in the [Windows App SDK](/windows/apps/windows-app-sdk/), see the **[Windows App SDK namespaces](/windows/windows-app-sdk/api/winrt/)**).
