---
-api-id: P:Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter.CheckBrush
...
# Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter.CheckBrush

## -description
Gets or sets the brush used to render the check mark on a selected item.

Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.Primitives.ListViewItemPresenter.CheckBrush](/windows/winui/api/microsoft.ui.xaml.controls.primitives.listviewitempresenter.checkbrush) (for WinUI in the [Windows App SDK](/windows/apps/windows-app-sdk/), see the **[Windows App SDK namespaces](/windows/windows-app-sdk/api/winrt/)**).
