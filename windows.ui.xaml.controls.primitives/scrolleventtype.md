...
### -field ThumbTrack:5
The [Thumb](thumb.md) was dragged and caused a [PointerMoved](../windows.ui.xaml/uielement_pointermoved.md) event. A [Scroll](scrollbar_scroll.md) event of this [ScrollEventType](scrolleventtype.md) may occur more than one time when the [Thumb](thumb.md) is dragged in the [ScrollBar](scrollbar.md).
