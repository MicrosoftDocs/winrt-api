---
-api-id: P:Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter.PointerOverBackground
...
# Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter.PointerOverBackground

## -description
Gets or sets the brush used to render the background of an item that has the pointer over it.

Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.Primitives.ListViewItemPresenter.PointerOverBackground](/windows/winui/api/microsoft.ui.xaml.controls.primitives.listviewitempresenter.pointeroverbackground).
