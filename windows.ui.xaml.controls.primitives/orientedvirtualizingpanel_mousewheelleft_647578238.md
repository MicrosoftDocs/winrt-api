---
-api-id: M:Windows.UI.Xaml.Controls.Primitives.OrientedVirtualizingPanel.MouseWheelLeft
...
## -remarks
This calls [SetHorizontalOffset](orientedvirtualizingpanel_sethorizontaloffset.md) using a default value for "mouse-wheel click" of 48 pixels (3 lines), which comes from a default [ScrollViewer](../windows.ui.xaml.controls/scrollviewer.md). 
