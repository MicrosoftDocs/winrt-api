---
-api-id: M:Windows.UI.Xaml.Controls.Primitives.OrientedVirtualizingPanel.PageLeft
...
## -remarks
This implementation calls [SetHorizontalOffset](orientedvirtualizingpanel_sethorizontaloffset.md) using a value for "page" that is same as the [ViewportWidth](orientedvirtualizingpanel_viewportwidth.md). 
