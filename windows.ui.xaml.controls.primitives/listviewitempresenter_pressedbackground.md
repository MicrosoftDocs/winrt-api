---
-api-id: P:Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter.PressedBackground
...
# Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter.PressedBackground
...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.Primitives.ListViewItemPresenter.PressedBackground](/windows/winui/api/microsoft.ui.xaml.controls.primitives.listviewitempresenter.pressedbackground).
...
## -property-value
The brush used to render an unselected item's background ([ListView](../windows.ui.xaml.controls/listview.md)) or border ([GridView](../windows.ui.xaml.controls/gridview.md)) while pressed.
