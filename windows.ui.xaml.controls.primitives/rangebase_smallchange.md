...
## -remarks
[Slider](../windows.ui.xaml.controls/slider.md) overrides the metadata of this property and sets its default to 1. For more information, see [Dependency properties overview](https://docs.microsoft.com/windows/uwp/xaml-platform/dependency-properties-overview).
