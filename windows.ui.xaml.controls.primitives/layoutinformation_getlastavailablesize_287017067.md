---
-api-id: M:Windows.UI.Xaml.Controls.Primitives.LayoutInformation.GetLastAvailableSize(Windows.UI.Xaml.UIElement)
-api-type: winrt method
---

<!-- Method syntax.
public Size LayoutInformation.GetLastAvailableSize(UIElement element)
-->

# Windows.UI.Xaml.Controls.Primitives.LayoutInformation.GetLastAvailableSize
