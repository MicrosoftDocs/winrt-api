---
-api-id: P:Windows.UI.Xaml.Controls.Primitives.GridViewItemPresenter.CheckBrush
...
# Windows.UI.Xaml.Controls.Primitives.GridViewItemPresenter.CheckBrush

## -description
Gets or sets the brush used to render the check mark on a selected item.

Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.Primitives.GridViewItemPresenter.CheckBrush](/windows/winui/api/microsoft.ui.xaml.controls.primitives.gridviewitempresenter.checkbrush).
