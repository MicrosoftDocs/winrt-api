---
-api-id: P:Windows.UI.Xaml.Controls.Primitives.GridViewItemPresenter.SelectedPointerOverBackground
...
# Windows.UI.Xaml.Controls.Primitives.GridViewItemPresenter.SelectedPointerOverBackground

## -description
Gets or sets the brush used to render the background of an item that's selected and has the pointer over it.

Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.Primitives.GridViewItemPresenter.SelectedPointerOverBackground](/windows/winui/api/microsoft.ui.xaml.controls.primitives.gridviewitempresenter.selectedpointeroverbackground).
