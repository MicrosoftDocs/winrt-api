---
-api-id: P:Windows.UI.Xaml.Controls.Primitives.GridViewItemPresenter.DragBackground
...
# Windows.UI.Xaml.Controls.Primitives.GridViewItemPresenter.DragBackground

## -description
Gets or sets the brush used to render the background of an item that's being dragged.

Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.Primitives.GridViewItemPresenter.DragBackground](/windows/winui/api/microsoft.ui.xaml.controls.primitives.gridviewitempresenter.dragbackground) (for WinUI in the [Windows App SDK](/windows/apps/windows-app-sdk/), see the **[Windows App SDK namespaces](/windows/windows-app-sdk/api/winrt/)**).
