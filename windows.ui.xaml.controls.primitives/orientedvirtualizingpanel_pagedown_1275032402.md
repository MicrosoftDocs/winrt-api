...
## -remarks
This implementation calls [SetVerticalOffset](orientedvirtualizingpanel_setverticaloffset.md) using a value for "page" that is same as the [ViewportHeight](orientedvirtualizingpanel_viewportheight.md). 
