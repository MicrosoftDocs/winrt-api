...
## -remarks
[MapRouteDrivingOptions](maproutedrivingoptions.md) allows you to specify advanced routing options when using the [GetDrivingRouteAsync](maproutefinder_getdrivingrouteasync_1265171240.md) method.
