...
Changes to the report interval after an event handler has been registered or [GetCurrentReading](magnetometer_getcurrentreading.md) has been called may apply to the delivery of subsequent sensor readings.
