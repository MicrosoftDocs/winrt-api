---
-api-id: E:Windows.Media.PlayTo.PlayToReceiver.SourceChangeRequested
-api-type: winrt event
---

<!-- Event syntax
public event Windows.Foundation.TypedEventHandler SourceChangeRequested<Windows.Media.PlayTo.PlayToReceiver,  Windows.Media.PlayTo.SourceChangeRequestedEventArgs>
-->

# Windows.Media.PlayTo.PlayToReceiver.SourceChangeRequested
...
> [!div class="tabbedCodeSnippets"][!code-cs[SourceChangeRequested](../windows.media.playto/code/PlayTo_Receiver1/csharp/MainPage.xaml.cs#SnippetSourceChangeRequested)][!code-js[SourceChangeRequested](../windows.media.playto/code/PlayTo_Receiver1/javascript/default.js#SnippetSourceChangeRequested)][!code-vb[SourceChangeRequested](../windows.media.playto/code/PlayTo_Receiver1/vbnet/MainPage.xaml.vb#SnippetSourceChangeRequested)]
