...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Interop.NotifyCollectionChangedEventArgs](/windows/winui/api/microsoft.ui.xaml.interop.notifycollectionchangedeventargs).
