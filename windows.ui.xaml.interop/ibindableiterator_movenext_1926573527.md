...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Interop.IBindableIterator.MoveNext](/windows/winui/api/microsoft.ui.xaml.interop.ibindableiterator.movenext).
