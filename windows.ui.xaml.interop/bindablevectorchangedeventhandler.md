...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Interop.BindableVectorChangedEventHandler](/windows/winui/api/microsoft.ui.xaml.interop.bindablevectorchangedeventhandler).
