...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Interop.IBindableIterator.HasCurrent](/windows/winui/api/microsoft.ui.xaml.interop.ibindableiterator.hascurrent).
