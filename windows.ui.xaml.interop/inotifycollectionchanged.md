...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Interop.INotifyCollectionChanged](/windows/winui/api/microsoft.ui.xaml.interop.inotifycollectionchanged).
