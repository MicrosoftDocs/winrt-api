---
-api-id: T:Windows.Security.Authentication.OnlineId.OnlineIdServiceTicket
-api-type: winrt class
---

<!-- Class syntax.
public class OnlineIdServiceTicket : Windows.Security.Authentication.OnlineId.IOnlineIdServiceTicket
-->
