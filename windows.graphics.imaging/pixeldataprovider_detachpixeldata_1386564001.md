...
If you are using the [Windows Runtime C++ Template Library (WRL)](https://docs.microsoft.com/en-us/cpp/windows/windows-runtime-cpp-template-library-wrl), you are responisble for releasing the underlying memory for the pixel data. Call [CoTaskMemFree](https://msdn.microsoft.com/en-us/library/windows/desktop/ms680722(v=vs.85).aspx) after you are done with the data. If you are using a language projection such as C# or C++/WinRT, memory management is handled automatically.
