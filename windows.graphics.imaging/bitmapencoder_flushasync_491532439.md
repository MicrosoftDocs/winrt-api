...
If, after encoding is complete, you want to reuse the [IRandomAccessStream](https://msdn.microsoft.com/library/d2eceb3d-d13e-44c1-bfe2-1aa57f7432c6) from which the [BitmapEncoder](bitmapencoder.md) was created, such as passing it to the [Windows.Storage.Compression](../windows.storage.compression/windows_storage_compression.md) APIs, you must first reset the stream's seek position to 0, the start of the stream, by calling [IRandomAccessStream.Seek](../windows.storage.streams/irandomaccessstream_seek_1797934981.md).
