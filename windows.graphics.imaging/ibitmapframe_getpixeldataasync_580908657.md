---
-api-id: M:Windows.Graphics.Imaging.IBitmapFrame.GetPixelDataAsync(Windows.Graphics.Imaging.BitmapPixelFormat,Windows.Graphics.Imaging.BitmapAlphaMode,Windows.Graphics.Imaging.BitmapTransform,Windows.Graphics.Imaging.ExifOrientationMode,Windows.Graphics.Imaging.ColorManagementMode)
...
## -remarks
This method should be used instead of [GetPixelDataAsync](ibitmapframe_getpixeldataasync_1391309547.md) if the application needs finer grained control over the pixel data array.

## -examples

## -see-also
[GetPixelDataAsync](ibitmapframe_getpixeldataasync_1391309547.md)