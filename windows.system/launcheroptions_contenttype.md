...
Because **ContentType** allows you to directly launch a file handler the same security checks that apply to file launching apply to URI launches with this option specified. See [Launch the default app for a file](https://msdn.microsoft.com/library/bb45fcaf-df93-4c99-a8b5-59b799c7bd98) and [How to launch the default app for a file (JavaScript)](https://msdn.microsoft.com/library/876edae5-f1a8-45f9-a1a6-50efb1025f96) for more details on those security checks. 
