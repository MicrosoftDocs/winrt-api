...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.Diagnostics.CompositionDebugHeatMaps.Hide](/windows/winui/api/microsoft.ui.composition.diagnostics.compositiondebugheatmaps.hide).
