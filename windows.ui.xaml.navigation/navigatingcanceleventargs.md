...
## -description
Provides data for the [OnNavigatingFrom](../windows.ui.xaml.controls/page_onnavigatingfrom.md) callback that can be used to cancel a navigation request from origination.
...
## -see-also
[OnNavigatingFrom](../windows.ui.xaml.controls/page_onnavigatingfrom.md)