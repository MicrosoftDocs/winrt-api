---
-api-id: T:Windows.Security.Authentication.Identity.Provider.SecondaryAuthenticationFactorAuthenticationStageChangedEventArgs
-api-type: winrt class
---

<!-- Class syntax.
public class SecondaryAuthenticationFactorAuthenticationStageChangedEventArgs : Windows.Security.Authentication.Identity.Provider.ISecondaryAuthenticationFactorAuthenticationStageChangedEventArgs
-->

# Windows.Security.Authentication.Identity.Provider.SecondaryAuthenticationFactorAuthenticationStageChangedEventArgs

## -description
Provides information about the [SecondaryAuthenticationFactorAuthenticationStageChanged](secondaryauthenticationfactorauthenticationstagechangedeventargs.md) event.
