---
-api-id: T:Windows.Security.Authentication.Identity.Provider.SecondaryAuthenticationFactorDevicePresence
-api-type: winrt enum
---

<!-- Enumeration syntax.
public enum SecondaryAuthenticationFactorDevicePresence : int 
-->
