...
The brightness override settings. A null [BrightnessOverrideSettings](brightnessoverridesettings.md) property means that the [DisplayEnhancementOverride](displayenhancementoverride) does no twant to override brightness settings. This property is null by default.
