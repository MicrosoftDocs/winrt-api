...
The [Scaling according to DPI sample](http://go.microsoft.com/fwlink/p/?linkid=231577) shows how to use the [DisplayOrientations](displayorientations.md) enumeration.
