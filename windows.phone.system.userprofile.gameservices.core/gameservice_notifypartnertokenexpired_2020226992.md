...
## -remarks
If the partner token returned by [GetPartnerTokenAsync](gameservice_getpartnertokenasync_475016101.md) has expired this notifies the game service API to remove any cached data so that the next call will return a new partner token.
