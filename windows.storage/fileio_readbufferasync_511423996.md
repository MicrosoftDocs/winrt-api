...
## -examples
The [File Access sample]( http://go.microsoft.com/fwlink/p/?linkid=231445) shows you how to use [ReadBufferAsync](fileio_readbufferasync.md) to read the contents of a file and return a buffer, like this:
