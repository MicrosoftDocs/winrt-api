...
## -remarks
For more info about how to share files and folders among apps from the same publisher, see [GetPublisherCacheFolder](applicationdata_getpublishercachefolder.md).

## -examples

## -see-also
[GetPublisherCacheFolder](applicationdata_getpublishercachefolder.md)