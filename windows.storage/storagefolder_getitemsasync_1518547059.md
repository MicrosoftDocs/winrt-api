...
<table>
   ...
   <tr><td>[CreateItemQuery()](storagefolder_createitemquery.md)</td><td>Default behavior of this method.</td><td>N/A</td></tr>
   <tr><td>[CreateItemQueryWithOptions(QueryOptions)](storagefolder_createitemquerywithoptions.md)</td><td><ul><li>Default behavior of this method if none of the following options are specified.
