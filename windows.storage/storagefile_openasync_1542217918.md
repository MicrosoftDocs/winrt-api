---
-api-id: M:Windows.Storage.StorageFile.OpenAsync(Windows.Storage.FileAccessMode,Windows.Storage.StorageOpenOptions)
...
## -see-also
[OpenAsync(FileAccessMode)](storagefile_openasync_502008712.md)