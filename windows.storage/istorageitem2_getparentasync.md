...
## -remarks
You must have access to the parent for the [GetParentAsync](istorageitem2_getparentasync.md) method to succeed, either by declaring library capabilities or by persisting a higher-level folder in the Access List. Also, this method returns **null** if you can’t get to the parent, instead of raising an exception.
