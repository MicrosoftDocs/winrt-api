...
## -remarks
You can use the [SignalDataChanged | signalDataChanged](applicationdata_signaldatachanged.md) method to fire a [DataChanged | datachanged](applicationdata_datachanged.md) event that you can use to signal other code in your app to reload the local state.
