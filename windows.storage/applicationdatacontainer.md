...
Call the [ApplicationDataContainer.DeleteContainer | deleteContainer](applicationdatacontainer_deletecontainer_439744840.md) method to delete the `exampleContainer` settings container when you have finished with it.
