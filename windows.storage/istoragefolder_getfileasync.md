...
## -returns
When this method completes successfully, it returns a [StorageFile](storagefile.md) that represents the file.
...
## -see-also
[StorageFolder.GetFileAsync](storagefolder_getfileasync.md)