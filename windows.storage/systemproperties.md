...
Some of the [SystemProperties](systemproperties.md) properties return a string name directly. For example, [SystemProperties.Title](systemproperties_title.md) returns the string "System.Title". Some of the [SystemProperties](systemproperties.md) properties return a helper object. For example, [SystemProperties.Video](systemproperties_video.md) returns a [SystemVideoProperties](systemvideoproperties.md) object. You can then use this object's properties to get the name for a video-specific [Windows file property](https://msdn.microsoft.com/library/7532e58f-bbf2-4e36-9d81-c8e04b92cb7c), for example [SystemVideoProperties.FrameHeight](systemvideoproperties_frameheight.md) returns "System.Video.FrameHeight".
