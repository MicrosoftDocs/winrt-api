...
<!-- Property syntax
public Windows.Storage.StorageFolder TemporaryFolder { get; }
-->
...
## -see-also
[Quickstart: Temporary application data (JavaScript)](/previous-versions/windows/apps/hh465130(v=win.10)), [Store and retrieve settings and other app data](/windows/uwp/app-settings/store-and-retrieve-app-data)
