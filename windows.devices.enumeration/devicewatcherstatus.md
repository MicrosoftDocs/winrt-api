...
### -field Stopping:3
The client has called [Stop](devicewatcher_stop.md) and the watcher is still in the process of stopping. Events may still be raised.

### -field Stopped:4
The client has called [Stop](devicewatcher_stop.md) and the watcher has completed all outstanding events. No further events will be raised.
