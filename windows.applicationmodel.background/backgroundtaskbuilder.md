...
> [!NOTE]
> Starting in Windows 8.1, the parameters used to register the background task are validated at the time the task is registered. See the remarks for [BackgroundTaskBuilder.Register](backgroundtaskbuilder_register.md).
