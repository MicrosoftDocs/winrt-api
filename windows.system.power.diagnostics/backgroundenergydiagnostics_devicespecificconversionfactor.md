...
## -remarks
To determine the estimated energy usage for the device in units of milliwatts (mW), divide the computed total energy usage by the [DeviceSpecificConversionFactor](backgroundenergydiagnostics_devicespecificconversionfactor.md).
