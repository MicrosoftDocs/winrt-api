---
-api-id: T:Windows.Media.Casting.CastingDeviceSelectedEventArgs
-api-type: winrt class
---

<!-- Class syntax.
public class CastingDeviceSelectedEventArgs : Windows.Media.Casting.ICastingDeviceSelectedEventArgs
-->
