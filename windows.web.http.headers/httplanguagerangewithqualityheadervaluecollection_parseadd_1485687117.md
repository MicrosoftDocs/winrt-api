---
-api-id: M:Windows.Web.Http.Headers.HttpLanguageRangeWithQualityHeaderValueCollection.ParseAdd(System.String)
...
The *input* parameter is not a valid value for the **Accept-Language** HTTP header.
