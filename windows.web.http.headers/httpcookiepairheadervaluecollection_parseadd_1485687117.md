---
-api-id: M:Windows.Web.Http.Headers.HttpCookiePairHeaderValueCollection.ParseAdd(System.String)
...
The *input* parameter is not a valid value for the **Cookie** HTTP header.
