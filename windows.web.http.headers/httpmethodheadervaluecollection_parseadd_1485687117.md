---
-api-id: M:Windows.Web.Http.Headers.HttpMethodHeaderValueCollection.ParseAdd(System.String)
...
The *input* parameter is not a valid value for the **Allow** HTTP header.
