...
If you are programming using C# or Microsoft Visual Basic, the equivalent method is [RemoveAt](httpchallengeheadervaluecollection_removeat_1.md). The behavior of each language's RemoveAt is basically the same.
