...
If you are programming using Visual C++ component extensions (C++/CX) or JavaScript, [CopyTo](httpchallengeheadervaluecollection_copyto.md) has similar behavior to [GetMany](httpchallengeheadervaluecollection_getmany.md), but note that the parameters are in a different order. Or you can make an [IVectorView](../windows.foundation.collections/ivectorview_1.md) copy by calling the [GetView](httpchallengeheadervaluecollection_getview.md) method.
