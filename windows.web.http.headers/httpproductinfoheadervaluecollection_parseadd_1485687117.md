---
-api-id: M:Windows.Web.Http.Headers.HttpProductInfoHeaderValueCollection.ParseAdd(System.String)
...
The *input* parameter is not a valid value for the **User-Agent** HTTP header.
