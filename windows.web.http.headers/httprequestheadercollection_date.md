...
## -remarks
The [Date](httprequestheadercollection_date.md) property represents the **Date** header on an HTTP request message. The **Date** header is the date and time the message was sent.
...
The following sample code shows a method to set the **Date** header on an [HttpRequestMessage](../windows.web.http/httprequestmessage.md) object using the [Date](httprequestheadercollection_date.md) property on the [HttpRequestHeaderCollection](httprequestheadercollection.md) object.
