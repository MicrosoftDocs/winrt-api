...
## -remarks
The HttpChallengeHeaderValue class provides support for the authentication information in **Authorization**, **ProxyAuthorization**, **WWW-Authenticate**, and **Proxy-Authenticate** HTTP header values as defined in [RFC 2616](https://go.microsoft.com/fwlink/p/?LinkID=241642) by the IETF.
