...
## -see-also
[StaggerDelayFactor](animationdescription_staggerdelayfactor.md), [DelayLimit](animationdescription_delaylimit.md), [Animation metrics sample](http://go.microsoft.com/fwlink/p/?linkid=242462)