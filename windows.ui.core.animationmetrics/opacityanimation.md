...
<!-- @WRITER erictill 1/12/2012 :get the <xref rid="w_ui_core_animmet.ipropertyanimation" targtype="interface_winrt">IPropertyAnimation</xref> object by using the <xref rid="w_ui_core_animmet.animationdescription_animations" targtype="property_winrt">AnimationDescription.animations</xref> property and cast it as an <xref rid="w_ui_core_animmet.opacityanimation" targtype="class_winrt">OpacityAnimation</xref>. -->
