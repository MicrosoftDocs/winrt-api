...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.FrameworkElement.FocusVisualSecondaryThickness](/windows/winui/api/microsoft.ui.xaml.frameworkelement.focusvisualsecondarythickness).
