...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.DependencyPropertyChangedCallback](/windows/winui/api/microsoft.ui.xaml.dependencypropertychangedcallback).
