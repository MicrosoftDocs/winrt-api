...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.UIElement.OnProcessKeyboardAccelerators](/windows/winui/api/microsoft.ui.xaml.uielement.onprocesskeyboardaccelerators).
