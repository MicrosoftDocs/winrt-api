...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.UnhandledExceptionEventArgs.Handled](/windows/winui/api/microsoft.ui.xaml.unhandledexceptioneventargs.handled).
