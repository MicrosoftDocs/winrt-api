...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.UIElement.ManipulationInertiaStarting](/windows/winui/api/microsoft.ui.xaml.uielement.manipulationinertiastarting).
