...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.UIElement.BringIntoViewRequested](/windows/winui/api/microsoft.ui.xaml.uielement.bringintoviewrequested).
