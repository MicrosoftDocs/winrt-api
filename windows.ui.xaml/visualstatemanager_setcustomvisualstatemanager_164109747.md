...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.VisualStateManager.SetCustomVisualStateManager](/windows/winui/api/microsoft.ui.xaml.visualstatemanager.setcustomvisualstatemanager).
