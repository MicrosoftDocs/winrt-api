...
## -xaml-values
<dl><dt>xyFocusKeyboardNavigationModeMemberName</dt><dd>xyFocusKeyboardNavigationModeMemberNameOne of the named constants of the [XYFocusKeyboardNavigationMode](../windows.ui.xaml.input/xyfocuskeyboardnavigationmode.md) enumeration.</dd>
</dl>
