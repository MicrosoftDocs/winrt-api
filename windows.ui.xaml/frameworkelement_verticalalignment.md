...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.FrameworkElement.VerticalAlignment](/windows/winui/api/microsoft.ui.xaml.frameworkelement.verticalalignment).
