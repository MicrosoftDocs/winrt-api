...
## -description
Creates a new [Size](../windows.foundation/size.md) based on width and height element values. C# and Microsoft Visual Basic code should use [Size(Double,Double)](../windows.foundation/size_size.md) instead.
