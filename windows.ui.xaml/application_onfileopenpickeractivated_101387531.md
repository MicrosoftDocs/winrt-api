...
## -remarks
[OnFileOpenPickerActivated](application_onfileopenpickeractivated.md) is a pre-defined activation point handler that is invoked for a core [Activated](../windows.ui.core/corewindow_activated.md) event when the [ActivationKind](../windows.applicationmodel.activation/activationkind.md) is **FileOpenPicker**.
