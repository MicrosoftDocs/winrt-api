...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.UIElement.KeyboardAcceleratorPlacementMode](/windows/winui/api/microsoft.ui.xaml.uielement.keyboardacceleratorplacementmode).
