...
+ For layout containers, the coordinate frame of reference changes. "(0, 0)" in a [Canvas](../windows.ui.xaml.controls/canvas.md) is the top right corner. The "0" column in a Grid for purposes of [Grid.Column](/uwp/api/windows.ui.xaml.controls.grid#xaml-attached-properties) is the rightmost column.
...
## -see-also
[How to adjust layout and fonts for various languages, and support RTL layouts](https://docs.microsoft.com/previous-versions/windows/apps/hh967760(v=win.10)), [Image](../windows.ui.xaml.controls/image.md)
