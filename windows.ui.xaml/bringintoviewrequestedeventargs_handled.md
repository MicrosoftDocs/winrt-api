...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.BringIntoViewRequestedEventArgs.Handled](/windows/winui/api/microsoft.ui.xaml.bringintoviewrequestedeventargs.handled).
