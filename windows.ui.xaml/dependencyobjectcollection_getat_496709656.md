...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.DependencyObjectCollection.GetAt](/windows/winui/api/microsoft.ui.xaml.dependencyobjectcollection.getat).
