...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.FrameworkElement.HorizontalAlignment](/windows/winui/api/microsoft.ui.xaml.frameworkelement.horizontalalignment).
