...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.BringIntoViewOptions.VerticalOffset](/windows/winui/api/microsoft.ui.xaml.bringintoviewoptions.verticaloffset).
