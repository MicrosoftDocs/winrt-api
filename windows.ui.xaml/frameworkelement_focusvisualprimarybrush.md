...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.FrameworkElement.FocusVisualPrimaryBrush](/windows/winui/api/microsoft.ui.xaml.frameworkelement.focusvisualprimarybrush).
