...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.ApplicationHighContrastAdjustment](/windows/winui/api/microsoft.ui.xaml.applicationhighcontrastadjustment).
