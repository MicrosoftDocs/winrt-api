...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.BringIntoViewOptions.HorizontalOffset](/windows/winui/api/microsoft.ui.xaml.bringintoviewoptions.horizontaloffset).
