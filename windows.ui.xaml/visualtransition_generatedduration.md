...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.VisualTransition.GeneratedDuration](/windows/winui/api/microsoft.ui.xaml.visualtransition.generatedduration).
