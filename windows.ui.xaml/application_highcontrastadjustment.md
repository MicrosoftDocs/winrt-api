...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Application.HighContrastAdjustment](/windows/winui/api/microsoft.ui.xaml.application.highcontrastadjustment).
