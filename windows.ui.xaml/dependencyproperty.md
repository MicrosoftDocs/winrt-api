...
The Windows Runtime implements the XAML attached property language feature with [DependencyProperty](dependencyproperty.md) identifiers and property storage on a [DependencyObject](dependencyobject.md). For more info, see [Attached properties overview](https://msdn.microsoft.com/library/098c1de0-d640-48b1-9961-d0adf33266e2).
