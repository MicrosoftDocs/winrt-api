...
## -remarks
[InsertAt](setterbasecollection_insertat_634140918.md) expands the collection and moves all subsequent index items by one. In contrast, [SetAt](setterbasecollection_setat_1418942598.md) replaces the item at the index, and the collection count remains the same.
