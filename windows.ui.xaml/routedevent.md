...
For more info on how routed events work, see [Events and routed events overview](https://msdn.microsoft.com/library/34c219e8-3efb-45bc-8bbd-6fd937698832). The RoutedEvent type is part of the infrastructure for routed events, but you don't use RoutedEvent directly in typical Windows Runtime app programming.
...
## -see-also
[Events and routed events overview](https://msdn.microsoft.com/library/34c219e8-3efb-45bc-8bbd-6fd937698832), [UIElement.AddHandler](uielement_addhandler_2121467075.md), [UIElement.RemoveHandler](uielement_removehandler_661998757.md), [RoutedEventArgs](routedeventargs.md)
