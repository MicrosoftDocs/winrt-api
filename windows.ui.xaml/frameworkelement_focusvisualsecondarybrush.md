...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.FrameworkElement.FocusVisualSecondaryBrush](/windows/winui/api/microsoft.ui.xaml.frameworkelement.focusvisualsecondarybrush).
