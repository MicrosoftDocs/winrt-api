...
## -remarks
The [Dispatcher](dependencyobject_dispatcher.md) property provides the [CoreDispatcher](../windows.ui.core/coredispatcher.md) reference that can be used to marshal calls coming from non-UI threads, using [RunAsync](../windows.ui.core/coredispatcher_runasync_447339746.md) and an awaitable function. For more info on awaitable functions, see [Call asynchronous APIs in C# or Visual Basic](http://msdn.microsoft.com/library/066711e0-d5c4-467e-8683-3cc64edbcc83). See also "**DependencyObject** and threading" section of the [DependencyObject](dependencyobject.md) reference topic.
