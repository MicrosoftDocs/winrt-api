...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.VisualStateChangedEventArgs.OldState](/windows/winui/api/microsoft.ui.xaml.visualstatechangedeventargs.oldstate).
