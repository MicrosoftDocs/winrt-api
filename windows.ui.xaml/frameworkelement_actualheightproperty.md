...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.FrameworkElement.ActualHeightProperty](/windows/winui/api/microsoft.ui.xaml.frameworkelement.actualheightproperty).
