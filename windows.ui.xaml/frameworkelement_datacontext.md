...
Another technique for setting DataContext is to add it to the root of the runtime object tree, as part of app initialization logic, just after calling **InitializeComponent**. This technique is shown in [Data binding overview](https://msdn.microsoft.com/library/a9d54dec-cd1b-4043-ade4-32cd4977d1bf).
