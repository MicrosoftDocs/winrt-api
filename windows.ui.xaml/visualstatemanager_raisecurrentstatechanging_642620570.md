...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.VisualStateManager.RaiseCurrentStateChanging](/windows/winui/api/microsoft.ui.xaml.visualstatemanager.raisecurrentstatechanging).
