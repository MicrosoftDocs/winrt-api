---
-api-id: M:Windows.UI.Xaml.SetterBaseCollection.RemoveAt(System.UInt32)
...
# Windows.UI.Xaml.SetterBaseCollection.RemoveAt

## -description
Removes the item at the specified index.

Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.SetterBaseCollection.RemoveAt](/windows/winui/api/microsoft.ui.xaml.setterbasecollection.removeat).
