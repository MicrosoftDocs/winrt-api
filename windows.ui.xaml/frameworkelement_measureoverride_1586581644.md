...
## -remarks
This method has a default implementation that performs built-in layout for most [FrameworkElement](frameworkelement.md) derived classes. [MeasureOverride](frameworkelement_measureoverride_1586581644.md) provides the behavior for [Measure](uielement_measure_1722732750.md), whenever [Measure](uielement_measure_1722732750.md) is called either by internal layout logic or your own app's code, including any [MeasureOverride](frameworkelement_measureoverride_1586581644.md) methods of your own for other classes. If you are producing a templated control, the [MeasureOverride](frameworkelement_measureoverride_1586581644.md) logic defines your control's specific "Measure" pass layout logic.

The general design of how elements go through a layout process when your app runs is divided into two steps: a "Measure" pass, and then an "Arrange" pass. Control authors (or panel authors) who want to customize the "Measure" pass of layout processing should override [MeasureOverride](frameworkelement_measureoverride_1586581644.md). Your implementation should do the following: 
...
## -see-also
[Measure](uielement_measure_1722732750.md), [ArrangeOverride](frameworkelement_arrangeoverride_1795048387.md), [Define layouts with XAML](http://msdn.microsoft.com/library/8d4e4162-1c9c-48f4-8a94-34976fb17079)
