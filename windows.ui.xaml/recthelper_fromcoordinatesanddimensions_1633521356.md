...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.RectHelper.FromCoordinatesAndDimensions](/windows/winui/api/microsoft.ui.xaml.recthelper.fromcoordinatesanddimensions).
