...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.ElementFactoryRecycleArgs.Parent](/windows/winui/api/microsoft.ui.xaml.elementfactoryrecycleargs.parent).
