...
## -remarks
[GridLength](gridlengthhelper.md) is a Windows Runtime structure that represents a factor for available-space measurements in rows or columns of a [Grid](../windows.ui.xaml.controls/grid.md).
