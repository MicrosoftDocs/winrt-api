...
## -remarks
The [GetDeferral](drageventargs_getdeferral.md) method allows your app to call a function during a drag-and-drop operation, so that your app can asynchronously generate the [DataPackage](../windows.applicationmodel.datatransfer/datapackage.md) object for the target app.
