...
For more info on how to use [Window.SizeChanged](window_sizechanged.md) to detect changes in the app window environment and load the appropriate visual states for your app, see [Quickstart: Designing apps for different window sizes](https://msdn.microsoft.com/library/e8f39d87-d7c3-433f-8592-a45dfbae52c7).
