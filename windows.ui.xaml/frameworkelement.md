...
The [FrameworkElement](frameworkelement.md) class defines the [Language](frameworkelement_language.md) property and the [FlowDirection](frameworkelement_flowdirection.md) property. For more info, see [Globalizing your app](https://msdn.microsoft.com/library/fc8fa294-98ac-4fd0-a445-cd252e84cd65).
