...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.DependencyPropertyChangedEventHandler](/windows/winui/api/microsoft.ui.xaml.dependencypropertychangedeventhandler).
