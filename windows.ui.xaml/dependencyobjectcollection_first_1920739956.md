...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.DependencyObjectCollection.First](/windows/winui/api/microsoft.ui.xaml.dependencyobjectcollection.first).
