...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.DragStartingEventArgs.GetPosition](/windows/winui/api/microsoft.ui.xaml.dragstartingeventargs.getposition).
