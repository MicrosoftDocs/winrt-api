...
## -remarks
This value can be modified by event handlers as the event bubbles. A scrolling control that partially or fully satisfies the request will adjust the requested [HorizontalOffset](bringintoviewrequestedeventargs_horizontaloffset.md) to reflect the remaining amount that it could not satisfy.
