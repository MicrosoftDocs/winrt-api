...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.EffectiveViewportChangedEventArgs](/windows/winui/api/microsoft.ui.xaml.effectiveviewportchangedeventargs).
