...
App activation as opposed to [Window](window.md) activation has its own **Activated** event. For more info, see [OnActivated](application_onactivated_603737819.md) or [Handle app activation](http://msdn.microsoft.com/library/da9a6a43-f09d-4512-a2ab-9b6132431007).
