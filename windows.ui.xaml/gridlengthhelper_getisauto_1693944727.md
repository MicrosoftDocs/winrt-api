...
## -description
Returns whether the evaluated [GridLength](gridlength.md) is the special "Auto" value. C# and Microsoft Visual Basic code should use [IsAuto](gridlength_isauto.md) instead.
