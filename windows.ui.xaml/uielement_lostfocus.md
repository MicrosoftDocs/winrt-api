...
[LostFocus](uielement_lostfocus.md) is a routed event. For more info on how class-based handling for events works, see [Events and routed events overview](https://msdn.microsoft.com/library/34c219e8-3efb-45bc-8bbd-6fd937698832).
...
For more info on tab sequences and accessibility, see [Keyboard accessibility](https://msdn.microsoft.com/library/ddae8c4b-7907-49fe-9645-f105f8dfad8b).
