...
+ The C# or Microsoft Visual Basic  [System.TimeSpan](https://msdn.microsoft.com/library/system.timespan.aspx) has a [Parse](https://docs.microsoft.com/en-us/dotnet/api/system.timespan.parse#System_TimeSpan_Parse_System_String_) method that use *hours***:***minutes***:***seconds* string format. If you need to create a [Duration](duration.md) value in code you can call the [Duration](duration_duration.md) constructor and provide the [System.TimeSpan](https://msdn.microsoft.com/library/system.timespan.aspx) argument by calling [TimeSpan.Parse](https://docs.microsoft.com/en-us/dotnet/api/system.timespan.parse#System_TimeSpan_Parse_System_String_) with an *hours***:***minutes***:***seconds* string. Always use the "en-us" culture for parsing this string, because that's how XAML interprets the string format, and you shouldn't be using culture-specific inputs for animating timings anyways.
