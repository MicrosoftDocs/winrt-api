...
## -description
Adds the **TimeSpan** component of two [Duration](duration.md) values. C# and Microsoft Visual Basic code should use the + operator or the [Add](duration_add.md) method instead.
