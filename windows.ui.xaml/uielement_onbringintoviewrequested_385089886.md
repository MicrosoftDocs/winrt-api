...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.UIElement.OnBringIntoViewRequested](/windows/winui/api/microsoft.ui.xaml.uielement.onbringintoviewrequested).
