...
## -examples
The entirety of an [OnCreateAutomationPeer](uielement_oncreateautomationpeer.md) implementation should consist of constructing the custom automation peer class and returning it.
