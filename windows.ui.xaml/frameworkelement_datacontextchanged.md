...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.FrameworkElement.DataContextChanged](/windows/winui/api/microsoft.ui.xaml.frameworkelement.datacontextchanged).
