...
## -description
Creates an element tree of elements. [FrameworkTemplate](frameworktemplate.md) is a base class for classes that have specific templating behavior, including [ControlTemplate](../windows.ui.xaml.controls/controltemplate.md) and [DataTemplate](datatemplate.md).
...
[FrameworkTemplate](frameworktemplate.md) is the parent class for several immediately derived classes that each define specific templating behavior. Here are some of the notable derived classes:
