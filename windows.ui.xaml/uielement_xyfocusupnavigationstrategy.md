...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.UIElement.XYFocusUpNavigationStrategy](/windows/winui/api/microsoft.ui.xaml.uielement.xyfocusupnavigationstrategy).
