...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.UIElement.KeyboardAcceleratorPlacementTarget](/windows/winui/api/microsoft.ui.xaml.uielement.keyboardacceleratorplacementtarget).
