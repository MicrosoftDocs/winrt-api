...
## -description
Gets or sets the thickness of the outer border of a [HighVisibility](focusvisualkind.md) focus visual for a [FrameworkElement](frameworkelement.md).

## -property-value
The thickness of the outer border of a [HighVisibility](focusvisualkind.md) focus visual. The default value is 2.
