...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.DependencyProperty.RegisterAttached](/windows/winui/api/microsoft.ui.xaml.dependencyproperty.registerattached).
