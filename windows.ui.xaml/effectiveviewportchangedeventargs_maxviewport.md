...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.EffectiveViewportChangedEventArgs.MaxViewport](/windows/winui/api/microsoft.ui.xaml.effectiveviewportchangedeventargs.maxviewport).
