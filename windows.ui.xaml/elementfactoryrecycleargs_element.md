...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.ElementFactoryRecycleArgs.Element](/windows/winui/api/microsoft.ui.xaml.elementfactoryrecycleargs.element).
