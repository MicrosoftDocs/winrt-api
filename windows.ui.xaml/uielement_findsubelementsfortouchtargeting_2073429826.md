...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.UIElement.FindSubElementsForTouchTargeting](/windows/winui/api/microsoft.ui.xaml.uielement.findsubelementsfortouchtargeting).
