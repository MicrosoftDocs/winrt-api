...
To access the [MinWindowHeight](adaptivetrigger_minwindowheight.md) dependency property in code, you can use the dependency property system, calling either [GetValue](dependencyobject_getvalue.md) or [SetValue](dependencyobject_setvalue.md) and passing [AdaptiveTrigger.MinWindowHeightProperty](adaptivetrigger_minwindowheightproperty.md) as the dependency property identifier.

## -examples

## -see-also
[MinWindowHeight](adaptivetrigger_minwindowheight.md), [Dependency properties overview](http://msdn.microsoft.com/library/ad649e66-f71c-4daa-9994-617c886fda7e)