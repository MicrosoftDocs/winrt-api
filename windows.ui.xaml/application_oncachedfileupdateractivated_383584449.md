...
For example code that overrides [OnFileOpenPickerActivated](application_onfileopenpickeractivated_101387531.md), see [File picker contracts sample](http://go.microsoft.com/fwlink/p/?linkid=231536).
