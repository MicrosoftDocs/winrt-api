...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.UnhandledExceptionEventArgs.Message](/windows/winui/api/microsoft.ui.xaml.unhandledexceptioneventargs.message).
