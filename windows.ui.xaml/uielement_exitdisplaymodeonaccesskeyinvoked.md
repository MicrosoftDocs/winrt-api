...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.UIElement.ExitDisplayModeOnAccessKeyInvoked](/windows/winui/api/microsoft.ui.xaml.uielement.exitdisplaymodeonaccesskeyinvoked).
