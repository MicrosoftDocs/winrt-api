...
[OnLaunched](application_onlaunched.md) is a good place to change [DebugSettings](debugsettings.md) values.
...
## -examples
This example shows an [OnLaunched](application_onlaunched.md) override that accesses [Application.DebugSettings](application_debugsettings.md) and sets two properties of the singleton [DebugSettings](debugsettings.md) value to **true**. The context of this code is the app.xaml code-behind, so **this** refers to the created [Application](application.md) object for the app.
...
## -see-also
[Application.DebugSettings](application_debugsettings.md), [Data binding in depth](http://msdn.microsoft.com/library/41e1b4f1-6caf-4128-a61a-4e400b149011), [Performance best practices for ](http://msdn.microsoft.com/library/567bcefa-5da5-4e42-a4b8-1358c71adfa2)