...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.VisualTransition.GeneratedEasingFunction](/windows/winui/api/microsoft.ui.xaml.visualtransition.generatedeasingfunction).
