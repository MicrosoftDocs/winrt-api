...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.UIElement.XYFocusRightNavigationStrategy](/windows/winui/api/microsoft.ui.xaml.uielement.xyfocusrightnavigationstrategy).
