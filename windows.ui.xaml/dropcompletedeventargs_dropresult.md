...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.DropCompletedEventArgs.DropResult](/windows/winui/api/microsoft.ui.xaml.dropcompletedeventargs.dropresult).
