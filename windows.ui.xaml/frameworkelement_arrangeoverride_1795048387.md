...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.FrameworkElement.ArrangeOverride](/windows/winui/api/microsoft.ui.xaml.frameworkelement.arrangeoverride).
