...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.DragStartingEventArgs.GetDeferral](/windows/winui/api/microsoft.ui.xaml.dragstartingeventargs.getdeferral).
