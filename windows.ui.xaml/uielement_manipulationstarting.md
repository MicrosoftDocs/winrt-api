...
[ManipulationStarting](uielement_manipulationstarting.md) supports the ability to attach event handlers to the route that will be invoked even if the event data for the event is marked [Handled](../windows.ui.xaml.input/manipulationstartingroutedeventargs_handled.md). See [AddHandler](uielement_addhandler.md).
