...
## -remarks
Use this property as a debugging aid to visibly detect areas of the UI where applying a [CacheMode](uielement_cachemode.md) for textures might be useful. For more info, see "Cache static content" section of [Optimize your XAML markup](https://docs.microsoft.com/windows/uwp/debug-test-perf/optimize-xaml-loading).
...
## -see-also
[EnableFrameRateCounter](debugsettings_enableframeratecounter.md), [Performance best practices for ](https://docs.microsoft.com/previous-versions/windows/apps/hh750313(v=win.10))
