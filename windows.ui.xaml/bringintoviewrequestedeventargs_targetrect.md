...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.BringIntoViewRequestedEventArgs.TargetRect](/windows/winui/api/microsoft.ui.xaml.bringintoviewrequestedeventargs.targetrect).
