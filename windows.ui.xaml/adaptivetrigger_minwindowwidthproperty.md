...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.AdaptiveTrigger.MinWindowWidthProperty](/windows/winui/api/microsoft.ui.xaml.adaptivetrigger.minwindowwidthproperty).
