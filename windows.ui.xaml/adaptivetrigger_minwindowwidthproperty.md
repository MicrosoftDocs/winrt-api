...
To access the [MinWindowWidth](adaptivetrigger_minwindowwidth.md) dependency property in code, you can use the dependency property system, calling either [GetValue](dependencyobject_getvalue.md) or [SetValue](dependencyobject_setvalue.md) and passing [AdaptiveTrigger.MinWindowWidthProperty](adaptivetrigger_minwindowwidthproperty.md) as the dependency property identifier.
