...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.FrameworkElement.OnApplyTemplate](/windows/winui/api/microsoft.ui.xaml.frameworkelement.onapplytemplate).
