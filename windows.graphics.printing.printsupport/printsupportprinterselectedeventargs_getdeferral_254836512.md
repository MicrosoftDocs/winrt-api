...
Informs the system that the app might continue to perform work after the [PrintSupportExtensionSession.PrinterSelected](/uwp/api/windows.graphics.printing.printsupport/printsupportextensionsession_printerselected) event handler returns.
