...
## -remarks
The retrieved elements and their attributes are manipulated through Document Object Model (DOM) manipulation functions to customize the toast content. See [toast schema](XREF:TODO:toast.Schema_Root) for an explanation of toast elements and attributes.
