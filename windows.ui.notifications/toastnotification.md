...
- Handling activation guidance
    - UWP Applications should use the [OnActivated](https://github.com/MicrosoftDocs/winrt-api/windows.ui.xaml/application_onactivated_603737819.md) for handling toast activations.
    - Staring WinRT Build 19041, MSIX and Sparsed Sign Packaged applications are able to use [ToastNotificationActionTrigger](https://github.com/MicrosoftDocs/winrt-api/windows.applicationmodel.background/toastnotificationactiontrigger.md) for handling activations [for more details](https://docs.microsoft.com/windows/uwp/launch-resume/create-and-register-a-winmain-background-task#add-the-support-code-to-instantiate-the-com-class).
