...
## -examples
The following example code uses the [BadgeNotification](badgenotification_badgenotification.md) method to create a numeric badge notification.
