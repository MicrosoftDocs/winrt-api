...
## -warning
This method fails if called recursively. When it fails, call [RoOriginateError](https://msdn.microsoft.com/library/ed647880-5a18-4f75-b7e5-3b9bf36229d3) to obtain the error and the message supplied to an attached debugger.
