...
## -enum-fields
### -field Arrow:0
![arrow cursor](./images/cursors/arrow_cursor.png)
The left-upward (northwest) arrow Windows cursor.

### -field Cross:1
![cross cursor](./images/cursors/cross_cursor.png)
...
### -field Person:15
![hand with person cursor](./images/cursors/person_cursor.png)
The "hand" Windows cursor with a person symbol.

### -field Pin:14
![hand with pin cursor](./images/cursors/pin_cursor.png)
