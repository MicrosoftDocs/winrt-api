---
-api-id: P:Windows.UI.Core.CoreWindow.FlowDirection
-api-type: winrt property
---

<!-- Property syntax
public Windows.UI.Core.CoreWindowFlowDirection FlowDirection { get;  set; }
-->

# Windows.UI.Core.CoreWindow.FlowDirection
...
## -see-also
[CoreWindowFlowDirection](corewindowflowdirection.md)