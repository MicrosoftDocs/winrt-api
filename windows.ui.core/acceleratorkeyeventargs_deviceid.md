...
Use [DeviceId](acceleratorkeyeventargs_deviceid.md) to differentiate between devices that can generate key events, such as multiple Xbox controllers.

> [DeviceId](acceleratorkeyeventargs_deviceid.md) is not supported for all input devices.
