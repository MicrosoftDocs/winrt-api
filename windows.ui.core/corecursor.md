...
To use a custom cursor, use the **CoreCursorType.Custom** enumeration option, and specify the **Id** of the custom cursor. You can add a _.res_ resource file that contains the custom cursor to your project and include it in your assembly with the [/win32res](https://msdn.microsoft.com/library/8f2f5x2e.aspx) compiler option. The **Id** is the [Cursor Resource ID](https://msdn.microsoft.com/library/aa380920.aspx) specified in the _.res_ file.
