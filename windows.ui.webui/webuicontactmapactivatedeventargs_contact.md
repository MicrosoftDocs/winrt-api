---
-api-id: P:Windows.UI.WebUI.WebUIContactMapActivatedEventArgs.Contact
...
# Windows.UI.WebUI.WebUIContactMapActivatedEventArgs.Contact
...
## -remarks
Use the [Contact](webuicontactmapactivatedeventargs_contact.md) property to collect additional info about the contact that is being mapped. The contact can have a name and thumbnail that can be used to represent it in your app's UI. Or, the contact can have alternative addresses that can be used.
