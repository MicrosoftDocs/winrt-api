...
You should also release any exclusive resources, like file handles at suspend, so that they can be used by other apps while your app is suspended. Your app can also listen to the [Oncheckpoint](https://msdn.microsoft.com/library/a7620c81-f769-46e5-b030-dde21b8c2d5b) event to handle the app being suspended.
...
## -see-also
[App lifecycle](https://msdn.microsoft.com/library/6c469e77-f1e3-4859-a27b-c326f9616d10), [Oncheckpoint event](https://msdn.microsoft.com/library/a7620c81-f769-46e5-b030-dde21b8c2d5b), [App activated, resume, and suspend using the WRL sample](https://go.microsoft.com/fwlink/p/?linkid=226722)
