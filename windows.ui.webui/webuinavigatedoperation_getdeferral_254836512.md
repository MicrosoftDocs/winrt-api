...
An app can complete navigation after its required asynchronous operations complete and it is ready to display its UI. App navigation is delayed until the app calls the [WebUINavigatedDeferral.complete](webuinavigateddeferral_complete.md) method.
