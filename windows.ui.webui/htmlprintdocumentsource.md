...
## -remarks
To get an instance of [HtmlPrintDocumentSource](htmlprintdocumentsource.md), call the [getHtmlPrintDocumentSource](https://msdn.microsoft.com/en-us/library/hh772325(v=vs.85).aspx)[MSApp](https://msdn.microsoft.com/en-us/library/hh772326(v=vs.85).aspx) method. 
