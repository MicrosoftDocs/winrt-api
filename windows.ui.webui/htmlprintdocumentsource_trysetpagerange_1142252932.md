...
## -returns
A [Boolean](https://msdn.microsoft.com/library/system.boolean.aspx) value that indicates whether [trySetPageRange](htmlprintdocumentsource_trysetpagerange.md) set the page range in *strPageRange*. **TRUE** indicates the page range was set and **FALSE** otherwise.
