...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Automation.ScrollPatternIdentifiers](/windows/winui/api/microsoft.ui.xaml.automation.scrollpatternidentifiers).
