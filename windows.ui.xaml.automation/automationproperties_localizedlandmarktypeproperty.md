...
## -remarks
This should be used in tandem with [UIA_CustomLandmarkTypeId](https://msdn.microsoft.com/library/73a34568-25da-4e70-bb2a-725135e6860b) however, **LocalizedLandmarkType** should always take precedence over **LandmarkType** and be used to describe the landmark before **LandmarkType**.
