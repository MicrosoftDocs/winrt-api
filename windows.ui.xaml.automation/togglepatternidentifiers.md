...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Automation.TogglePatternIdentifiers](/windows/winui/api/microsoft.ui.xaml.automation.togglepatternidentifiers).
