...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Automation.TableItemPatternIdentifiers](/windows/winui/api/microsoft.ui.xaml.automation.tableitempatternidentifiers).
