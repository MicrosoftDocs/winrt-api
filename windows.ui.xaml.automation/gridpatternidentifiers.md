...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Automation.GridPatternIdentifiers](/windows/winui/api/microsoft.ui.xaml.automation.gridpatternidentifiers).
