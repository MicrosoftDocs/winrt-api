...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Automation.MultipleViewPatternIdentifiers](/windows/winui/api/microsoft.ui.xaml.automation.multipleviewpatternidentifiers).
