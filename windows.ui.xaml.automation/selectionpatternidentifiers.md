...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Automation.SelectionPatternIdentifiers](/windows/winui/api/microsoft.ui.xaml.automation.selectionpatternidentifiers).
