...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Automation.DragPatternIdentifiers](/windows/winui/api/microsoft.ui.xaml.automation.dragpatternidentifiers).
