...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Automation.ValuePatternIdentifiers](/windows/winui/api/microsoft.ui.xaml.automation.valuepatternidentifiers).
