...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Automation.TransformPatternIdentifiers](/windows/winui/api/microsoft.ui.xaml.automation.transformpatternidentifiers).
