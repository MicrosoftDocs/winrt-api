...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Automation.WindowPatternIdentifiers](/windows/winui/api/microsoft.ui.xaml.automation.windowpatternidentifiers).
