...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Automation.StylesPatternIdentifiers](/windows/winui/api/microsoft.ui.xaml.automation.stylespatternidentifiers).
