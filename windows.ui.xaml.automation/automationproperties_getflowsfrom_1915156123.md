...
## -remarks
Get the list, then call the [Add](/dotnet/api/system.collections.generic.icollection-1.add?redirectedfrom=MSDN#System_Collections_Generic_ICollection_1_Add__0_) method to add a new element.
