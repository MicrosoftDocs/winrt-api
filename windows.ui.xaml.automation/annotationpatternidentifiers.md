...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Automation.AnnotationPatternIdentifiers](/windows/winui/api/microsoft.ui.xaml.automation.annotationpatternidentifiers).
