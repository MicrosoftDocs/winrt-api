...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Automation.SpreadsheetItemPatternIdentifiers](/windows/winui/api/microsoft.ui.xaml.automation.spreadsheetitempatternidentifiers).
