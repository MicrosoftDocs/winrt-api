...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Automation.GridItemPatternIdentifiers](/windows/winui/api/microsoft.ui.xaml.automation.griditempatternidentifiers).
