...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Automation.DropTargetPatternIdentifiers](/windows/winui/api/microsoft.ui.xaml.automation.droptargetpatternidentifiers).
