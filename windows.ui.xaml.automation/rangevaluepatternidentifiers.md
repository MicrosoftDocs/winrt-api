...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Automation.RangeValuePatternIdentifiers](/windows/winui/api/microsoft.ui.xaml.automation.rangevaluepatternidentifiers).
