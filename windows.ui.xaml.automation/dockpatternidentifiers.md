...
This same pattern is usually exposed to clients in a different way, depending on which technology they use to implement the client and examine the Microsoft UI Automation tree. [IDockProvider](https://msdn.microsoft.com/library/106ca4b4-1304-4942-88a4-79a3895b552f) is also presented as a Component Object Model (COM) interface.

## -examples

## -see-also
[IDockProvider](../windows.ui.xaml.automation.provider/idockprovider.md), [Control patterns and interfaces](https://msdn.microsoft.com/library/2091883c-5d0c-44ed-936a-709022926a42), [Custom automation peers](https://msdn.microsoft.com/library/aa8da53b-fe6e-40ac-9f0a-cb09637c87b4)
