...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Automation.DockPatternIdentifiers](/windows/winui/api/microsoft.ui.xaml.automation.dockpatternidentifiers).
