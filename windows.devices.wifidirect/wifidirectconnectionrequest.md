...
The [Close](wifidirectconnectionrequest_close_811482585.md) method releases all unmanaged resources associated with the [WiFiDirectConnectionRequest](wifidirectconnectionrequest.md) object.
