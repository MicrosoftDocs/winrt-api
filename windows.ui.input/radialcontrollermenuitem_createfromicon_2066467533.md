...
[UX guidelines](https://docs.microsoft.com/windows/uwp/input-and-devices/windows-wheel-interactions) for the Surface Dial recommend the following:
...
## -see-also
- [CreateFromKnownIcon](radialcontrollermenuitem_createfromknownicon_1665769620.md)
