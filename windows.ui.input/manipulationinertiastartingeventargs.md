---
-api-id: T:Windows.UI.Input.ManipulationInertiaStartingEventArgs
-api-type: winrt class
---

<!-- Class syntax.
public class ManipulationInertiaStartingEventArgs : Windows.UI.Input.IManipulationInertiaStartingEventArgs
-->
