---
-api-id: T:Windows.UI.Input.PointerUpdateKind
-api-type: winrt enum
---

<!-- Enumeration syntax
public enum Windows.UI.Input.PointerUpdateKind : int
-->
...
## -see-also
[Windows.UI.Input Enumerations](windows_ui_input_enumerations.md), [PointerUpdateKind](pointerpointproperties_pointerupdatekind.md)