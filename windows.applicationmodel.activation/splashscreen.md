...
If you notice a flicker during the transition to your extended splash screen, see the [Troubleshooting](https://msdn.microsoft.com/library/windows/apps/hh465338.aspx) section in [Guidelines and checklist for splash screens](https://msdn.microsoft.com/library/windows/apps/hh465338.aspx) for help.
...
[Windows.ApplicationModel.Activation classes](windows_applicationmodel_activation_classes.md), [Splash screen sample](https://go.microsoft.com/fwlink/p/?linkid=234889), [App activate and suspend using WinJS sample](https://go.microsoft.com/fwlink/p/?linkid=231617), [App activated, resume, and suspend using the WRL sample](https://go.microsoft.com/fwlink/p/?linkid=231474), [Quickstart: Adding a splash screen](https://docs.microsoft.com/previous-versions/windows/apps/hh465346(v=win.10)), [App lifecycle](https://docs.microsoft.com/windows/uwp/launch-resume/app-lifecycle), [How to extend the splash screen](https://docs.microsoft.com/previous-versions/windows/apps/hh700390(v=win.10)), [Add a splash screen](https://docs.microsoft.com/windows/uwp/launch-resume/add-a-splash-screen), [App lifecycle](https://docs.microsoft.com/windows/uwp/launch-resume/app-lifecycle), [Display a splash screen for more time](https://docs.microsoft.com/windows/uwp/launch-resume/create-a-customized-splash-screen), [Splash screen sample (Windows 10)](https://go.microsoft.com/fwlink/p/?LinkId=620608)
