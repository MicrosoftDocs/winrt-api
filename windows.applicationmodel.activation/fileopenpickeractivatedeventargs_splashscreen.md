...
## -see-also
[FileOpenPickerActivatedEventArgs class](fileopenpickeractivatedeventargs.md), [SplashScreen class](splashscreen.md), [File picker contracts sample](http://go.microsoft.com/fwlink/p/?linkid=231536)