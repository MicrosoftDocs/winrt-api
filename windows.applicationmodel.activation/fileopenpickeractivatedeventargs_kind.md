...
## -see-also
[ActivationKind enumeration](activationkind.md), [FileOpenPickerActivatedEventArgs class](fileopenpickeractivatedeventargs.md), [File picker contracts sample](http://go.microsoft.com/fwlink/p/?linkid=231536)