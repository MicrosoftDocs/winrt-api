...
### -param lineColor
The color of the ruled line, as an integer value that is equal to the value of the cartridge constant used in the [ClaimedSlipPrinter.ColorCartridge](claimedslipprinter_colorcartridge.md) property. If an unsupported value is specified, the printing results may be unpredictable.
...
## -see-also
[IReceiptOrSlipJob.DrawRuledLine](ireceiptorslipjob_drawruledline_1309666666.md), [ClaimedSlipPrinter.ColorCartridge](claimedslipprinter_colorcartridge.md), [PosPrinterLineDirection](posprinterlinedirection.md), [PosPrinterLineStyle](posprinterlinestyle.md)