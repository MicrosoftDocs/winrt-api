---
-api-id: M:Windows.Devices.PointOfService.ClaimedCashDrawer.Close
...
## -description
Disposes the claimed cash drawer, releases claim on the device, and disables the device the same way as calling [DisableAsync.](claimedcashdrawer_disableasync.md)
