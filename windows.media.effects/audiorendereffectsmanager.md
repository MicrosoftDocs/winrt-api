...
## -remarks
To create an instance of [AudioRenderEffectsManager](audiorendereffectsmanager.md), call [AudioEffectsManager.CreateAudioRenderEffectsManager](audioeffectsmanager_createaudiorendereffectsmanager.md).
