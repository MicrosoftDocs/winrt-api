---
-api-id: T:Windows.Media.Capture.Frames.MediaFrameSourceGetPropertyResult
-api-type: winrt class
---

<!-- Class syntax.
public class MediaFrameSourceGetPropertyResult : Windows.Media.Capture.Frames.IMediaFrameSourceGetPropertyResult
-->
