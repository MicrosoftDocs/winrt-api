...
## -remarks
Get an instance of this class by calling [FindAllAsync](mediaframesourcegroup_findallasync.md) and selecting an instance from the returned list. If you know the unique identifier of a media frame source group, you can get an instance of this class by calling [FromIdAsync](mediaframesourcegroup_fromidasync.md).
