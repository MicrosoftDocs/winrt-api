---
-api-id: P:Windows.Services.Maps.Guidance.GuidanceRoute.Path
-api-type: winrt property
---

<!-- Property syntax
public Windows.Devices.Geolocation.Geopath Path { get; }
-->

# Windows.Services.Maps.Guidance.GuidanceRoute.Path
