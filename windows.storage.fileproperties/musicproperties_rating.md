...
For HTML UI, the [Rating](http://msdn.microsoft.com/library/5f0a82ee-7a91-4b49-851c-580510000c7a) control implements a star-rating behavior, but you’ll have convert a **Rating** property value into the star-count values that the [Rating](http://msdn.microsoft.com/library/5f0a82ee-7a91-4b49-851c-580510000c7a) control uses for its properties.
...
Here’s some suggested logic for converting the 0-99 possible value of a **Rating** property to an integer value between 0 and 5 that is suitable for a 5-star UI presentation metaphor, and for the [Rating](http://msdn.microsoft.com/library/5f0a82ee-7a91-4b49-851c-580510000c7a) control: `uint starRating = rating == 0 ? 0 : (uint)Math.Round((double)rating / 25.0) + 1;
`.

## -examples

## -see-also
[Guidelines for the Rating control](http://msdn.microsoft.com/library/7ef0eeeb-c097-4508-a295-2eba3f79cafd)