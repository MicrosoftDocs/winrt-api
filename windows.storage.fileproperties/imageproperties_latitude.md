...
For code examples that demonstrate working with [Latitude](imageproperties_latitude.md), [Longitude](imageproperties_longitude.md) and their underlying file properties, see the [Simple imaging sample](https://go.microsoft.com/fwlink/p/?linkid=231549).
