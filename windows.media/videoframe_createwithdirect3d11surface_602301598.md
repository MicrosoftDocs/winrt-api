...
## -description
Creates a new instance of the [VideoFrame](videoframe.md) class for which the image data is stored in the provided [IDXGISurface](https://msdn.microsoft.com/library/windows/desktop/bb174565(v=vs.85).aspx).

## -parameters
### -param surface
The [IDXGISurface](https://msdn.microsoft.com/library/windows/desktop/bb174565(v=vs.85).aspx) in which the image data is stored.

## -returns
A **VideoFrame**.

## -remarks
If the *surface* parameter is null, an argument exception will occur. The supplied [IDXGISurface](https://msdn.microsoft.com/library/windows/desktop/bb174565(v=vs.85).aspx) must use one of the supported pixel formats. **VideoFrame** supports the formats corresponding to the following [DirectXPixelFormat](../windows.graphics.directx/directxpixelformat.md) values:
