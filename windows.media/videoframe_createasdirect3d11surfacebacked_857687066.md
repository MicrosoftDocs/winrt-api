...
## -description
Creates a new instance of the [VideoFrame](videoframe.md) class for which the image data is stored in an [IDXGISurface](https://docs.microsoft.com/windows/desktop/api/dxgi/nn-dxgi-idxgisurface) allocated by the supplied Direct3D device.
