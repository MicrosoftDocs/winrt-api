...
## -description
Creates a new instance of the [VideoFrame](videoframe.md) class for which the image data is stored in an [IDXGISurface](https://msdn.microsoft.com/library/windows/desktop/bb174565(v=vs.85).aspx) allocated by the supplied Direct3D device.
