...
Namespace Global.SDKTemplate.Common
    ...
    Public Class LayoutAwarePage
        ...
        ''' <summary>
        ''' Undo the changes made in <see cref="OnLoaded"/> when the page is no longer visible as best
        ''' practice to avoid prolonging object lifetime or leaking.
        ''' </summary>
        ''' <param name="sender">The object that initiated the request.</param>
        ''' <param name="e">Event data that describes how the request was made.</param>
        ...
        ''' <seealso cref="InvalidateVisualState"/>
        Protected Overridable Function DetermineVisualState(width As Double) As String
