...
+ If you're using .NET code, the collection is an [IReadOnlyDictionary](/dotnet/api/system.collections.generic.ireadonlydictionary-2?redirectedfrom=MSDN) instance, with string keys and nominally untyped ([Object](/dotnet/api/system.object?redirectedfrom=MSDN)) values. Use the [Item](/dotnet/api/system.collections.generic.ireadonlydictionary-2.item?redirectedfrom=MSDN#System_Collections_Generic_IReadOnlyDictionary_2_Item__0_) indexer or [TryGetValue](/dotnet/api/system.collections.generic.ireadonlydictionary-2.trygetvalue?redirectedfrom=MSDN#System_Collections_Generic_IReadOnlyDictionary_2_TryGetValue__0__1__) to get the values of specific properties. Always use [KnownRetailInfoProperties](knownretailinfoproperties.md) properties to specify the *key* parameters.
