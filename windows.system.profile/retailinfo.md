...
When possible, use [RetailInfo](retailinfo.md) instead of the previous [Windows.Phone.System.Profile.RetailMode](../windows.phone.system.profile/retailmode.md) API. [RetailMode](../windows.phone.system.profile/retailmode.md) is only available for Windows Phone and doesn't support a "Properties" set of device-specific properties.
