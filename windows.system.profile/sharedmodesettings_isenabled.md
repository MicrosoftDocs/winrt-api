...
A **true** value means the PC is running in scenarios where multiple consecutive users use the PC. For more info on when this is used on Desktop, see [Set up a shared or guest PC with Windows 10](https://technet.microsoft.com/en-us/itpro/windows/manage/set-up-shared-or-guest-pc).
