...
## -remarks
Get an instance of the **MediaItemDisplayProperties** class by calling [GetDisplayProperties](mediaplaybackitem_getdisplayproperties.md) on an initialized [MediaPlaybackItem](mediaplaybackitem.md) object. Update the display properties for the playback item by setting the properties of the retrieved **MediaItemDisplayProperties** object and then calling [ApplyDisplayProperties](mediaplaybackitem_applydisplayproperties.md).
