...
## -description
Provides data for the [BufferingStarted](https://docs.microsoft.com/uwp/api/windows.media.playback.mediaplaybacksession#Windows_Media_Playback_MediaPlaybackSession_BufferingStarted) event of a [MediaPlaybackSession](https://docs.microsoft.com/en-us/uwp/api/windows.media.playback.mediaplaybacksession).
