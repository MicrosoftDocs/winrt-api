---
-api-id: T:Windows.Media.Playback.MediaPlaybackItemOpenedEventArgs
-api-type: winrt class
---

<!-- Class syntax.
public class MediaPlaybackItemOpenedEventArgs : Windows.Media.Playback.IMediaPlaybackItemOpenedEventArgs
-->
