---
-api-id: M:Windows.Media.Protection.PlayReady.PlayReadyMeteringReportServiceRequest.ProcessManualEnablingResponse(System.Byte[])
...
+ S_OK—The enabling response was processed and there are no more service requests necessary. A following call to [NextServiceRequest](playreadymeteringreportservicerequest_nextservicerequest.md) will return a **NULL** pointer.
