---
-api-id: M:Windows.Media.Protection.PlayReady.IPlayReadyServiceRequest.ProcessManualEnablingResponse(System.Byte[])
...
# Windows.Media.Protection.PlayReady.IPlayReadyServiceRequest.ProcessManualEnablingResponse
...
+ S_OK—The enabling response was processed and there are no more service requests necessary. A following call to [NextServiceRequest](iplayreadyservicerequest_nextservicerequest.md) will return a **NULL** pointer.
