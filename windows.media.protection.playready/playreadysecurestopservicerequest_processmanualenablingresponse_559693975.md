---
-api-id: M:Windows.Media.Protection.PlayReady.PlayReadySecureStopServiceRequest.ProcessManualEnablingResponse(System.Byte[])
...
+ S_OK—The enabling response was processed and there are no more service requests necessary. A following call to [NextServiceRequest](playreadysecurestopservicerequest_nextservicerequest.md) will return a **NULL** pointer.
