---
-api-id: T:Windows.Devices.WiFiDirect.Services.WiFiDirectServiceProvisioningInfo
-api-type: winrt class
-api-device-family-note: xbox
---

<!-- Class syntax.
public class WiFiDirectServiceProvisioningInfo : Windows.Devices.WiFiDirect.Services.IWiFiDirectServiceProvisioningInfo
-->
