---
-api-id: T:Windows.Devices.WiFiDirect.Services.WiFiDirectServiceConfigurationMethod
-api-type: winrt enum
---

<!-- Enumeration syntax
public enum Windows.Devices.WiFiDirect.Services.WiFiDirectServiceConfigurationMethod : int
-->
