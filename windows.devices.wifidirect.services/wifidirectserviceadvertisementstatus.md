---
-api-id: T:Windows.Devices.WiFiDirect.Services.WiFiDirectServiceAdvertisementStatus
-api-type: winrt enum
---

<!-- Enumeration syntax
public enum Windows.Devices.WiFiDirect.Services.WiFiDirectServiceAdvertisementStatus : int
-->
