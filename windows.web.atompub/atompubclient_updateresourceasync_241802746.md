...
## -description
Updates an existing Entry or Media Link resource. If an ETag: header has previously been seen while retrieving this resource (in a response to [RetrieveResourceAsync](atompubclient_retrieveresourceasync.md), [CreateResourceAsync](atompubclient_createresourceasync.md) or a previous call to [UpdateResourceAsync](atompubclient_updateresourceasync.md)), this method automatically sends an If-Match: header with the remembered value.
