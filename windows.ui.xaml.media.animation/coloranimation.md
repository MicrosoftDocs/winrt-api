...
The [From](coloranimation_from.md), [By](coloranimation_by.md) and [To](coloranimation_to.md) properties of a [ColorAnimation](coloranimation.md) aren't strictly a [Color](../windows.ui/color.md). Instead these are a [Nullable](XREF:TODO:T:System.Nullable`1) for [Color](../windows.ui/color.md). The default value for these is **null**, not an uninitialized structure. That **null** value is how the animation system distinguishes that you haven't specifically set a value. Visual C++ component extensions (C++/CX) doesn't have a [Nullable](XREF:TODO:T:System.Nullable`1) type, so it uses [IReference](../windows.foundation/ireference_1.md) instead.
...
> [!div class="tabbedCodeSnippets"][!code-xml[Coloranimation](../windows.ui.xaml.media.animation/code/coloranimation/csharp/Page.xaml#SnippetColoranimation)][!code-vb[Coloranimation](../windows.ui.xaml.media.animation/code/coloranimation/vbnet/Page.xaml.vb#SnippetColoranimation)][!code-xml[Coloranimation](../windows.ui.xaml.media.animation/code/coloranimationusingkeyframes/csharp/Page.xaml#SnippetColoranimation)][!code-vb[Coloranimation](../windows.ui.xaml.media.animation/code/coloranimationusingkeyframes/vbnet/Page.xaml.vb#SnippetColoranimation)][!code-xml[Coloranimation](../windows.ui.xaml.media.animation/code/coloranimation_direct_targeting/csharp/Page.xaml#SnippetColoranimation)][!code-vb[Coloranimation](../windows.ui.xaml.media.animation/code/coloranimation_direct_targeting/vbnet/Page.xaml.vb#SnippetColoranimation)]

> [!div class="tabbedCodeSnippets"][!code-cs[Coloranimation_cs](../windows.ui.xaml.media.animation/code/coloranimation/csharp/Page.xaml.cs#SnippetColoranimation_cs)][!code-vb[Coloranimation_cs](../windows.ui.xaml.media.animation/code/coloranimation/vbnet/Page.xaml.vb#SnippetColoranimation_cs)]
...
> [!div class="tabbedCodeSnippets"][!code-xml[Coloranimation_direct_targeting](../windows.ui.xaml.media.animation/code/coloranimation_direct_targeting/csharp/Page.xaml#SnippetColoranimation_direct_targeting)][!code-vb[Coloranimation_direct_targeting](../windows.ui.xaml.media.animation/code/coloranimation_direct_targeting/vbnet/Page.xaml.vb#SnippetColoranimation_direct_targeting)]

> [!div class="tabbedCodeSnippets"][!code-cs[Coloranimation_direct_targeting_cs](../windows.ui.xaml.media.animation/code/coloranimation_direct_targeting/csharp/Page.xaml.cs#SnippetColoranimation_direct_targeting_cs)][!code-vb[Coloranimation_direct_targeting_cs](../windows.ui.xaml.media.animation/code/coloranimation_direct_targeting/vbnet/Page.xaml.vb#SnippetColoranimation_direct_targeting_cs)]
