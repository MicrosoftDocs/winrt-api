...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Media.Animation.ColorAnimationUsingKeyFrames.EnableDependentAnimationProperty](/windows/winui/api/microsoft.ui.xaml.media.animation.coloranimationusingkeyframes.enabledependentanimationproperty).
