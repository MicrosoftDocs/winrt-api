...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Media.Animation.DiscreteColorKeyFrame](/windows/winui/api/microsoft.ui.xaml.media.animation.discretecolorkeyframe).
