---
-api-id: P:Windows.UI.Xaml.Media.Animation.PointKeyFrame.KeyTime
...
# Windows.UI.Xaml.Media.Animation.PointKeyFrame.KeyTime

## -description
Gets or sets the time at which the key frame's target [Value](pointkeyframe_value.md) should be reached.

Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Media.Animation.PointKeyFrame.KeyTime](/windows/winui/api/microsoft.ui.xaml.media.animation.pointkeyframe.keytime) (for WinUI in the [Windows App SDK](/windows/apps/windows-app-sdk/), see the **[Windows App SDK namespaces](/windows/windows-app-sdk/api/winrt/)**).
