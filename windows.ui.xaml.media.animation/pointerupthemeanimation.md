...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Media.Animation.PointerUpThemeAnimation](/windows/winui/api/microsoft.ui.xaml.media.animation.pointerupthemeanimation).
