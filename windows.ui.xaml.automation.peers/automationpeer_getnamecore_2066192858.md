...
## -description
Provides the peer's behavior when a Microsoft UI Automation client calls [GetName](automationpeer_getname.md) or an equivalent Microsoft UI Automation client API.
...
## -see-also
[GetName](automationpeer_getname.md), [Custom automation peers](http://msdn.microsoft.com/library/aa8da53b-fe6e-40ac-9f0a-cb09637c87b4)