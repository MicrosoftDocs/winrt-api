...
## -description
Provides the peer's behavior when a Microsoft UI Automation client calls [IsContentElement](automationpeer_iscontentelement.md) or an equivalent Microsoft UI Automation client API.
