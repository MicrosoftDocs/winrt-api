...
## -remarks
As an example, if the user entered "425-555-5555" for a zip code field that requires 5 or 9 digits, the [IsDataValidForForm](automationpeer_isdatavalidforform.md) property can be set to **false** to indicate that the data is not valid.
