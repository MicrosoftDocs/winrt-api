...
+ [GetClassName](automationpeer_getclassname_614238974.md) uses "GetContainerPeer" logic to get class name information. If there is no container peer, calling [GetClassName](automationpeer_getclassname_614238974.md) throws [ElementNotAvailableException](/dotnet/api/system.windows.automation.elementnotavailableexception?redirectedfrom=MSDN).
