...
If [FromElement](frameworkelementautomationpeer_fromelement_1666357111.md) returns **null**, it's probably because the element you passed does not have an implementation for [OnCreateAutomationPeer](../windows.ui.xaml/uielement_oncreateautomationpeer_1478162674.md).

[FromElement](frameworkelementautomationpeer_fromelement_1666357111.md) can return the peer even if the **CreateAutomationPeer** system logic hasn't run yet on the *element* target for some reason. It will invoke the same **CreateAutomationPeer** logic internally in order to get the peer.
