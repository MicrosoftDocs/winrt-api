...
## -description
Provides the peer's behavior when a Microsoft UI Automation client calls [IsKeyboardFocusable](automationpeer_iskeyboardfocusable.md) or an equivalent Microsoft UI Automation client API.
