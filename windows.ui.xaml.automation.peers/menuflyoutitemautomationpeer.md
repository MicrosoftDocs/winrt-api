...
+ [GetClassName](automationpeer_getclassname.md) returns "MenuFlyoutItem".
+ [GetAutomationControlType](automationpeer_getautomationcontroltype.md) returns [AutomationControlType.MenuItem](automationcontroltype.md).
