...
## -description
Gets a value that indicates whether the [Toggle](semanticzoomautomationpeer_toggle.md) method can be called and result in a toggled view.

## -property-value
**true** if calling [Toggle](semanticzoomautomationpeer_toggle.md) will result in a toggled view; otherwise, **false**.
