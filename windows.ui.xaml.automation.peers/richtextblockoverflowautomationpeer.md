...
+ [GetClassName](automationpeer_getclassname.md) returns "RichTextBlockOverflow".
...
+ [GetName](automationpeer_getname.md) returns a plain-text representation of the [RichTextBlockOverflow](../windows.ui.xaml.controls/richtextblockoverflow.md) text content from [Blocks](../windows.ui.xaml.controls/richtextblock_blocks.md).
