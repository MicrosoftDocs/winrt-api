---
-api-id: M:Windows.UI.Xaml.Automation.Peers.AutomationPeer.GetPeerFromPoint(Windows.Foundation.Point)
...
# Windows.UI.Xaml.Automation.Peers.AutomationPeer.GetPeerFromPoint

## -description
Gets an [AutomationPeer](automationpeer.md) from the specified point.

Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Automation.Peers.AutomationPeer.GetPeerFromPoint](/windows/winui/api/microsoft.ui.xaml.automation.peers.automationpeer.getpeerfrompoint) (for WinUI in the [Windows App SDK](/windows/apps/windows-app-sdk/), see the **[Windows App SDK namespaces](/windows/windows-app-sdk/api/winrt/)**).
