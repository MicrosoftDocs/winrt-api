...
Making the media content itself accessible requires planning, and is related to accessibility scenarios where Microsoft UI Automation isn't directly involved. For more info, see [Making media content accessible](https://docs.microsoft.com/previous-versions/windows/apps/hh868162(v=win.10)).
