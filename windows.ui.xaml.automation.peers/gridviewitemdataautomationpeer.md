...
## -remarks
 [GridViewItemDataAutomationPeer](gridviewitemdataautomationpeer.md) is generated from [GridViewAutomationPeer](gridviewautomationpeer.md) logic, not an associated control class.

### Default peer implementation and overrides in **GridViewItemDataAutomationPeer**

[GridViewItemDataAutomationPeer](gridviewitemdataautomationpeer.md) has overrides of **Core** methods such that the associated [AutomationPeer](automationpeer.md) methods provide peer-specific information to a Microsoft UI Automation client.
