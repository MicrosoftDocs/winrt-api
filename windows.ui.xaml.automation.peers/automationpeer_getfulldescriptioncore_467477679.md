...
## -remarks
You should never invoke the base behavior, and all custom peers should override [GetFullDescriptionCore](automationpeer_getfulldescriptioncore_467477679.md) to report the full description of this [AutomationPeer](automationpeer.md). For more info, see [Custom automation peers](http://msdn.microsoft.com/library/aa8da53b-fe6e-40ac-9f0a-cb09637c87b4).
