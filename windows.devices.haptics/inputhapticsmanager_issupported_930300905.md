---
-api-id: M:Windows.Devices.Haptics.InputHapticsManager.IsSupported
...
**true** if the [InputHapticsManager](inputhapticsmanager.md) functionality is supported; otherwise, **false**.
