---
-api-id: M:Windows.AI.MachineLearning.TensorInt32Bit.CreateReference
-api-type: winrt method
ms.custom: 19H1
---

<!-- Method syntax.
public [IMemoryBufferReference](../windows.foundation/imemorybufferreference.md) TensorInt32Bit.CreateReference()
-->
