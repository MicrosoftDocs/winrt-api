...
Note: On Windows builds prior to build 2004 this would silently succeed and incorrectly return the software adapter ([DXGI_ADAPTER_FLAG_SOFTWARE]([https://docs.microsoft.com/en-us/windows/win32/api/xgi/ne-dxgi-dxgi_adapter_flag))
