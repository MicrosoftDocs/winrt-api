---
-api-id: M:Windows.AI.MachineLearning.TensorBoolean.CreateReference
-api-type: winrt method
ms.custom: 19H1
---

<!-- Method syntax.
public [IMemoryBufferReference](../windows.foundation/imemorybufferreference.md) TensorBoolean.CreateReference()
-->
