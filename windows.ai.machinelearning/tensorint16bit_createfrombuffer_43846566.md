---
-api-id: M:Windows.AI.MachineLearning.TensorInt16Bit.CreateFromBuffer(System.Int64[],Windows.Storage.Streams.IBuffer)
-api-type: winrt method
ms.custom: 19H1
---

<!-- Method syntax.
public TensorInt16Bit TensorInt16Bit.CreateFromBuffer(Int64[] shape, IBuffer buffer)
-->
...
## -returns
A 16-bit signed integer tensor object backed by a buffer reference to the provided [IBuffer](../windows.storage.streams/ibuffer.md) *buffer*.
