...
<!-- Method syntax.
public TensorInt32Bit TensorInt32Bit.CreateFromBuffer(Int64[] shape, IBuffer buffer)
-->
...
## -returns
A 32-bit signed integer tensor object backed by a buffer reference to the provided [IBuffer](../windows.storage.streams/ibuffer.md) *buffer*.
