---
-api-id: M:Windows.Storage.Pickers.FileOpenPicker.CreateForUser(Windows.System.User)
-api-type: winrt method
ms.custom: 19H1
---

<!-- Method syntax.
public FileOpenPicker FileOpenPicker.CreateForUser(User user)
-->
...
## -parameters
### -param user
The user for which to create the [FileOpenPicker](fileopenpicker.md).

## -returns
The new [FileOpenPicker](fileopenpicker.md) that was created.
