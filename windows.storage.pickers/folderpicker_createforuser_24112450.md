---
-api-id: M:Windows.Storage.Pickers.FolderPicker.CreateForUser(Windows.System.User)
-api-type: winrt method
ms.custom: 19H1
---

<!-- Method syntax.
public FolderPicker FolderPicker.CreateForUser(User user)
-->
...
## -parameters
### -param user
The user for which to create the [FolderPicker](folderpicker.md).

## -returns
The new [FolderPicker](folderpicker.md) that was created.
