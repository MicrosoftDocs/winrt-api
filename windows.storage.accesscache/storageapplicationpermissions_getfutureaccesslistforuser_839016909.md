---
-api-id: M:Windows.Storage.AccessCache.StorageApplicationPermissions.GetFutureAccessListForUser(Windows.System.User)
-api-type: winrt method
ms.custom: 19H1
---

<!-- Method syntax.
public StorageItemAccessList StorageApplicationPermissions.GetFutureAccessListForUser(User user)
-->
