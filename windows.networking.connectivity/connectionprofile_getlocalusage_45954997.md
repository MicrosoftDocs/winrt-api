...
## -description
> [!NOTE]
> [GetLocalUsage](connectionprofile_getlocalusage_45954997.md) may be altered or unavailable for releases after Windows 8.1. Instead, use [GetNetworkUsageAsync](connectionprofile_getnetworkusageasync.md)
