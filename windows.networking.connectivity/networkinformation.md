...
(WlanConnectionProfileDetails, WwanConnectionProfileDetails). Always re-query inside the status changed event
handler because previously cached profile objects are not live-updating.
