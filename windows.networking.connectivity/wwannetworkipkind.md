...
## -description
Defines constants that describe a level of supported IP. The values reflect the [WWAN_IP_TYPE](https://msdn.microsoft.com/library/windows/hardware/hh464134) enumeration. You can use these values to determine which cellular profile to use (for example, to choose between IMS and SUPL).
