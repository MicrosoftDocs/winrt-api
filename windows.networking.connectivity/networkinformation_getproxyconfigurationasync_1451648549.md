...
## -remarks
The *uri* parameter passed to the [GetProxyConfigurationAsync](networkinformation_getproxyconfigurationasync_1451648549.md) method should contain a hostname or IP address for the target endpoint and service name, port number, or protocol scheme.

If the [GetProxyConfigurationAsync](networkinformation_getproxyconfigurationasync_1451648549.md) method is successful, a [ProxyConfiguration](proxyconfiguration.md) object for the specified *uri* parameter is returned by the [IAsyncOperation(ProxyConfiguration)](../windows.foundation/iasyncoperation_1.md) handler.
