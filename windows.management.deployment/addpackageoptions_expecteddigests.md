...
Gets a dictionary that maps the package URIs associated with an <xref:Windows.Management.Deployment.AddPackageOptions> with the a corresponding digest string.
