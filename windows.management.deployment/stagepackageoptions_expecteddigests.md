...
Gets a dictionary that maps the package URIs associated with a <xref:Windows.Management.Deployment.StagePackageOptions> with the a corresponding digest string.
