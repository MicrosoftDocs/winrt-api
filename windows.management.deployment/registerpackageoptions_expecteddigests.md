...
Gets a dictionary that maps the package URIs associated wih a <xref:Windows.Management.Deployment.RegisterPackageOptions> with the a corresponding digest string.
