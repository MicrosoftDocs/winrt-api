...
## -description
Allows single or multiple app [Packages](https://docs.microsoft.com/uwp/api/windows.applicationmodel.package) to be installed with an .appinstaller file.
...
- [App Installer APIs](https://docs.microsoft.com/windows/msix/app-installer/app-installer-documentation)
