...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.CompositionObject.StopAnimation](/windows/winui/api/microsoft.ui.composition.compositionobject.stopanimation).
