...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.CompositionGeometry.TrimEnd](/windows/winui/api/microsoft.ui.composition.compositiongeometry.trimend).
