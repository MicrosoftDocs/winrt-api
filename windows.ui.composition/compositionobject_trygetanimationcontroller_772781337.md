...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.CompositionObject.TryGetAnimationController](/windows/winui/api/microsoft.ui.composition.compositionobject.trygetanimationcontroller).
