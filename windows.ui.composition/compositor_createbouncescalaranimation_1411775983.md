...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.Compositor.CreateBounceScalarAnimation](/windows/winui/api/microsoft.ui.composition.compositor.createbouncescalaranimation).
