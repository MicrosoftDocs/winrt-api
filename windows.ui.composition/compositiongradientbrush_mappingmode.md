...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.CompositionGradientBrush.MappingMode](/windows/winui/api/microsoft.ui.composition.compositiongradientbrush.mappingmode).
