...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.Compositor.CreateDropShadow](/windows/winui/api/microsoft.ui.composition.compositor.createdropshadow).
