...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.CompositionAnimation.SetColorParameter](/windows/winui/api/microsoft.ui.composition.compositionanimation.setcolorparameter).
