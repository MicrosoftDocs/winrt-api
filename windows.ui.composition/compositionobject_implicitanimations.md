...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.CompositionObject.ImplicitAnimations](/windows/winui/api/microsoft.ui.composition.compositionobject.implicitanimations).
