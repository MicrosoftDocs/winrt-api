...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.Compositor.CreateVector3KeyFrameAnimation](/windows/winui/api/microsoft.ui.composition.compositor.createvector3keyframeanimation).
