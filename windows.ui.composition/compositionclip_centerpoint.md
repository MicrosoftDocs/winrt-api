...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.CompositionClip.CenterPoint](/windows/winui/api/microsoft.ui.composition.compositionclip.centerpoint).
