...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.CompositionVirtualDrawingSurface](/windows/winui/api/microsoft.ui.composition.compositionvirtualdrawingsurface).
