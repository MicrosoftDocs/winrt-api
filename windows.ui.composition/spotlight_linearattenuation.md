...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.SpotLight.LinearAttenuation](/windows/winui/api/microsoft.ui.composition.spotlight.linearattenuation).
