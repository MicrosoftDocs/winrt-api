...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.RenderingDeviceReplacedEventArgs.GraphicsDevice](/windows/winui/api/microsoft.ui.composition.renderingdevicereplacedeventargs.graphicsdevice).
