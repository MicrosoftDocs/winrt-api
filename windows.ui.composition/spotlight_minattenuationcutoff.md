...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.SpotLight.MinAttenuationCutoff](/windows/winui/api/microsoft.ui.composition.spotlight.minattenuationcutoff).
