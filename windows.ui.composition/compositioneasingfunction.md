...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.CompositionEasingFunction](/windows/winui/api/microsoft.ui.composition.compositioneasingfunction).
