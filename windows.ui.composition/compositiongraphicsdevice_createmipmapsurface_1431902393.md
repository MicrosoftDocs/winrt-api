...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.CompositionGraphicsDevice.CreateMipmapSurface](/windows/winui/api/microsoft.ui.composition.compositiongraphicsdevice.createmipmapsurface).
