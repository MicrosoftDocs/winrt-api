...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.CompositionClip.RotationAngleInDegrees](/windows/winui/api/microsoft.ui.composition.compositionclip.rotationangleindegrees) (for WinUI in the [Windows App SDK](/windows/apps/windows-app-sdk/), see the **[Windows App SDK namespaces](/windows/windows-app-sdk/api/winrt/)**).
