...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.Compositor.CreateContainerVisual](/windows/winui/api/microsoft.ui.composition.compositor.createcontainervisual).
