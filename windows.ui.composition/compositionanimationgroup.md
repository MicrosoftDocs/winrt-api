...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.CompositionAnimationGroup](/windows/winui/api/microsoft.ui.composition.compositionanimationgroup).
