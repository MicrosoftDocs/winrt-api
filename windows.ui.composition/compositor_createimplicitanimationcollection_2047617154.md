...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.Compositor.CreateImplicitAnimationCollection](/windows/winui/api/microsoft.ui.composition.compositor.createimplicitanimationcollection).
