...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.CompositionAnimation.SetScalarParameter](/windows/winui/api/microsoft.ui.composition.compositionanimation.setscalarparameter).
