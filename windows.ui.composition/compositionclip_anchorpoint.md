...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.CompositionClip.AnchorPoint](/windows/winui/api/microsoft.ui.composition.compositionclip.anchorpoint).
