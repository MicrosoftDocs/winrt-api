...
## -description
Retrieves the specified [Single](https://msdn.microsoft.com/library/system.single.aspx) property value.
...
### -param value
If the operation is successful, this parameter will contain the specified [Single](https://msdn.microsoft.com/library/system.single.aspx) property value when the method returns.
