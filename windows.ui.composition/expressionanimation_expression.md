...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.ExpressionAnimation.Expression](/windows/winui/api/microsoft.ui.composition.expressionanimation.expression).
