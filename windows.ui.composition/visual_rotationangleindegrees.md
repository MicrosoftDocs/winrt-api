---
-api-id: P:Windows.UI.Composition.Visual.RotationAngleInDegrees
...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.Visual.RotationAngleInDegrees](/windows/winui/api/microsoft.ui.composition.visual.rotationangleindegrees).
