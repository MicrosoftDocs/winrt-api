...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.CompositionClip.TransformMatrix](/windows/winui/api/microsoft.ui.composition.compositionclip.transformmatrix).
