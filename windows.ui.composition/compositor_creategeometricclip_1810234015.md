...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.Compositor.CreateGeometricClip](/windows/winui/api/microsoft.ui.composition.compositor.creategeometricclip).
