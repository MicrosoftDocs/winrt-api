...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.CompositionSpriteShape.StrokeStartCap](/windows/winui/api/microsoft.ui.composition.compositionspriteshape.strokestartcap).
