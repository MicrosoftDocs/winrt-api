...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.CompositionObject.StartAnimation](/windows/winui/api/microsoft.ui.composition.compositionobject.startanimation).
