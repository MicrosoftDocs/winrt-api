...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.CompositionViewBox.HorizontalAlignmentRatio](/windows/winui/api/microsoft.ui.composition.compositionviewbox.horizontalalignmentratio).
