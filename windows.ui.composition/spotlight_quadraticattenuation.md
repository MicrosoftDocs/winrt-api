...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.SpotLight.QuadraticAttenuation](/windows/winui/api/microsoft.ui.composition.spotlight.quadraticattenuation).
