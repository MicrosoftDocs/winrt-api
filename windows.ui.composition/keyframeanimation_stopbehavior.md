...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.KeyFrameAnimation.StopBehavior](/windows/winui/api/microsoft.ui.composition.keyframeanimation.stopbehavior).
