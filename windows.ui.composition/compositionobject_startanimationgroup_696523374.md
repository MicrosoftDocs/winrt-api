...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.CompositionObject.StartAnimationGroup](/windows/winui/api/microsoft.ui.composition.compositionobject.startanimationgroup).
