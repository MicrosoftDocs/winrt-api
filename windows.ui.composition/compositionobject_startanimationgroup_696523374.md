...
To get [Completed](compositionscopedbatch_completed.md) events for all the animations, [StartAnimationGroup](compositionobject_startanimationgroup.md) should be called from a [CompositionScopedBatch](compositionscopedbatch.md) with a registered [Completed](compositionscopedbatch_completed.md) event.
