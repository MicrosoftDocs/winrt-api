...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.ScalarNaturalMotionAnimation.FinalValue](/windows/winui/api/microsoft.ui.composition.scalarnaturalmotionanimation.finalvalue).
