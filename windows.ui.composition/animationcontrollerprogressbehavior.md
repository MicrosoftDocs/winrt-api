...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.AnimationControllerProgressBehavior](/windows/winui/api/microsoft.ui.composition.animationcontrollerprogressbehavior).
