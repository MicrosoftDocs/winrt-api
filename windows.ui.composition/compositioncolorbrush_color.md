...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.CompositionColorBrush.Color](/windows/winui/api/microsoft.ui.composition.compositioncolorbrush.color).
