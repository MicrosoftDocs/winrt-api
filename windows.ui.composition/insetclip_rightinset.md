---
-api-id: P:Windows.UI.Composition.InsetClip.RightInset
...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.InsetClip.RightInset](/windows/winui/api/microsoft.ui.composition.insetclip.rightinset).
