---
-api-id: P:Windows.UI.Composition.Visual.Offset
...
# Windows.UI.Composition.Visual.Offset
...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.Visual.Offset](/windows/winui/api/microsoft.ui.composition.visual.offset) (for WinUI in the [Windows App SDK](/windows/apps/windows-app-sdk/), see the **[Windows App SDK namespaces](/windows/windows-app-sdk/api/winrt/)**).
