...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.CompositionSurfaceBrush.AnchorPoint](/windows/winui/api/microsoft.ui.composition.compositionsurfacebrush.anchorpoint).
