...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.CompositionSpriteShape.Geometry](/windows/winui/api/microsoft.ui.composition.compositionspriteshape.geometry).
