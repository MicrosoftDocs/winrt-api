...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.CompositionRectangleGeometry](/windows/winui/api/microsoft.ui.composition.compositionrectanglegeometry).
