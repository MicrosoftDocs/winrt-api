...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.SpotLight.OuterConeIntensity](/windows/winui/api/microsoft.ui.composition.spotlight.outerconeintensity).
