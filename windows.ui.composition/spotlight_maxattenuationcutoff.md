...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.SpotLight.MaxAttenuationCutoff](/windows/winui/api/microsoft.ui.composition.spotlight.maxattenuationcutoff).
