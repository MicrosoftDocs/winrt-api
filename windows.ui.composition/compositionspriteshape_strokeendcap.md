...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.CompositionSpriteShape.StrokeEndCap](/windows/winui/api/microsoft.ui.composition.compositionspriteshape.strokeendcap).
