...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.CompositionSurfaceBrush.VerticalAlignmentRatio](/windows/winui/api/microsoft.ui.composition.compositionsurfacebrush.verticalalignmentratio).
