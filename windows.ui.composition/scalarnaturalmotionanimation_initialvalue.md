...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.ScalarNaturalMotionAnimation.InitialValue](/windows/winui/api/microsoft.ui.composition.scalarnaturalmotionanimation.initialvalue).
