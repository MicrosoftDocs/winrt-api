...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.SpotLight.ConstantAttenuation](/windows/winui/api/microsoft.ui.composition.spotlight.constantattenuation).
