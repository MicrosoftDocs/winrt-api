...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.PointLight.MinAttenuationCutoff](/windows/winui/api/microsoft.ui.composition.pointlight.minattenuationcutoff).
