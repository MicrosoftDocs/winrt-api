...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.Visual.RelativeOffsetAdjustment](/windows/winui/api/microsoft.ui.composition.visual.relativeoffsetadjustment).
