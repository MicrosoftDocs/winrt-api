...
## -remarks
A [PointLight](pointlight.md) gives off light equally in all directions.

[PointLight](pointlight.md) is one of the four light types derived from [CompositionLight](compositionlight.md).
