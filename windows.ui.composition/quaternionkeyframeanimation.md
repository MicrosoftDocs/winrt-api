...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.QuaternionKeyFrameAnimation](/windows/winui/api/microsoft.ui.composition.quaternionkeyframeanimation).
