...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.CompositionSurfaceBrush.Surface](/windows/winui/api/microsoft.ui.composition.compositionsurfacebrush.surface).
