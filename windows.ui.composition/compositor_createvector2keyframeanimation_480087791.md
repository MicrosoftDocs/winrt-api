...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.Compositor.CreateVector2KeyFrameAnimation](/windows/winui/api/microsoft.ui.composition.compositor.createvector2keyframeanimation).
