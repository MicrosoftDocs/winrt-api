...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.AnimationController.MaxPlaybackRate](/windows/winui/api/microsoft.ui.composition.animationcontroller.maxplaybackrate).
