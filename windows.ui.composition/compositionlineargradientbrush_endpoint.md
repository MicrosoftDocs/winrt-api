...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.CompositionLinearGradientBrush.EndPoint](/windows/winui/api/microsoft.ui.composition.compositionlineargradientbrush.endpoint).
