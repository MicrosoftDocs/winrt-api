...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.Vector3KeyFrameAnimation.InsertKeyFrame](/windows/winui/api/microsoft.ui.composition.vector3keyframeanimation.insertkeyframe).
