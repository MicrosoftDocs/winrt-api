...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.Compositor.CreateBounceVector2Animation](/windows/winui/api/microsoft.ui.composition.compositor.createbouncevector2animation).
