...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.CompositionBatchCompletedEventArgs](/windows/winui/api/microsoft.ui.composition.compositionbatchcompletedeventargs).
