...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.CompositionSpriteShape.StrokeDashArray](/windows/winui/api/microsoft.ui.composition.compositionspriteshape.strokedasharray).
