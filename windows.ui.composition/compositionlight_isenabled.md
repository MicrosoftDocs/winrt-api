...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.CompositionLight.IsEnabled](/windows/winui/api/microsoft.ui.composition.compositionlight.isenabled).
