...
To see the complete listing for this and other printing scenarios using **PrintTaskRequested**, see [Printing](/previous-versions/windows/apps/hh465225(v=win.10)).
