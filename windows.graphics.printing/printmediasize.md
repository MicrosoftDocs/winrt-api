---
-api-id: T:Windows.Graphics.Printing.PrintMediaSize
-api-type: winrt enum
---

<!-- Enumeration syntax
public enum Windows.Graphics.Printing.PrintMediaSize : int
-->
...
### -field IsoB4Envelope:29
The IsoB4Envelope media size.

### -field IsoB5Envelope:30
