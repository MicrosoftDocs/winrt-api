...
## -remarks
HTML content often contains references to other files. The most common example is an img tag that refers to a specific file. To ensure that the image is sent with the rest of the HTML content, you need to use `ResourceMap`, which maps the URI string to the actual data. You can learn more about this in [How to share HTML](https://msdn.microsoft.com/library/95a3d2a1-e188-4bd9-bace-d401d2d14ca2).
