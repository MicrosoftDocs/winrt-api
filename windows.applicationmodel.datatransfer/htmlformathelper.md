...
## -remarks
For more information on how to use this class, check out [DataPackage.SetHtmlFormat](datapackage_sethtmlformat.md). You might also want to look at our topic, [How to share HTML](http://msdn.microsoft.com/library/95a3d2a1-e188-4bd9-bace-d401d2d14ca2).
