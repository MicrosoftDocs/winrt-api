...
This method is often used when you use a delegate function to share data. For more information, see [How to support pull operations](https://msdn.microsoft.com/library/3f11f42f-d23b-4750-beab-bce05badbac8).
