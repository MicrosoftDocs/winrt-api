...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Composition.Effects.SceneLightingEffect.ReflectanceModel](/windows/winui/api/microsoft.ui.composition.effects.scenelightingeffect.reflectancemodel).
