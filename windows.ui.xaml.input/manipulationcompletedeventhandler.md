...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.ManipulationCompletedEventHandler](/windows/winui/api/microsoft.ui.xaml.input.manipulationcompletedeventhandler).
