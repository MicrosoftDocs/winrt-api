...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.HoldingRoutedEventArgs.Handled](/windows/winui/api/microsoft.ui.xaml.input.holdingroutedeventargs.handled).
