...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.ManipulationDeltaEventHandler](/windows/winui/api/microsoft.ui.xaml.input.manipulationdeltaeventhandler).
