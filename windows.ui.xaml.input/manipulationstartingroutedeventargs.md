...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.ManipulationStartingRoutedEventArgs](/windows/winui/api/microsoft.ui.xaml.input.manipulationstartingroutedeventargs).
