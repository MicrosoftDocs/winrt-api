...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.HoldingRoutedEventArgs.GetPosition](/windows/winui/api/microsoft.ui.xaml.input.holdingroutedeventargs.getposition).
