...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.GettingFocusEventArgs.FocusState](/windows/winui/api/microsoft.ui.xaml.input.gettingfocuseventargs.focusstate).
