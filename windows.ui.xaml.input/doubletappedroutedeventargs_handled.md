...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.DoubleTappedRoutedEventArgs.Handled](/windows/winui/api/microsoft.ui.xaml.input.doubletappedroutedeventargs.handled).
