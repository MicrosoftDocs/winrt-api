...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.LosingFocusEventArgs.InputDevice](/windows/winui/api/microsoft.ui.xaml.input.losingfocuseventargs.inputdevice).
