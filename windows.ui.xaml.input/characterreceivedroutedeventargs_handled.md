...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.CharacterReceivedRoutedEventArgs.Handled](/windows/winui/api/microsoft.ui.xaml.input.characterreceivedroutedeventargs.handled).
