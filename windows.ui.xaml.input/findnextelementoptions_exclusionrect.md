...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.FindNextElementOptions.ExclusionRect](/windows/winui/api/microsoft.ui.xaml.input.findnextelementoptions.exclusionrect).
