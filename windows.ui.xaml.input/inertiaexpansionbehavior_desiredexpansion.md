...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.InertiaExpansionBehavior.DesiredExpansion](/windows/winui/api/microsoft.ui.xaml.input.inertiaexpansionbehavior.desiredexpansion).
