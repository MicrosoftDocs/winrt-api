...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.PointerRoutedEventArgs.IsGenerated](/windows/winui/api/microsoft.ui.xaml.input.pointerroutedeventargs.isgenerated).
