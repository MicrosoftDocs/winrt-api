...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.StandardUICommand.KindProperty](/windows/winui/api/microsoft.ui.xaml.input.standarduicommand.kindproperty).
