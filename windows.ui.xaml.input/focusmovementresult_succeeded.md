...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.FocusMovementResult.Succeeded](/windows/winui/api/microsoft.ui.xaml.input.focusmovementresult.succeeded).
