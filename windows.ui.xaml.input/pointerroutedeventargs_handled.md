...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.PointerRoutedEventArgs.Handled](/windows/winui/api/microsoft.ui.xaml.input.pointerroutedeventargs.handled).
