...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.DoubleTappedRoutedEventArgs.PointerDeviceType](/windows/winui/api/microsoft.ui.xaml.input.doubletappedroutedeventargs.pointerdevicetype).
