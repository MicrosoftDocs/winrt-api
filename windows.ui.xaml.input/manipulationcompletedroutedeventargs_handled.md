---
-api-id: P:Windows.UI.Xaml.Input.ManipulationCompletedRoutedEventArgs.Handled
...
# Windows.UI.Xaml.Input.ManipulationCompletedRoutedEventArgs.Handled
...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.ManipulationCompletedRoutedEventArgs.Handled](/windows/winui/api/microsoft.ui.xaml.input.manipulationcompletedroutedeventargs.handled).
