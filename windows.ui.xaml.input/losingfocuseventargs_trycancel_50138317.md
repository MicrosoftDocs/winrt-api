...
## -remarks
Apps that target the Windows 10 Spring Creators Update (version 1803) or later should use this property instead of [Cancel](losingfocuseventargs_cancel.md). If your app also supports previous versions, see [Version adaptive apps: Use new APIs while maintaining compatibility with previous versions](https://docs.microsoft.com/windows/uwp/debug-test-perf/version-adaptive-apps) for more info.
