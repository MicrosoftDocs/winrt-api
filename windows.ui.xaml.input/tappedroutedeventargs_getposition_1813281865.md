...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.TappedRoutedEventArgs.GetPosition](/windows/winui/api/microsoft.ui.xaml.input.tappedroutedeventargs.getposition).
