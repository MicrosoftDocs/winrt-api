---
-api-id: P:Windows.UI.Xaml.Input.ManipulationDeltaRoutedEventArgs.Handled
...
# Windows.UI.Xaml.Input.ManipulationDeltaRoutedEventArgs.Handled
...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.ManipulationDeltaRoutedEventArgs.Handled](/windows/winui/api/microsoft.ui.xaml.input.manipulationdeltaroutedeventargs.handled).
