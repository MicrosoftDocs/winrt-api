...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.ProcessKeyboardAcceleratorEventArgs.Modifiers](/windows/winui/api/microsoft.ui.xaml.input.processkeyboardacceleratoreventargs.modifiers).
