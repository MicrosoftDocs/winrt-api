...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.AccessKeyDisplayRequestedEventArgs.PressedKeys](/windows/winui/api/microsoft.ui.xaml.input.accesskeydisplayrequestedeventargs.pressedkeys).
