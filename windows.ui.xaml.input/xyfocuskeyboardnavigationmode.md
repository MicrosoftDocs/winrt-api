...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.XYFocusKeyboardNavigationMode](/windows/winui/api/microsoft.ui.xaml.input.xyfocuskeyboardnavigationmode).
