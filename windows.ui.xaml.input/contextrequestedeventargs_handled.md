...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.ContextRequestedEventArgs.Handled](/windows/winui/api/microsoft.ui.xaml.input.contextrequestedeventargs.handled).
