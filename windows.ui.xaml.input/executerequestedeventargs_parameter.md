...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.ExecuteRequestedEventArgs.Parameter](/windows/winui/api/microsoft.ui.xaml.input.executerequestedeventargs.parameter).
