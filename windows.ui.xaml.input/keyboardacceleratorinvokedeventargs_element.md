...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.KeyboardAcceleratorInvokedEventArgs.Element](/windows/winui/api/microsoft.ui.xaml.input.keyboardacceleratorinvokedeventargs.element).
