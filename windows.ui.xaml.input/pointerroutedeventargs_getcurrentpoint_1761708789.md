...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.PointerRoutedEventArgs.GetCurrentPoint](/windows/winui/api/microsoft.ui.xaml.input.pointerroutedeventargs.getcurrentpoint).
