...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.RightTappedRoutedEventArgs.GetPosition](/windows/winui/api/microsoft.ui.xaml.input.righttappedroutedeventargs.getposition).
