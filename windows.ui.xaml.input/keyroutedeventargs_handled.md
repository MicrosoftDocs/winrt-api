...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.KeyRoutedEventArgs.Handled](/windows/winui/api/microsoft.ui.xaml.input.keyroutedeventargs.handled).
