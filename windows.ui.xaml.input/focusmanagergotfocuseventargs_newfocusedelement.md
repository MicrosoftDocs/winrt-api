...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.FocusManagerGotFocusEventArgs.NewFocusedElement](/windows/winui/api/microsoft.ui.xaml.input.focusmanagergotfocuseventargs.newfocusedelement).
