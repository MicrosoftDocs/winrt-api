...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.ManipulationDeltaRoutedEventArgs.Cumulative](/windows/winui/api/microsoft.ui.xaml.input.manipulationdeltaroutedeventargs.cumulative).
