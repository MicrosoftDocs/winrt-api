...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.ManipulationStartedRoutedEventArgs.Position](/windows/winui/api/microsoft.ui.xaml.input.manipulationstartedroutedeventargs.position).
