...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.KeyboardAcceleratorInvokedEventArgs.Handled](/windows/winui/api/microsoft.ui.xaml.input.keyboardacceleratorinvokedeventargs.handled).
