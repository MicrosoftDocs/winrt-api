...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.RightTappedRoutedEventArgs.Handled](/windows/winui/api/microsoft.ui.xaml.input.righttappedroutedeventargs.handled).
