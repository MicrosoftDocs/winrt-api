...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.NoFocusCandidateFoundEventArgs.Direction](/windows/winui/api/microsoft.ui.xaml.input.nofocuscandidatefoundeventargs.direction).
