...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.ContextRequestedEventArgs.TryGetPosition](/windows/winui/api/microsoft.ui.xaml.input.contextrequestedeventargs.trygetposition).
