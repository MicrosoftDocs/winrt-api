...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.FocusManagerLostFocusEventArgs](/windows/winui/api/microsoft.ui.xaml.input.focusmanagerlostfocuseventargs).
