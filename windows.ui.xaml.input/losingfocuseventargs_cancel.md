...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.LosingFocusEventArgs.Cancel](/windows/winui/api/microsoft.ui.xaml.input.losingfocuseventargs.cancel).
