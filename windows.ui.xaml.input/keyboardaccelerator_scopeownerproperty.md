...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.KeyboardAccelerator.ScopeOwnerProperty](/windows/winui/api/microsoft.ui.xaml.input.keyboardaccelerator.scopeownerproperty).
