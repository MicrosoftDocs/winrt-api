...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.GettingFocusEventArgs.Direction](/windows/winui/api/microsoft.ui.xaml.input.gettingfocuseventargs.direction).
