---
-api-id: M:Windows.UI.Xaml.Input.DoubleTappedRoutedEventArgs.GetPosition(Windows.UI.Xaml.UIElement)
...
# Windows.UI.Xaml.Input.DoubleTappedRoutedEventArgs.GetPosition
...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.DoubleTappedRoutedEventArgs.GetPosition](/windows/winui/api/microsoft.ui.xaml.input.doubletappedroutedeventargs.getposition) (for WinUI in the [Windows App SDK](/windows/apps/windows-app-sdk/), see the **[Windows App SDK namespaces](/windows/windows-app-sdk/api/winrt/)**).
