...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.DoubleTappedRoutedEventArgs.GetPosition](/windows/winui/api/microsoft.ui.xaml.input.doubletappedroutedeventargs.getposition).
