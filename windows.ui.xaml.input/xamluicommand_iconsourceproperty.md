...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.XamlUICommand.IconSourceProperty](/windows/winui/api/microsoft.ui.xaml.input.xamluicommand.iconsourceproperty).
