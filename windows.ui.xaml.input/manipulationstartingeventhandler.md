...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Input.ManipulationStartingEventHandler](/windows/winui/api/microsoft.ui.xaml.input.manipulationstartingeventhandler).
