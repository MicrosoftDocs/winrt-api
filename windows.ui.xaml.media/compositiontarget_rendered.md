...
## -remarks
The Visual Studio [Application Timeline](https://docs.microsoft.com/visualstudio/profiling/application-timeline) profiler should be used when developing and testing your application since it gives more detailed information on your application's resource consumption including time spent preparing UI frames.
...
If you do see long frame durations then consider profiling your application using the Visual Studio Application Timeline and implementing the recommended [Performance best practices for Windows Store apps](https://docs.microsoft.com/windows/uwp/debug-test-perf/performance-and-xaml-ui).
...
## -see-also
Visual Studio [Application Timeline](https://docs.microsoft.com/visualstudio/profiling/application-timeline), [Performance best practices for Windows Store apps](https://docs.microsoft.com/windows/uwp/debug-test-perf/performance-and-xaml-ui)
