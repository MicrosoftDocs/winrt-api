...
## -examples
This XAML example shows how to set the [Foreground](../windows.ui.xaml.controls/textblock_foreground.md) property of a [TextBlock](../windows.ui.xaml.controls/textblock.md) to an [ImageBrush](imagebrush.md), whose image is used as the fill for the [TextBlock](../windows.ui.xaml.controls/textblock.md)-rendered text.
...
## -see-also
[TileBrush](tilebrush.md), [Image](../windows.ui.xaml.controls/image.md), [Image and ImageBrush](http://msdn.microsoft.com/library/cea8780c-71a3-4168-a6e8-6361cdfb2faf), [XAML vector-based drawing sample (see Scenario 2)](http://go.microsoft.com/fwlink/p/?linkid=226866)
