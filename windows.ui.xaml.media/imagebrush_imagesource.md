...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Media.ImageBrush.ImageSource](/windows/winui/api/microsoft.ui.xaml.media.imagebrush.imagesource) (for WinUI in the [Windows App SDK](/windows/apps/windows-app-sdk/), see the **[Windows App SDK namespaces](/windows/windows-app-sdk/api/winrt/)**).
