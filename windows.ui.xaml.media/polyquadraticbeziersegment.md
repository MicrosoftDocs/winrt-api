...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Media.PolyQuadraticBezierSegment](/windows/winui/api/microsoft.ui.xaml.media.polyquadraticbeziersegment).
