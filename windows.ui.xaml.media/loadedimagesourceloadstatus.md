...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Media.LoadedImageSourceLoadStatus](/windows/winui/api/microsoft.ui.xaml.media.loadedimagesourceloadstatus).
