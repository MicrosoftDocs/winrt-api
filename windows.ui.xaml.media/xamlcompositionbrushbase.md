...
- [Using XAML brushes](https://docs.microsoft.com/windows/uwp/graphics/using-brushes)
...
- [Composition brushes](https://docs.microsoft.com/windows/uwp/composition/composition-brushes)