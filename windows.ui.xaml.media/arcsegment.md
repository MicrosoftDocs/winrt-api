...
Rather than creating an instance or an object element, you can also define an [ArcSegment](arcsegment.md) as part of a vector within the string for a [Move and draw commands syntax](http://msdn.microsoft.com/library/7772bc3e-a631-46ff-9940-3dd5b9d0e0d9).
