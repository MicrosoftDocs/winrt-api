...
However, if you must render a frame with an alternate view transform, be sure to call this method and provide that transform.  Visual quality will be even worse if the compositor does not know the the actual transforms used for rendering.
