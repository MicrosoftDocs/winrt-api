...
The map's camera settings are updated whenever the view of the map is changed. For example, when updating the [Center](mapcontrol_center.md) property or calling the [TrySetSceneAsync](mapcontrol_trysetsceneasync.md) method.
