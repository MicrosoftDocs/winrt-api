---
-api-id: P:Windows.UI.Xaml.Controls.Maps.MapIcon.Location
...
# Windows.UI.Xaml.Controls.Maps.MapIcon.Location
...
## -property-value
The geographic location of the [MapIcon](mapicon.md) on the [MapControl](mapcontrol.md).
