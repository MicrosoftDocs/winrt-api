...
## -remarks
> [!TIP]
> Use the [CreateFromCamera](mapscene_createfromcamera.md) method to create a scene by specifying the position of the map's camera. The location specified in this method by the *bounds* parameter is the location that will appear in the scene, it's not the location of the map's camera.
