...
## -description
Gets or sets the image for the [MapBillboard](mapbillboard.md). Provide an optional custom image to replace the default image.

## -property-value
The image for the [MapBillboard](mapbillboard.md).
