---
-api-id: M:Windows.UI.Xaml.Controls.Maps.MapScene.CreateFromLocationAndRadius(Windows.Devices.Geolocation.Geopoint,System.Double,System.Double,System.Double)
-api-type: winrt method
---

<!-- Method syntax
public Windows.UI.Xaml.Controls.Maps.MapScene CreateFromLocationAndRadius(Windows.Devices.Geolocation.Geopoint location, System.Double radiusInMeters, System.Double headingInDegrees, System.Double pitchInDegrees)
-->
...
## -remarks
> [!TIP]
> Use the [CreateFromCamera](mapscene_createfromcamera_432380015.md) method to create a scene by specifying the position of the map's camera. The location specified in this method by the *location* parameter is the location that will appear in the scene, it's not the location of the map's camera.
...
## -see-also
[CreateFromLocationAndRadius(Geopoint, Double)](mapscene_createfromlocationandradius_299761416.md)