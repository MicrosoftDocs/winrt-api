...
## -examples
The following example sets the [StyleSheet](mapcontrol_stylesheet.md) property by using the static [MapControl.RoadDark](mapstylesheet_roaddark_376470101.md) method.
