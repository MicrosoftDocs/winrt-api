...
You can see code examples that demonstrate how to respond to search events and manage the search pane in the [Search contract sample](http://code.msdn.microsoft.com/windowsapps/Search-app-contract-sample-118a92f5).
