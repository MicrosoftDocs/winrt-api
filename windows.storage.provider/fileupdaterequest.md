...
## -examples
The [File picker contracts sample](https://go.microsoft.com/fwlink/p/?linkid=231536) demonstrates how to respond to a [FileUpdateRequested](cachedfileupdaterui_fileupdaterequested.md) event, including how to use [Request](fileupdaterequestedeventargs_request.md) to get the [FileUpdateRequest](fileupdaterequest.md).
