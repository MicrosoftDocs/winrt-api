...
To update any property on [StorageProviderKnownFolderSyncInfo](storageproviderknownfoldersyncinfo.md), the cloud files provider should raise the **KnownFolderSyncInfoChanged** event and be ready to provide a new **StorageProviderKnownFolderSyncInfo** object.
