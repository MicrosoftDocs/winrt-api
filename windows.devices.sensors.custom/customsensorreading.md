...
Each key is a string that represents a [PROPERTYKEY](https://msdn.microsoft.com/library/3f5f31af-f040-443b-9045-9761055381ea). Each value can be an integer, Boolean, float, or double.
