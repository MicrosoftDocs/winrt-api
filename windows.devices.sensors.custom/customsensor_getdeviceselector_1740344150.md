...
## -parameters
### -param interfaceId
The interface [Guid](/dotnet/api/system.guid?redirectedfrom=MSDN) that is associated with the custom sensor. This [Guid](/dotnet/api/system.guid?redirectedfrom=MSDN) is defined and registered by the sensor.
