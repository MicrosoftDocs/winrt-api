...
## -remarks
In apps compiled for Windows 8, the [WebView](webview.md) control automatically gets input focus whenever you use script to programmatically set the focus to some content in the [WebView](webview.md). In apps compiled for Windows 8.1, this does not occur automatically. Instead, you must call the [Focus](webview_focus.md) method to set the focus to the [WebView](webview.md) control and also use script to set the focus to some content in the control.
