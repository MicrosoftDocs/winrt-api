...
If your datasource performs data virtualization, you can use the [SelectedRanges](listviewbase_selectedranges.md) property with the [SelectRange](listviewbase_selectrange_1824826911.md) and [DeselectRange](listviewbase_deselectrange_1629963900.md) methods to modify selection of items that have not been created yet.
