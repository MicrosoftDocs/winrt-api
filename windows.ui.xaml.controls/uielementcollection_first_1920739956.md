...
## -remarks
A convenient way to hold the iterator returned by [First](uielementcollection_first_1920739956.md) is to assign the return value to a variable that is declared with the **auto** type deduction keyword. Then use [IIterator](../windows.foundation.collections/iiterator_1.md)  API as part of a **while** loop. For example:
