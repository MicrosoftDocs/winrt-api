...
## -examples
The following code example shows how to use this method with a resolver that will serve a file from the app package. For a complete example, see the [XAML WebView control sample](http://go.microsoft.com/fwlink/p/?linkid=238582).
