---
-api-id: P:Windows.UI.Xaml.Controls.AppBarSeparator.IsInOverflow
...
# Windows.UI.Xaml.Controls.AppBarSeparator.IsInOverflow

## -description
Gets a value that indicates whether this item is in the overflow menu.

Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.AppBarSeparator.IsInOverflow](/windows/winui/api/microsoft.ui.xaml.controls.appbarseparator.isinoverflow) (for WinUI in the [Windows App SDK](/windows/apps/windows-app-sdk/), see the **[Windows App SDK namespaces](/windows/windows-app-sdk/api/winrt/)**).
