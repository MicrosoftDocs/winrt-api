...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.Grid.BorderThicknessProperty](/windows/winui/api/microsoft.ui.xaml.controls.grid.borderthicknessproperty).
