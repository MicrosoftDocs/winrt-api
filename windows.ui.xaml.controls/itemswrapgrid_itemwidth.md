...
## -property-value
The width of the layout area for each item that is contained in an [ItemsWrapGrid](itemswrapgrid.md). The default is [Double.NaN](https://msdn.microsoft.com/library/system.double.nan.aspx), which results in the "Auto" layout behavior.
