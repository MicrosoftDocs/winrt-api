---
-api-id: P:Windows.UI.Xaml.Controls.AppBarButton.DynamicOverflowOrder
...
# Windows.UI.Xaml.Controls.AppBarButton.DynamicOverflowOrder
...
## -remarks
For more info and guidelines, see the [App bar and command bar](https://msdn.microsoft.com/windows/uwp/controls-and-patterns/app-bars) article.
...
You can assign the same [DynamicOverflowOrder](appbarbutton_dynamicoverfloworder.md) value to more than one element. Elements with the same value move in and out of the overflow area at the same time.

### Version compatibility

The [DynamicOverflowOrder](appbarbutton_dynamicoverfloworder.md) property is not available prior to Windows 10, version 1607. If your app’s 'minimum platform version' setting in Microsoft Visual Studio is less than the 'introduced version' shown in the Requirements block later in this page, you must design and test your app to account for this. For more info, see [Version adaptive code](https://msdn.microsoft.com/windows/uwp/debug-test-perf/version-adaptive-code).
