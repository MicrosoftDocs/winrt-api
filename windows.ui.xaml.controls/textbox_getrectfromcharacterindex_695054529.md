...
## -examples
This example shows how to use [GetRectFromCharacterIndex](textbox_getrectfromcharacterindex_695054529.md) to determine the rectangle for the selected text. For the complete example, see Scenario 2 of the [ContextMenu sample](http://go.microsoft.com/fwlink/p/?linkid=234891).
