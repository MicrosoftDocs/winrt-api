---
-api-id: P:Windows.UI.Xaml.Controls.PasswordBox.TextReadingOrder
...
# Windows.UI.Xaml.Controls.PasswordBox.TextReadingOrder

## -description
Gets or sets a value that indicates how the reading order is determined for the [PasswordBox](passwordbox.md).

Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.PasswordBox.TextReadingOrder](/windows/winui/api/microsoft.ui.xaml.controls.passwordbox.textreadingorder) (for WinUI in the [Windows App SDK](/windows/apps/windows-app-sdk/), see the **[Windows App SDK namespaces](/windows/windows-app-sdk/api/winrt/)**).
