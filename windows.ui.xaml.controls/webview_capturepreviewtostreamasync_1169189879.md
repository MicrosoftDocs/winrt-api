...
## -examples
This example shows how to use this method to create a thumbnail image of the current content. For the complete example, see the [WebView control sample](http://code.msdn.microsoft.com/windowsapps/XAML-WebView-control-sample-58ad63f7).
...
## -see-also
[XAML WebView control sample](http://code.msdn.microsoft.com/windowsapps/XAML-WebView-control-sample-58ad63f7), [WebView control (XAML) sample (Windows 10)](https://go.microsoft.com/fwlink/p/?LinkId=722922)
