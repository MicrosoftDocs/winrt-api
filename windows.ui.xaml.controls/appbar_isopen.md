...
> **Windows 8**
> Binding to the [IsOpen](appbar_isopen.md) property doesn't have the expected results because the [PropertyChanged](../windows.ui.xaml.data/inotifypropertychanged.md) notification doesn't occur when the property is set.
