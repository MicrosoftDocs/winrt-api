---
-api-id: T:Windows.UI.Xaml.Controls.SelectionMode
-api-type: winrt enum
---
...
Equivalent **WinUI 2 API for UWP**: [SelectionMode](/windows/winui/api/microsoft.ui.xaml.controls.selectionmode) (for WinUI in the [Windows App SDK](/windows/apps/windows-app-sdk/), see the **[Windows App SDK namespaces](/windows/windows-app-sdk/api/winrt/)**).
