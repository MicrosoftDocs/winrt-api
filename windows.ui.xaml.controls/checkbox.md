...
Equivalent WinUI class: [Microsoft.UI.Xaml.Controls.CheckBox](/windows/winui/api/microsoft.ui.xaml.controls.checkbox).
...
## -see-also
[Check boxes overview](/windows/uwp/controls-and-patterns/checkbox), [CheckBox styles and templates](/windows/uwp/design/controls-and-patterns/xaml-styles), [RadioButton](radiobutton.md), [ToggleButton](../windows.ui.xaml.controls.primitives/togglebutton.md), [Controls list](/windows/uwp/design/controls-and-patterns/), [Controls by function](/windows/uwp/controls-and-patterns/controls-by-function)
