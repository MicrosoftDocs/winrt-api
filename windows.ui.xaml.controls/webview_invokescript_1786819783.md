...
## -description
> [!NOTE]
> [InvokeScript](webview_invokescript.md) may be altered or unavailable for releases after Windows 8.1. Instead, use [InvokeScriptAsync](webview_invokescriptasync.md).
