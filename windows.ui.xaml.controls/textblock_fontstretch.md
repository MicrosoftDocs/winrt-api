---
-api-id: P:Windows.UI.Xaml.Controls.TextBlock.FontStretch
...
# Windows.UI.Xaml.Controls.TextBlock.FontStretch

## -description
Gets or sets the font stretch for the text content in this element.

Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.TextBlock.FontStretch](/windows/winui/api/microsoft.ui.xaml.controls.textblock.fontstretch) (for WinUI in the [Windows App SDK](/windows/apps/windows-app-sdk/), see the **[Windows App SDK namespaces](/windows/windows-app-sdk/api/winrt/)**).
