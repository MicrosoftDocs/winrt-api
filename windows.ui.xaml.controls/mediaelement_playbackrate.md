...
## -remarks
The current [PlaybackRate](mediaelement_playbackrate.md) is set to the value of [DefaultPlaybackRate](mediaelement_defaultplaybackrate.md) whenever [Play](mediaelement_play_848564459.md) is called. So setting [DefaultPlaybackRate](mediaelement_defaultplaybackrate.md) to a different value has no effect until [Play](mediaelement_play_848564459.md) is called.
