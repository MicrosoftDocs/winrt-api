...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.Control.OnKeyDown](/windows/winui/api/microsoft.ui.xaml.controls.control.onkeydown) (for WinUI in the [Windows App SDK](/windows/apps/windows-app-sdk/), see the **[Windows App SDK namespaces](/windows/windows-app-sdk/api/winrt/)**).
...
## -see-also
[UIElement.KeyDown](../windows.ui.xaml/uielement_keydown.md), [KeyRoutedEventArgs](../windows.ui.xaml.input/keyroutedeventargs.md), [Keyboard interactions](/windows/uwp/input-and-devices/keyboard-interactions), [Events and routed events overview](/windows/uwp/xaml-platform/events-and-routed-events-overview)
