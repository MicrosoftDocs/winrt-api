...
When the Image element isn’t in the live visual tree, the Image element will not fire [ImageOpened](image_imageopened.md) or [ImageFailed](image_imagefailed.md) events.  If you need to receive these events while the element isn’t in the live tree, use the BitmapImage.[ImageOpened](../windows.ui.xaml.media.imaging/bitmapimage_imageopened.md)/[ImageFailed](../windows.ui.xaml.media.imaging/bitmapimage_imagefailed.md) events.
...
## -see-also
[ImageFailed](image_imagefailed.md), [Image and ImageBrush](https://msdn.microsoft.com/library/cea8780c-71a3-4168-a6e8-6361cdfb2faf)
