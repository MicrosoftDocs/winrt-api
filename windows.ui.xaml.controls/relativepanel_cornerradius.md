---
-api-id: P:Windows.UI.Xaml.Controls.RelativePanel.CornerRadius
...
# Windows.UI.Xaml.Controls.RelativePanel.CornerRadius

## -description
Gets or sets the radius for the corners of the panel's border.

Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.RelativePanel.CornerRadius](/windows/winui/api/microsoft.ui.xaml.controls.relativepanel.cornerradius) (for WinUI in the [Windows App SDK](/windows/apps/windows-app-sdk/), see the **[Windows App SDK namespaces](/windows/windows-app-sdk/api/winrt/)**).
