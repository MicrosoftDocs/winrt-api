...
## -see-also
[FrameworkElement](../windows.ui.xaml/frameworkelement.md), [MediaCapture](../windows.media.capture/mediacapture.md), [Capture photos and video with MediaCapture](https://docs.microsoft.com/windows/uwp/audio-video-camera/capture-photos-and-video-with-mediacapture), [Media capture sample](http://code.msdn.microsoft.com/windowsapps/media-capture-sample-adf87622), [Camera capture UI sample](https://go.microsoft.com/fwlink/p/?linkid=249441), [Call asynchronous APIs in C# or Visual Basic](https://docs.microsoft.com/windows/uwp/threading-async/call-asynchronous-apis-in-csharp-or-visual-basic)
