...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.AnchorRequestedEventArgs](/windows/winui/api/microsoft.ui.xaml.controls.anchorrequestedeventargs).
