...
This property is more typically set in a [Style](../windows.ui.xaml/style.md) setter rather than inline on an object element in UI definition. For more info, see [Styling controls](https://msdn.microsoft.com/library/ab469a46-faf5-42d0-9340-948d0edf4150).
