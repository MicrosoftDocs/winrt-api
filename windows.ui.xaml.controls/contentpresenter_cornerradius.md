---
-api-id: P:Windows.UI.Xaml.Controls.ContentPresenter.CornerRadius
...
# Windows.UI.Xaml.Controls.ContentPresenter.CornerRadius

## -description
Gets or sets the radius for the corners of the content presenter's border.

Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.ContentPresenter.CornerRadius](/windows/winui/api/microsoft.ui.xaml.controls.contentpresenter.cornerradius) (for WinUI in the [Windows App SDK](/windows/apps/windows-app-sdk/), see the **[Windows App SDK namespaces](/windows/windows-app-sdk/api/winrt/)**).
