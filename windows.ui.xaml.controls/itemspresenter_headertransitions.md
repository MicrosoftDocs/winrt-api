---
-api-id: P:Windows.UI.Xaml.Controls.ItemsPresenter.HeaderTransitions
...
# Windows.UI.Xaml.Controls.ItemsPresenter.HeaderTransitions
...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.ItemsPresenter.HeaderTransitions](/windows/winui/api/microsoft.ui.xaml.controls.itemspresenter.headertransitions) (for WinUI in the [Windows App SDK](/windows/apps/windows-app-sdk/), see the **[Windows App SDK namespaces](/windows/windows-app-sdk/api/winrt/)**).
...
## -property-value
The collection of [Transition](../windows.ui.xaml.media.animation/transition.md) style elements that apply to the header of an [ItemsPresenter](itemspresenter.md).
