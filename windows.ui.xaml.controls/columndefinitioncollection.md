...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.ColumnDefinitionCollection](/windows/winui/api/microsoft.ui.xaml.controls.columndefinitioncollection).
