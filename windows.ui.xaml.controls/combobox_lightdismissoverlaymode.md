---
-api-id: P:Windows.UI.Xaml.Controls.ComboBox.LightDismissOverlayMode
...
# Windows.UI.Xaml.Controls.ComboBox.LightDismissOverlayMode

## -description
Gets or sets a value that specifies whether the area outside of a *light-dismiss* UI is darkened.

Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.ComboBox.LightDismissOverlayMode](/windows/winui/api/microsoft.ui.xaml.controls.combobox.lightdismissoverlaymode) (for WinUI in the [Windows App SDK](/windows/apps/windows-app-sdk/), see the **[Windows App SDK namespaces](/windows/windows-app-sdk/api/winrt/)**).
