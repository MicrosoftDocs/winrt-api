...
The effects of this property are influenced by the value of the [DisplayMode](splitview_displaymode.md) property. <table>
   ...
   <tr><td>**Inline**</td><td>[IsPaneOpen](splitview_ispaneopen.md) is **true**.</td></tr>
   <tr><td>**Overlay**</td><td>When [IsPaneOpen](splitview_ispaneopen.md) is **false**, the pane is hidden.</td></tr>
   <tr><td>**Compact**</td><td>When [IsPaneOpen](splitview_ispaneopen.md) is **false**, the pane is shown in its compact size (see [CompactPaneLength](splitview_compactpanelength.md)).</td></tr>
</table>
