...
Another possible technique is to define a date that's available as a data object or in the data context, then set [MaxYear](datepicker_maxyear.md) as a XAML attribute that references a [{Binding} markup extension](https://msdn.microsoft.com/library/3bafe7b5-af33-487f-9ad5-beafd65d04c3) that can access the date as data.
