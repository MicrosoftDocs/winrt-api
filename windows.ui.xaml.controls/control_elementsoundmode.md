...
For more info about using this property, see [Sound in UWP apps](https://docs.microsoft.com/windows/uwp/style/sound).
...
## -see-also
[ElementSoundPlayer](../windows.ui.xaml/elementsoundplayer.md), [Sound in UWP apps](https://docs.microsoft.com/windows/uwp/style/sound)
