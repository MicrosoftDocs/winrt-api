...
## -remarks
[InsertAt](rowdefinitioncollection_insertat_1515930834.md) expands the collection and moves all subsequent index items by one. In contrast, [SetAt](rowdefinitioncollection_setat_721691810.md) replaces the item at the index, and the collection count remains the same.
