---
-api-id: T:Windows.UI.Xaml.Controls.MenuFlyoutSeparator
...
>
> If you have the **WinUI 2 Gallery** app installed, click here to [open the app and see the MenuFlyoutSeparator in action](winui2gallery:/item/MenuFlyout).
