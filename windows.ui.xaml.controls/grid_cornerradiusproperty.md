...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.Grid.CornerRadiusProperty](/windows/winui/api/microsoft.ui.xaml.controls.grid.cornerradiusproperty).
