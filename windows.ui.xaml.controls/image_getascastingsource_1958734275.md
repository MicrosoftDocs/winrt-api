...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.Image.GetAsCastingSource](/windows/winui/api/microsoft.ui.xaml.controls.image.getascastingsource).
