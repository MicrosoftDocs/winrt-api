...
Always use the [IsFullWindow](mediaplayerelement_isfullwindow.md) property to enable and disable full window rendering. This ensures system level optimizations are used during media playback.
