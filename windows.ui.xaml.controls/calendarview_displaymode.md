---
-api-id: P:Windows.UI.Xaml.Controls.CalendarView.DisplayMode
...
# Windows.UI.Xaml.Controls.CalendarView.DisplayMode

## -description
Gets or sets a value that indicates whether the calendar shows a picker for month, year, or decade.

Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.CalendarView.DisplayMode](/windows/winui/api/microsoft.ui.xaml.controls.calendarview.displaymode).
