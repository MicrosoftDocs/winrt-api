...
1. When the [SearchBox](searchbox.md) loses focus, set [FocusOnKeyboardInput](searchbox_focusonkeyboardinput.md) back to **true**. To do this, register for the [LostFocus](control_onlostfocus_679101471.md) event and use the event handler to set [FocusOnKeyboardInput](searchbox_focusonkeyboardinput.md) back to **true**.
