...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.FlyoutPresenter](/windows/winui/api/microsoft.ui.xaml.controls.flyoutpresenter) (for WinUI in the [Windows App SDK](/windows/apps/windows-app-sdk/), see the **[Windows App SDK namespaces](/windows/windows-app-sdk/api/winrt/)**).
...
## -see-also
[ContentControl](contentcontrol.md), [Flyout](flyout.md), [FlyoutPresenter styles and templates](/windows/uwp/design/controls-and-patterns/xaml-styles)
