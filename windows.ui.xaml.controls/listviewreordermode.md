---
-api-id: T:Windows.UI.Xaml.Controls.ListViewReorderMode
-api-type: winrt enum
---
...
Equivalent **WinUI 2 API for UWP**: [ListViewReorderMode](/windows/winui/api/microsoft.ui.xaml.controls.listviewreordermode).
