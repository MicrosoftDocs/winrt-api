---
-api-id: P:Windows.UI.Xaml.Controls.ContentPresenter.Padding
...
# Windows.UI.Xaml.Controls.ContentPresenter.Padding

## -description
Gets or sets the distance between the border and its child object.

Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.ContentPresenter.Padding](/windows/winui/api/microsoft.ui.xaml.controls.contentpresenter.padding) (for WinUI in the [Windows App SDK](/windows/apps/windows-app-sdk/), see the **[Windows App SDK namespaces](/windows/windows-app-sdk/api/winrt/)**).
