...
## -description
Gets or sets a value that marks the routed event as handled. A **true** value for [Handled](textcontrolpasteeventargs_handled.md) prevents most handlers along the event route from handling the same event again.
