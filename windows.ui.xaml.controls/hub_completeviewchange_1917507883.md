---
-api-id: M:Windows.UI.Xaml.Controls.Hub.CompleteViewChange
...
# Windows.UI.Xaml.Controls.Hub.CompleteViewChange

## -description
Changes related aspects of presentation when the overall view for a [SemanticZoom](isemanticzoominformation.md) changes.

Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.Hub.CompleteViewChange](/windows/winui/api/microsoft.ui.xaml.controls.hub.completeviewchange) (for WinUI in the [Windows App SDK](/windows/apps/windows-app-sdk/), see the **[Windows App SDK namespaces](/windows/windows-app-sdk/api/winrt/)**).
