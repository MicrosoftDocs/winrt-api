---
-api-id: P:Windows.UI.Xaml.Controls.TextCompositionEndedEventArgs.StartIndex
...
# Windows.UI.Xaml.Controls.TextCompositionEndedEventArgs.StartIndex

## -description
Gets the starting location of the text that the user is composing with an Input Method Editor (IME).

Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.TextCompositionEndedEventArgs.StartIndex](/windows/winui/api/microsoft.ui.xaml.controls.textcompositionendedeventargs.startindex).
