...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.DatePickerSelectedValueChangedEventArgs](/windows/winui/api/microsoft.ui.xaml.controls.datepickerselectedvaluechangedeventargs).
