...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.RowDefinitionCollection](/windows/winui/api/microsoft.ui.xaml.controls.rowdefinitioncollection).
