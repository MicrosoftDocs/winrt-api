---
-api-id: P:Windows.UI.Xaml.Controls.Control.BackgroundSizing
...
# Windows.UI.Xaml.Controls.Control.BackgroundSizing

## -description

Gets or sets a value that indicates how far the background extends in relation to this element's border.

Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.Control.BackgroundSizing](/windows/winui/api/microsoft.ui.xaml.controls.control.backgroundsizing) (for WinUI in the [Windows App SDK](/windows/apps/windows-app-sdk/), see the **[Windows App SDK namespaces](/windows/windows-app-sdk/api/winrt/)**).
