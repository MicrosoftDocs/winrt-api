...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.PasswordBoxPasswordChangingEventArgs](/windows/winui/api/microsoft.ui.xaml.controls.passwordboxpasswordchangingeventargs).
