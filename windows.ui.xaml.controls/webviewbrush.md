...
## -see-also
[TileBrush](../windows.ui.xaml.media/tilebrush.md), [Brush](../windows.ui.xaml.media/brush.md), [WebView](webview.md), [Use brushes](https://docs.microsoft.com/windows/uwp/graphics/using-brushes), [XAML WebView control sample](http://code.msdn.microsoft.com/windowsapps/XAML-WebView-control-sample-58ad63f7)
