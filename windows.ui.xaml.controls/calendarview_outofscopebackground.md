---
-api-id: P:Windows.UI.Xaml.Controls.CalendarView.OutOfScopeBackground
...
# Windows.UI.Xaml.Controls.CalendarView.OutOfScopeBackground

## -description
Gets or sets a brush that provides the background of a date that's out of scope.

Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.CalendarView.OutOfScopeBackground](/windows/winui/api/microsoft.ui.xaml.controls.calendarview.outofscopebackground).
