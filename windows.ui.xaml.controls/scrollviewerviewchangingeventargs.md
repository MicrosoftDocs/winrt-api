...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.ScrollViewerViewChangingEventArgs](/windows/winui/api/microsoft.ui.xaml.controls.scrollviewerviewchangingeventargs).
