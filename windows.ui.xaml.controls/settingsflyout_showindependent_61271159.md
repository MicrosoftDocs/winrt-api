...
For more code in context, see Scenario 4 of the [App settings sample](http://code.msdn.microsoft.com/windowsapps/App-settings-sample-1f762f49) and [Quickstart: Add app help](https://docs.microsoft.com/previous-versions/windows/apps/jj649425(v=win.10)).
