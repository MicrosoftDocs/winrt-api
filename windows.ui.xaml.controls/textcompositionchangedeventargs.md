...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.TextCompositionChangedEventArgs](/windows/winui/api/microsoft.ui.xaml.controls.textcompositionchangedeventargs).
