...
For info about the media formats that MediaPlayerElement supports, see [Supported codecs](https://msdn.microsoft.com/library/9347ad7c-3a90-4073-bff4-9e8237398343).
...
For more information about the [MediaPlayer](../windows.media.playback/mediaplayer.md) class, including guidelines on how to transition from [MediaElement](mediaelement.md) to MediaPlayerElement, see the [Media playback](https://msdn.microsoft.com/windows/uwp/audio-video-camera/media-playback) page.
