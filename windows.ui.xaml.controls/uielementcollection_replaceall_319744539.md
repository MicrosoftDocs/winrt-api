...
If you are programming using C# or Microsoft Visual Basic, there is no single-call equivalent to [ReplaceAll](uielementcollection_replaceall_319744539.md). Use [Clear](uielementcollection_clear_556466.md) and then successive calls to [Add](uielementcollection_add.md).
