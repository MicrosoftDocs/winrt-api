...
Replace the default panel used in a ListView with an [ItemsStackPanel](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.ItemsStackPanel) that has its Orientation changed set to Horizontal.
