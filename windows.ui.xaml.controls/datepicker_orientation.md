...
## -remarks
By default, the [DatePicker](datepicker.md) shows the month, day, and year pickers in a horizontal row. You can change them to a vertical stack by setting the [Orientation](datepicker_orientation.md) property to [Vertical](orientation.md).
