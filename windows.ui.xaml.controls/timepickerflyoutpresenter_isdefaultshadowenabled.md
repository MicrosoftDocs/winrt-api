---
-api-id: P:Windows.UI.Xaml.Controls.TimePickerFlyoutPresenter.IsDefaultShadowEnabled
...
# Windows.UI.Xaml.Controls.TimePickerFlyoutPresenter.IsDefaultShadowEnabled

## -description

Gets or sets a value that indicates whether the default shadow effect is shown.

Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.TimePickerFlyoutPresenter.IsDefaultShadowEnabled](/windows/winui/api/microsoft.ui.xaml.controls.timepickerflyoutpresenter.isdefaultshadowenabled) (for WinUI in the [Windows App SDK](/windows/apps/windows-app-sdk/), see the **[Windows App SDK namespaces](/windows/windows-app-sdk/api/winrt/)**).
