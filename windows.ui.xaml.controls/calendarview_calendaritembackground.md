---
-api-id: P:Windows.UI.Xaml.Controls.CalendarView.CalendarItemBackground
...
# Windows.UI.Xaml.Controls.CalendarView.CalendarItemBackground

## -description
Gets or sets a brush that provides the background of a calendar item.

Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.CalendarView.CalendarItemBackground](/windows/winui/api/microsoft.ui.xaml.controls.calendarview.calendaritembackground) (for WinUI in the [Windows App SDK](/windows/apps/windows-app-sdk/), see the **[Windows App SDK namespaces](/windows/windows-app-sdk/api/winrt/)**).
