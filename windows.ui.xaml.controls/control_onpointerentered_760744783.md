---
-api-id: M:Windows.UI.Xaml.Controls.Control.OnPointerEntered(Windows.UI.Xaml.Input.PointerRoutedEventArgs)
...
# Windows.UI.Xaml.Controls.Control.OnPointerEntered

## -description
Called before the [PointerEntered](../windows.ui.xaml/uielement_pointerentered.md) event occurs.

Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.Control.OnPointerEntered](/windows/winui/api/microsoft.ui.xaml.controls.control.onpointerentered) (for WinUI in the [Windows App SDK](/windows/apps/windows-app-sdk/), see the **[Windows App SDK namespaces](/windows/windows-app-sdk/api/winrt/)**).
