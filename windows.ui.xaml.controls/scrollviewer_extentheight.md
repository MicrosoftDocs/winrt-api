---
-api-id: P:Windows.UI.Xaml.Controls.ScrollViewer.ExtentHeight
...
# Windows.UI.Xaml.Controls.ScrollViewer.ExtentHeight

## -description
Gets the vertical size of all the scrollable content in the [ScrollViewer](scrollviewer.md).

Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.ScrollViewer.ExtentHeight](/windows/winui/api/microsoft.ui.xaml.controls.scrollviewer.extentheight) (for WinUI in the [Windows App SDK](/windows/apps/windows-app-sdk/), see the **[Windows App SDK namespaces](/windows/windows-app-sdk/api/winrt/)**).
