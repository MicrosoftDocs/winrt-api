...
## -description
> [!NOTE]
> [IndexFromContainer](itemcontainergenerator_indexfromcontainer.md) may be altered or unavailable for releases after Windows 8.1. Instead, use [ItemsControl.IndexFromContainer](itemscontrol_indexfromcontainer.md).
