...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.ContainerContentChangingEventArgs](/windows/winui/api/microsoft.ui.xaml.controls.containercontentchangingeventargs).
