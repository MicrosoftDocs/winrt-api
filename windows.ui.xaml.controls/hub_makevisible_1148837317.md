...
Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.Hub.MakeVisible](/windows/winui/api/microsoft.ui.xaml.controls.hub.makevisible) (for WinUI in the [Windows App SDK](/windows/apps/windows-app-sdk/), see the **[Windows App SDK namespaces](/windows/windows-app-sdk/api/winrt/)**).
