---
-api-id: P:Windows.UI.Xaml.Controls.ItemsStackPanel.GroupPadding
...
# Windows.UI.Xaml.Controls.ItemsStackPanel.GroupPadding

## -description
Gets or sets the amount of space around a group.

Equivalent **WinUI 2 API for UWP**: [Microsoft.UI.Xaml.Controls.ItemsStackPanel.GroupPadding](/windows/winui/api/microsoft.ui.xaml.controls.itemsstackpanel.grouppadding) (for WinUI in the [Windows App SDK](/windows/apps/windows-app-sdk/), see the **[Windows App SDK namespaces](/windows/windows-app-sdk/api/winrt/)**).
