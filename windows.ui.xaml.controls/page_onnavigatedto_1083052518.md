...
## -remarks
Unlike in prior XAML platforms, the [OnNavigated](page_onnavigatedto.md) method is called before the visual tree is loaded. This has the following implications:
