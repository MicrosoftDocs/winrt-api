...
## -remarks
A [PosterSource](mediaplayerelement_postersource.md) is an image, such as a album cover or movie poster, that is displayed in place of video. It provides your [MediaPlayerElement](mediaplayerelement.md) with a visual representation before the media is loaded, or when the media is audio only.


The [PosterSource](mediaplayerelement_postersource.md) is displayed in the following situations:
