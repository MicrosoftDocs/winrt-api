...
## -description
> [!NOTE]
> [ScrollToHorizontalOffset](scrollviewer_scrolltohorizontaloffset.md) may be altered or unavailable for releases after Windows 8.1. Instead, use [ChangeView](scrollviewer_changeview.md).
