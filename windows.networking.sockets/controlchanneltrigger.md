...
+ The [HttpClient](/dotnet/api/system.net.http.httpclient) and [HttpClientHandler](/dotnet/api/system.net.http.httpclienthandler) classes in the [System.Net.Http](/dotnet/api/system.net.http) namespace in the .NET Framework 4.5. Custom classes that derive from these classes are also supported.
