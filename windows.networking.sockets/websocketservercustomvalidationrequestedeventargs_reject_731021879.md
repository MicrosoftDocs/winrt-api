...
## -remarks
There is no explicit method that allows a connection during validation. If no event handler calls [Reject](websocketservercustomvalidationrequestedeventargs_reject_731021879.md), then the connection is allowed.
