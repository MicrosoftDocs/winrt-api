...
> [!NOTE]
> [CancelIOAsync](datagramsocket_cancelioasync_169683529.md) cancels pending writes and reads in the Windows Runtime, but if there is a write buffer pending in networking drivers, it flushes the write.
