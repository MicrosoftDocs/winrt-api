...
+ If the websocket is not connected yet ([ConnectAsync](streamwebsocket_connectasync_682685111.md) has not been called), then [FlushAsync](../windows.storage.streams/ioutputstream_flushasync.md) throws an **E_ILLEGAL_METHOD_CALL** exception.
