...
Your code must set this property before you call [ConnectAsync](streamsocket_connectasync.md) to attempt to connect. Changing this property value after [ConnectAsync](streamsocket_connectasync.md) has been called results in an exception being thrown.
