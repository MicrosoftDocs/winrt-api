...
## -remarks
The [NoDelay](streamsocketcontrol_nodelay.md) property controls whether Nagle's algorithm is enabled or disabled on a [StreamSocket](streamsocket.md) object. The default value for the [NoDelay](streamsocketcontrol_nodelay.md) property is **true**.
