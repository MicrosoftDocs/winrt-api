...
## -see-also
[How to use advanced socket controls ](http://msdn.microsoft.com/library/2e1071d8-a1c7-44c0-b93a-31a701d431c4), [How to use advanced socket controls ](http://msdn.microsoft.com/library/f2c5be73-3461-452e-a38f-d2ddef9b5682), [ConnectAsync](streamsocket_connectasync.md), [HostName](../windows.networking/hostname.md), [LocalPort](streamsocketinformation_localport.md), [StreamSocket](streamsocket.md)
