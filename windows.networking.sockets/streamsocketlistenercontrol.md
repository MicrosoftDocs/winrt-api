...
For more information on using StreamSocketListenerControl, see [How to use advanced socket controls ](/previous-versions/windows/apps/hh780596(v=win.10)) and [How to use advanced socket controls ](/previous-versions/windows/apps/jj150598(v=win.10)).
