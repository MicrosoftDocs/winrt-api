...
## -remarks
The [UpgradeToSslAsync](streamsocket_upgradetosslasync.md) method can only be used to upgrade an already established connection made with a [SocketProtectionLevel](socketprotectionlevel.md) of **PlainSocket**.
...
The [UpgradeToSslAsync](streamsocket_upgradetosslasync.md) method requires that the remote server to which the connection was established is able to upgrade a TCP connection to an SSL connection.
