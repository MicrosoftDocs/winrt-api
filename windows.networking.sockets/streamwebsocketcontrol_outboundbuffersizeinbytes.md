...
The [OutboundBufferSizeInBytes](streamwebsocketcontrol_outboundbuffersizeinbytes.md) property must be set before the [StreamWebSocket](streamwebsocket.md) is connected. Setting this property after the [MessageWebSocket](messagewebsocket.md) is connected has no effect.
