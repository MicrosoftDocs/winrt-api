---
-api-id: T:Windows.Networking.Vpn.VpnChannelActivityStateChangedArgs
-api-type: winrt class
---

<!-- Class syntax.
public class VpnChannelActivityStateChangedArgs : Windows.Networking.Vpn.IVpnChannelActivityStateChangedArgs
-->
